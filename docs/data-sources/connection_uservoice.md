...
page_title: "etleap_connection_uservoice Data Source - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionUSERVOICE DataSource
---

# etleap_connection_uservoice (Data Source)
...
data "etleap_connection_uservoice" "my_connectionuservoice" {
  id = "acd5013e-0cd3-43c7-b143-d4b5f22c9131"
}
```
