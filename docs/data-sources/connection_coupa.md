...
page_title: "etleap_connection_coupa Data Source - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionCOUPA DataSource
---

# etleap_connection_coupa (Data Source)
...
data "etleap_connection_coupa" "my_connectioncoupa" {
  id = "ef0f714d-9610-463a-b6d6-e7aa77d67425"
}
```
...
- `client_id` (String) Your Coupa client id.
...
- `subdomain` (String) The subdomain for your Coupa instance.
