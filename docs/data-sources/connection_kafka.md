...
page_title: "etleap_connection_kafka Data Source - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionKAFKA DataSource
---

# etleap_connection_kafka (Data Source)
...
data "etleap_connection_kafka" "my_connectionkafka" {
  id = "5ce4e0c2-7ae5-4bad-b716-78cc6ddd7ad9"
}
```
...
- `auth_mechanism` (String) Kafka SASL authentication mechanism. must be one of ["SASL_SSL", "SASL_SCRAM_256", "SASL_SCRAM_512"]
