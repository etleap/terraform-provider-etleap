...
page_title: "etleap_connection_jira_cloud Data Source - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionJIRACLOUD DataSource
---

# etleap_connection_jira_cloud (Data Source)
...
data "etleap_connection_jira_cloud" "my_connectionjira_cloud" {
  id = "48ec9b5f-e340-49a3-acc6-a25c7a3d4a0e"
}
```
