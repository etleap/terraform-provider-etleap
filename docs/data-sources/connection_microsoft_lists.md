...
page_title: "etleap_connection_microsoft_lists Data Source - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionMICROSOFTLISTS DataSource
---

# etleap_connection_microsoft_lists (Data Source)
...
data "etleap_connection_microsoft_lists" "my_connectionmicrosoft_lists" {
  id = "ed6f36f3-d3d3-4406-a5eb-a4b52e1ac4ed"
}
```
