...
page_title: "etleap_connection_braintree Data Source - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionBRAINTREE DataSource
---

# etleap_connection_braintree (Data Source)
...
data "etleap_connection_braintree" "my_connectionbraintree" {
  id = "397c3402-7106-4011-8ab4-3bdd60c1ba08"
}
```
...
- `merchant_id` (String) Your Braintree tenant Merchant ID.
- `name` (String) The unique name of this connection.
- `public_key` (String) The public API key.
- `sandbox` (Boolean) Check this box if this is a sandbox account.
