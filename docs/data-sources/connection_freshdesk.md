...
page_title: "etleap_connection_freshdesk Data Source - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionFRESHDESK DataSource
---

# etleap_connection_freshdesk (Data Source)
...
data "etleap_connection_freshdesk" "my_connectionfreshdesk" {
  id = "f19d1464-871c-4946-ac46-fc90b6e9f803"
}
```
...
- `domain` (String) Your Freshdesk domain that precedes freshdesk.com. Example: https://(myDomain).freshdesk.com
