...
page_title: "etleap_connection_gitlab Data Source - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionGITLAB DataSource
---

# etleap_connection_gitlab (Data Source)
...
data "etleap_connection_gitlab" "my_connectiongitlab" {
  id = "49f3cbe3-43ad-4889-ae09-ea509815a625"
}
```
...
- `api_url` (String) Your Gitlab instance URL if you're on a self hosted setup. Leave empty for gitlab.com. Example: https://gitlab.example.com
