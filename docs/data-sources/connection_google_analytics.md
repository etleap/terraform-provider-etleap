...
page_title: "etleap_connection_google_analytics Data Source - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionGOOGLEANALYTICS DataSource
---

# etleap_connection_google_analytics (Data Source)
...
```terraform
data "etleap_connection_google_analytics" "my_connectiongoogle_analytics" {
  id = "81ddc281-1838-4b26-bdd6-c13d19c33713"
}
```
