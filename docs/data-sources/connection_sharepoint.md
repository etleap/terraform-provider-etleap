...
page_title: "etleap_connection_sharepoint Data Source - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionSHAREPOINT DataSource
---

# etleap_connection_sharepoint (Data Source)
...
```terraform
data "etleap_connection_sharepoint" "my_connectionsharepoint" {
  id = "ba260fc2-8a54-4017-893c-6a21fd255abc"
}
```
