...
page_title: "etleap_connection_sap_hana_sharded Data Source - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionSAPHANASHARDED DataSource
---

# etleap_connection_sap_hana_sharded (Data Source)
...
data "etleap_connection_sap_hana_sharded" "my_connectionsap_hana_sharded" {
  id = "78bccaef-2db0-42d5-b324-6d7bc4ff471c"
}
```
