...
page_title: "etleap_connection_the_trade_desk Data Source - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionTHETRADEDESK DataSource
---

# etleap_connection_the_trade_desk (Data Source)
...
- `partner_id` (String) Your Partner ID at The Trade Desk.
...
- `username` (String) Typically an email address.
