...
page_title: "etleap_connection_freshcaller Data Source - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionFRESHCALLER DataSource
---

# etleap_connection_freshcaller (Data Source)
...
data "etleap_connection_freshcaller" "my_connectionfreshcaller" {
  id = "15f59182-ce94-4a61-97e2-dadcd9e9ac25"
}
```
...
- `domain` (String) Your Freshcaller domain that precedes freshdesk.com. Example: https://(myDomain).freshcaller.com
