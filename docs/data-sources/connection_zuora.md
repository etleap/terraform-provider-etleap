...
page_title: "etleap_connection_zuora Data Source - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionZUORA DataSource
---

# etleap_connection_zuora (Data Source)
...
data "etleap_connection_zuora" "my_connectionzuora" {
  id = "9facc1fd-5a8b-4dd2-9ad4-2f41522f4a03"
}
```
...
- `client_id` (String) The Client ID displayed when you created the OAuth client. If you need help to create an OAuth Client, <a target="_blank" href="https://knowledgecenter.zuora.com/CF_Users_and_Administrators/A_Administrator_Settings/Manage_Users#Create_an_OAuth_Client_for_a_User">follow this article</a>.
...
- `endpoint` (String) The endpoint region.
- `endpoint_hostname` (String) Leave blank unless you have been assigned a specific endpoint, e.g. services42.zuora.com. Setting this overrides the 'Endpoint' and 'Sandbox' settings above.
