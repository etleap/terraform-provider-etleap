...
page_title: "etleap_connection_azure_blob_storage Data Source - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionAZUREBLOBSTORAGE DataSource
---

# etleap_connection_azure_blob_storage (Data Source)
...
data "etleap_connection_azure_blob_storage" "my_connectionazure_blob_storage" {
  id = "c3402710-6011-44ab-83bd-d60c1ba08b7f"
}
```
...
- `client_id` (String) The Application (client) ID from your Azure AD app registration.
...
- `storage_account` (String) The name of your Azure Storage Account.
- `tenant_id` (String) The Directory (tenant) ID from your Azure AD app registration.
