...
page_title: "etleap_connection_ldap Data Source - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionLDAP DataSource
---

# etleap_connection_ldap (Data Source)
...
data "etleap_connection_ldap" "my_connectionldap" {
  id = "5fe3409a-36cc-46a2-9c7a-3d4a0e5ce4e0"
}
```
...
- `pen` (Number) The IANA-assigned number for your custom schema entities
- `port` (Number)
