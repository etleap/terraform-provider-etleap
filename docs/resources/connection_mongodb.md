...
page_title: "etleap_connection_mongodb Resource - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionMONGODB Resource
---

# etleap_connection_mongodb (Resource)
...
- `use_ssl` (Boolean) Whether Etleap should connect over SSL. Default: false
