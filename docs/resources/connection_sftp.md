...
page_title: "etleap_connection_sftp Resource - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionSFTP Resource
---

# etleap_connection_sftp (Resource)
...
resource "etleap_connection_sftp" "my_connectionsftp" {
  ...
  hostname                    = "unrealistic-incentive.biz"
  name                        = "Elaine Nader"
  password                    = "...my_password..."
  pgp_secret_key              = "...my_pgp_secret_key..."
  port                        = 3
  type                        = "SFTP"
  username                    = "Maxie_Rutherford"
}
```
...
- `base_directory` (String) The start directory for the user. Etleap will read any file or folders under this directory.
- `hostname` (String) E.g. 'etleap.com' or '10.0.0.2'.
...
- `password` (String) If set to `null`, Public Key Authentication will be used.
...
- `use_public_key_authentication` (Boolean) Set to `true` if this connection is using Public Key Authentication instead of password authentication.
