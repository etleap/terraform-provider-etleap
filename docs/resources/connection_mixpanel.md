...
page_title: "etleap_connection_mixpanel Resource - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionMIXPANEL Resource
---

# etleap_connection_mixpanel (Resource)
...
- `api_secret` (String) 'API Secret' under Mixpanel 'Project Settings'
- `name` (String) The unique name of this connection.
- `timezone` (String) Mixpanel project timezone. Default: 'US/Pacific'
