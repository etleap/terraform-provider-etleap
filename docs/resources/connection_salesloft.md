...
page_title: "etleap_connection_salesloft Resource - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionSALESLOFT Resource
---

# etleap_connection_salesloft (Resource)
...
- `api_key` (String) Your Salesloft API key. You can generate a new API key in Salesloft under Your Applications > API Keys > Create New
