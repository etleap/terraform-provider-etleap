...
page_title: "etleap_connection_jira_align Resource - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionJIRAALIGN Resource
---

# etleap_connection_jira_align (Resource)
...
- `api_key` (String) The client API key required to authenticate with the JIRA Align API.
- `name` (String) The unique name of this connection.
- `subdomain` (String) Your JIRA Align subdomain (i.e. SUBDOMAIN.jiraalign.com)
