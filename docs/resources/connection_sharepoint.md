...
page_title: "etleap_connection_sharepoint Resource - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionSHAREPOINT Resource
---

# etleap_connection_sharepoint (Resource)
...
```terraform
resource "etleap_connection_sharepoint" "my_connectionsharepoint" {
  code                        = "...my_code..."
