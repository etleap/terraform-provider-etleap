...
page_title: "etleap_connection_freshchat Resource - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionFRESHCHAT Resource
---

# etleap_connection_freshchat (Resource)
...
- `api_key` (String) Your Freshchat API key. Can be found under Admin Settings -> Marketplace and Integrations -> API Settings under the "Your API Key" label.
- `domain` (String) Your Freshchat domain. Can be found under Admin Settings -> Marketplace and Integrations -> API Settings under the "Your chat URL" label.
