...
page_title: "etleap_connection_google_cloud_storage Resource - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionGOOGLECLOUDSTORAGE Resource
---

# etleap_connection_google_cloud_storage (Resource)
...
- `bucket` (String) A bucket you want to extract from. E.g. 'mybucket'
