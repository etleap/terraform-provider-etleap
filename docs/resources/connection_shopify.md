...
page_title: "etleap_connection_shopify Resource - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionSHOPIFY Resource
---

# etleap_connection_shopify (Resource)
...
- `api_key` (String) To find your API keys, or generate a new one, follow these instructions: <a target="_blank" href="https://shopify.dev/apps/auth/basic-http#2-generate-api-credentials">Generate Api Credentials</a>.
- `name` (String) The unique name of this connection.
- `password` (String) To find your API keys, or generate a new one, follow these instructions: <a target="_blank" href="https://shopify.dev/apps/auth/basic-http#2-generate-api-credentials">Generate Api Credentials</a>.
- `store_name` (String) The store name for your account is the name of your development store. You can find it in the url of your Shopify store: <b>storename</b>.myshopify.com/
