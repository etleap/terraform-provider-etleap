...
page_title: "etleap_connection_netsuite Resource - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionNETSUITE Resource
---

# etleap_connection_netsuite (Resource)
...
resource "etleap_connection_netsuite" "my_connectionnetsuite" {
  ...
  email                       = "Lolita_Dickinson@gmail.com"
  name                        = "Mrs. Frederick Hoeger"
...
- `account_id` (String) Under Setup -> Integration -> SOAP Web Services Preferences.
- `email` (String)
