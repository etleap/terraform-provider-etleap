...
page_title: "etleap_connection_fifteen_five Resource - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionFIFTEENFIVE Resource
---

# etleap_connection_fifteen_five (Resource)
...
- `access_token` (String) Your Access Token can be found in your dashboard under "Features" > "Integrations".
