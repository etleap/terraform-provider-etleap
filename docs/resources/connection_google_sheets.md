...
page_title: "etleap_connection_google_sheets Resource - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionGOOGLESHEETS Resource
---

# etleap_connection_google_sheets (Resource)
...
- `service_account_email` (String) Address of the Google service account provisioned for this connection. Only present when `authenticationMethod` is `SERVICE_ACCOUNT`.
