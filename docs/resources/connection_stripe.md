...
page_title: "etleap_connection_stripe Resource - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionSTRIPE Resource
---

# etleap_connection_stripe (Resource)
...
- `api_secret_key` (String) Your API secret key can be found in your dashboard under the "Developer" tab.
