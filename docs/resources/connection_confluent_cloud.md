...
page_title: "etleap_connection_confluent_cloud Resource - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionCONFLUENTCLOUD Resource
---

# etleap_connection_confluent_cloud (Resource)
...
- `schema_registry_secret` (String) Schema Registry API Secret
