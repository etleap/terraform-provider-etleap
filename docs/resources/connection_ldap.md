...
page_title: "etleap_connection_ldap Resource - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionLDAP Resource
---

# etleap_connection_ldap (Resource)
...
- `use_ssl` (Boolean) Enable this if you are using a secure port to connect to LDAP. Usually, this should be enabled if you are connecting via port 636. Default: false
