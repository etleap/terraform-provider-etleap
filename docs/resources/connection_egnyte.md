...
page_title: "etleap_connection_egnyte Resource - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionEGNYTE Resource
---

# etleap_connection_egnyte (Resource)
...
- `base_directory` (String) The path for your base directory. Use "/" for the whole file system.
...
- `domain_name` (String) The name of your Egnyte domain.
