...
page_title: "etleap_connection_jira_cloud Resource - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionJIRACLOUD Resource
---

# etleap_connection_jira_cloud (Resource)
...
- `type` (String) must be one of ["JIRA_CLOUD"]
