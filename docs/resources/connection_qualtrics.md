...
page_title: "etleap_connection_qualtrics Resource - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionQUALTRICS Resource
---

# etleap_connection_qualtrics (Resource)
...
- `api_token` (String) The API token can be located and generated under User settings.
- `data_center_id` (String) The ID of your data center. It can be located under User settings. Example: sjc1, lhr1
