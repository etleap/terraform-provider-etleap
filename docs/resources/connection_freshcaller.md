...
page_title: "etleap_connection_freshcaller Resource - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionFRESHCALLER Resource
---

# etleap_connection_freshcaller (Resource)
...
- `api_key` (String) Your Freshcaller API key
