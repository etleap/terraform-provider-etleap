...
page_title: "etleap_connection_dayforce Resource - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionDAYFORCE Resource
---

# etleap_connection_dayforce (Resource)
...
- `company_id` (String) Your Dayforce company namespace. Example: etleap
- `domain` (String) The service URL domain of your Dayforce environment, located in the URL of your application when redirected: https://(domain).dayforcehcm.com/ Example: eur261
- `is_test_environment` (String) Check if connecting to a Dayforce test environment.
- `name` (String) The unique name of this connection.
- `password` (String) The password of the Dayforce user with API access.
- `type` (String) must be one of ["DAYFORCE"]
- `username` (String) The username of the Dayforce user with API access.
