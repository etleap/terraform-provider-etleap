...
page_title: "etleap_connection_rave_medidata Resource - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionRAVEMEDIDATA Resource
---

# etleap_connection_rave_medidata (Resource)
...
- `hostname` (String) E.g., my-org.mdsol.com
- `name` (String) The unique name of this connection.
- `password` (String) Rave Account Password
- `type` (String) must be one of ["RAVE_MEDIDATA"]
- `username` (String) Rave Account Login
