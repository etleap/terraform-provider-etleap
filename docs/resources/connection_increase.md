...
page_title: "etleap_connection_increase Resource - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionINCREASE Resource
---

# etleap_connection_increase (Resource)
...
- `api_key` (String) Your Increase API key. Find it in the Increase dashboard under Developers.
- `is_sandbox` (String) Check if this API key is for the Increase sandbox environment. Production and sandbox use separate keys.
