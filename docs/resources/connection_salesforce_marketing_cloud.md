...
page_title: "etleap_connection_salesforce_marketing_cloud Resource - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionSALESFORCEMARKETINGCLOUD Resource
---

# etleap_connection_salesforce_marketing_cloud (Resource)
...
- `client_id` (String) You can retrieve your credentials, by creating an <a target="_blank" href="https://developer.salesforce.com/docs/marketing/marketing-cloud/guide/create-integration-enhanced.html#related-items">integration</a>.
- `client_secret` (String) You can retrieve your credentials, by creating an <a target="_blank" href="https://developer.salesforce.com/docs/marketing/marketing-cloud/guide/create-integration-enhanced.html#related-items">integration</a>.
- `name` (String) The unique name of this connection.
- `subdomain` (String) You can find your Account Subdomain with the following <a target="_blank" href="https://developer.salesforce.com/docs/marketing/marketing-cloud/guide/your-subdomain-tenant-specific-endpoints.html#locate-your-subdomain-and-endpoints">guide</a>.
