...
page_title: "etleap_connection_braintree Resource - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionBRAINTREE Resource
---

# etleap_connection_braintree (Resource)
...
- `private_key` (String) The private API key.
