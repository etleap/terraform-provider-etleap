...
page_title: "etleap_connection_twilio Resource - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionTWILIO Resource
---

# etleap_connection_twilio (Resource)
...
- `account_sid` (String) You can find your Account SID in your <a target="_blank" href="https://twilio.com/console">Account Dashboard</a>.
- `api_key_secret` (String) You can find your API keys, or generate a new one, in the <a target="_blank" href="https://www.twilio.com/console/runtime/api-keys">Twilio Console</a>.
- `api_key_sid` (String) You can find your API keys, or generate a new one, in the <a target="_blank" href="https://www.twilio.com/console/runtime/api-keys">Twilio Console</a>.
