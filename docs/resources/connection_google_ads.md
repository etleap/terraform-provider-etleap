...
page_title: "etleap_connection_google_ads Resource - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionGOOGLEADS Resource
---

# etleap_connection_google_ads (Resource)
...
- `customer_id` (String) The ID of the customer you want to log in as. Etleap will extract the data of all customers that this login customer has access to. 10 digits without hyphens.
