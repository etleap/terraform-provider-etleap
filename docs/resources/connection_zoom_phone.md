...
page_title: "etleap_connection_zoom_phone Resource - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionZOOMPHONE Resource
---

# etleap_connection_zoom_phone (Resource)
...
- `client_id` (String) Under Admin Dashboard > Created App > App credentials
- `client_secret` (String) Under Admin Dashboard > Created App > App credentials
