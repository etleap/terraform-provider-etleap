...
page_title: "etleap_connection_sap_odata Resource - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionSAPODATA Resource
---

# etleap_connection_sap_odata (Resource)
...
- `domain` (String) Your SAP domain. Example: https://mysapinstance.com
- `name` (String) The unique name of this connection.
- `password` (String) The password of the technical user that has access to your OData services.
- `type` (String) must be one of ["SAP_ODATA"]
- `username` (String) The username of the technical user that has access to your OData services.
