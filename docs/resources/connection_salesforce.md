...
page_title: "etleap_connection_salesforce Resource - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionSALESFORCE Resource
---

# etleap_connection_salesforce (Resource)
...
- `quota_limit` (Number) The maximum number of Bulk API batch requests Etleap will use per 24-hour window. Etleap will also stop if the remaining quota goes under 500 requests.
- `sandbox` (Boolean)
