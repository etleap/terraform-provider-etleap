...
page_title: "etleap_connection_sqs Resource - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionSQS Resource
---

# etleap_connection_sqs (Resource)
...
- `iam_role_arn` (String) An IAM Role ARN looks like 'arn:aws:iam::account_id:role/role-name'. Etleap will assume this role to access the SQS queues.
- `name` (String) The unique name of this connection.
- `region` (String) The AWS region where the data will be extracted from the SQS queues.
