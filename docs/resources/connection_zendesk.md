...
page_title: "etleap_connection_zendesk Resource - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionZENDESK Resource
---

# etleap_connection_zendesk (Resource)
...
- `subdomain` (String) The name of the subdomain. This is in the URL when you use zendesk: [subdomain].zendesk.com
