...
page_title: "etleap_connection_google_analytics Resource - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionGOOGLEANALYTICS Resource
---

# etleap_connection_google_analytics (Resource)
...
```terraform
resource "etleap_connection_google_analytics" "my_connectiongoogle_analytics" {
  code                        = "...my_code..."
  deletion_of_export_products = true
  name                        = "Mr. Anne Runolfsson"
