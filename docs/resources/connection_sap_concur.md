...
page_title: "etleap_connection_sap_concur Resource - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionSAPCONCUR Resource
---

# etleap_connection_sap_concur (Resource)
...
- `region` (String) Your SAP Concur region, e.g. us, eu, eu2.
- `request_token` (String) Your Company Request Token.
