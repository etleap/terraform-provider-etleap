...
page_title: "etleap_connection_elluminate Resource - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionELLUMINATE Resource
---

# etleap_connection_elluminate (Resource)
...
- `api_key` (String) Your Elluminate API key
- `api_secret` (String) Your Elluminate API secret
- `base_url` (String) Your Elluminate URL.
