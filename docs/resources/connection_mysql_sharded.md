...
page_title: "etleap_connection_mysql_sharded Resource - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionMYSQLSHARDED Resource
---

# etleap_connection_mysql_sharded (Resource)
...
- `validate_ssl_cert` (Boolean) Default: false
