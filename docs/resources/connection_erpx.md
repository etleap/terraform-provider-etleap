...
page_title: "etleap_connection_erpx Resource - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionERPX Resource
---

# etleap_connection_erpx (Resource)
...
- `api_url` (String) Your ERPx tenant API URL. Requires replacement if changed.
- `client_id` (String) Client ID
- `client_secret` (String) Client Secret
- `name` (String) The unique name of this connection.
- `token_url` (String) Your ERPx tenant authentication URL.
