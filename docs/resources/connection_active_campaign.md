...
page_title: "etleap_connection_active_campaign Resource - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionACTIVECAMPAIGN Resource
---

# etleap_connection_active_campaign (Resource)
...
- `api_key` (String) Your API key can be found in your account on the Settings page under the "Developer" tab. Each user in your ActiveCampaign account has their own unique API key.
- `base_url` (String) The base URL is specific to your account. Your API URL can be found in your account on the My Settings page under the "Developer" tab.
