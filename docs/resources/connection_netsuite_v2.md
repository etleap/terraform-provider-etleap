...
page_title: "etleap_connection_netsuite_v2 Resource - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionNETSUITEV2 Resource
---

# etleap_connection_netsuite_v2 (Resource)
...
- `consumer_secret` (String) Consumer Secret value displayed after creating a new integration.
- `name` (String) The unique name of this connection.
- `token_id` (String) Token Id value displayed after creating a new access token.
- `token_secret` (String) Token Secret value displayed after creating a new access token.
