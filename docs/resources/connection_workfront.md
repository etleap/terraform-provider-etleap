...
page_title: "etleap_connection_workfront Resource - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionWORKFRONT Resource
---

# etleap_connection_workfront (Resource)
...
- `api_key` (String) The client API key required to authenticate with the Workfront API. API keys can be generated by <a target="_blank" href="https://experience.workfront.com/s/article/Managing-API-Keys-for-the-Workfront-System-1973288244?ui-force-components-controllers-recordGlobalValueProvider.RecordGvp.getRecord=1&r=7"> following the documentation here</a>.
- `name` (String) The unique name of this connection.
- `subdomain` (String) Your Workfront subdomain (i.e. SUBDOMAIN.my.workfront.com)
