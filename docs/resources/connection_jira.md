...
page_title: "etleap_connection_jira Resource - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionJIRA Resource
---

# etleap_connection_jira (Resource)
...
- `base_url` (String) The base URL to the JIRA deployment, e.g. https://jira.atlassian.com
