...
page_title: "etleap_connection_coupa Resource - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionCOUPA Resource
---

# etleap_connection_coupa (Resource)
...
- `client_secret` (String) Your Coupa client secret.
