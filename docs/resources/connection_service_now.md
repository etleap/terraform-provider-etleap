...
page_title: "etleap_connection_service_now Resource - terraform-provider-etleap"
subcategory: ""
description: |-
  ConnectionSERVICENOW Resource
---

# etleap_connection_service_now (Resource)
...
- `password` (String) ServiceNow Instance Password
- `svn_instance_url` (String) E.g., 12345.service-now.com
- `type` (String) must be one of ["SERVICE_NOW"]
- `username` (String) ServiceNow Instance Login
