...
type GetModelGrantsRequest struct {
...
func (o *GetModelGrantsRequest) GetID() string {
	if o == nil {
		return ""
	}
	return o.ID
...
func (o *GetModelGrantsRequest) GetPageToken() *string {
	if o == nil {
		return nil
	}
	return o.PageToken
...
func (o *GetModelGrantsRequest) GetPageSize() int64 {
	if o == nil {
		return 0
	}
	return o.PageSize
...
type GetModelGrantsResponse struct {
...
func (o *GetModelGrantsResponse) GetContentType() string {
	if o == nil {
		return ""
	}
...
func (o *GetModelGrantsResponse) GetStatusCode() int {
	if o == nil {
		return 0
	}
	return o.StatusCode
...
func (o *GetModelGrantsResponse) GetRawResponse() *http.Response {
	if o == nil {
		return nil
	}
...
func (o *GetModelGrantsResponse) GetGrantsWithoutPrivilegeOutputPaginated() *shared.GrantsWithoutPrivilegeOutputPaginated {
	if o == nil {
		return nil
	}
...
func (o *GetModelGrantsResponse) GetErrors() *shared.Errors {
	if o == nil {
		return nil
	}
	return o.Errors
