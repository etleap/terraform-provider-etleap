...
func (o *ConnectionUserDefinedAPI) GetAuthenticationOauth() *Oauth2ClientCredentialsAuthentication {
	return o.GetAuthentication().Oauth2ClientCredentialsAuthentication
}
...
type ConnectionUserDefinedAPIInput struct {
	...
	Authentication Authentication       `json:"authentication"`
	// The list of entities.
	Entities []UserDefinedAPIEntityInput `json:"entities"`
}
...
func (o *ConnectionUserDefinedAPIInput) GetAuthenticationOauth() *Oauth2ClientCredentialsAuthentication {
	return o.GetAuthentication().Oauth2ClientCredentialsAuthentication
}

func (o *ConnectionUserDefinedAPIInput) GetEntities() []UserDefinedAPIEntityInput {
	if o == nil {
		return []UserDefinedAPIEntityInput{}
	}
	return o.Entities
}
