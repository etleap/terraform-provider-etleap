...
type ConnectionBigQueryOutput struct {
...
func (c ConnectionBigQueryOutput) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(c, "", false)
}

func (c *ConnectionBigQueryOutput) UnmarshalJSON(data []byte) error {
...
func (o *ConnectionBigQueryOutput) GetStatus() ConnectionBigQueryStatus {
	if o == nil {
...
func (o *ConnectionBigQueryOutput) GetName() string {
	if o == nil {
		return ""
	}
	return o.Name
...
func (o *ConnectionBigQueryOutput) GetCreateDate() time.Time {
	if o == nil {
		return time.Time{}
	}
	return o.CreateDate
...
func (o *ConnectionBigQueryOutput) GetDefaultUpdateSchedule() []ConnectionBigQueryDefaultUpdateSchedule {
	if o == nil {
...
func (o *ConnectionBigQueryOutput) GetActive() bool {
	if o == nil {
		return false
	}
	return o.Active
...
func (o *ConnectionBigQueryOutput) GetType() ConnectionBigQueryType {
	if o == nil {
...
func (o *ConnectionBigQueryOutput) GetID() string {
	if o == nil {
		return ""
	}
	return o.ID
...
func (o *ConnectionBigQueryOutput) GetUpdateSchedule() *UpdateScheduleTypes {
	if o == nil {
		return nil
	}
	return o.UpdateSchedule
...
func (o *ConnectionBigQueryOutput) GetUpdateScheduleMonthly() *UpdateScheduleModeMonthly {
	if v := o.GetUpdateSchedule(); v != nil {
		return v.UpdateScheduleModeMonthly
	}
	return nil
...
func (o *ConnectionBigQueryOutput) GetUpdateScheduleHourly() *UpdateScheduleModeHourly {
	if v := o.GetUpdateSchedule(); v != nil {
		return v.UpdateScheduleModeHourly
	}
	return nil
...
func (o *ConnectionBigQueryOutput) GetUpdateScheduleInterval() *UpdateScheduleModeInterval {
	if v := o.GetUpdateSchedule(); v != nil {
		return v.UpdateScheduleModeInterval
	}
	return nil
...
func (o *ConnectionBigQueryOutput) GetUpdateScheduleDaily() *UpdateScheduleModeDaily {
	if v := o.GetUpdateSchedule(); v != nil {
		return v.UpdateScheduleModeDaily
	}
	return nil
...
func (o *ConnectionBigQueryOutput) GetUpdateScheduleWeekly() *UpdateScheduleModeWeekly {
	if v := o.GetUpdateSchedule(); v != nil {
		return v.UpdateScheduleModeWeekly
	}
	return nil
...
func (o *ConnectionBigQueryOutput) GetDataset() *string {
	if o == nil {
		return nil
	}
	return o.Dataset
...
func (o *ConnectionBigQuery) GetJSONCredentials() string {
	if o == nil {
		return ""
	}
