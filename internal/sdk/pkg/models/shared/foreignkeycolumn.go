...
type ForeignKeyColumnType string

const (
	ForeignKeyColumnTypeTopLevelForeignKeyColumn ForeignKeyColumnType = "Top Level Foreign Key Column"
	ForeignKeyColumnTypeForeignColumn            ForeignKeyColumnType = "Foreign Column"
)
...
func CreateForeignKeyColumnTopLevelForeignKeyColumn(topLevelForeignKeyColumn TopLevelForeignKeyColumn) ForeignKeyColumn {
	typ := ForeignKeyColumnTypeTopLevelForeignKeyColumn
...
func CreateForeignKeyColumnForeignColumn(foreignColumn ForeignColumn) ForeignKeyColumn {
	typ := ForeignKeyColumnTypeForeignColumn
...
func (u *ForeignKeyColumn) UnmarshalJSON(data []byte) error {
	...
	if err := utils.UnmarshalJSON(data, &topLevelForeignKeyColumn, "", true, true); err == nil {
		...
		u.Type = ForeignKeyColumnTypeTopLevelForeignKeyColumn
		return nil
	}
	...
	if err := utils.UnmarshalJSON(data, &foreignColumn, "", true, true); err == nil {
		...
		u.Type = ForeignKeyColumnTypeForeignColumn
		return nil
	}
...
func (u ForeignKeyColumn) MarshalJSON() ([]byte, error) {
