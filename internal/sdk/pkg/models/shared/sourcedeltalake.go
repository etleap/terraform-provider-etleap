...
type SourceDeltaLakeType string

const (
	SourceDeltaLakeTypeDeltaLake SourceDeltaLakeType = "DELTA_LAKE"
)

func (e SourceDeltaLakeType) ToPointer() *SourceDeltaLakeType {
	return &e
}

func (e *SourceDeltaLakeType) UnmarshalJSON(data []byte) error {
	var v string
	...
	switch v {
	case "DELTA_LAKE":
		*e = SourceDeltaLakeType(v)
		return nil
	default:
		return fmt.Errorf("invalid value for SourceDeltaLakeType: %v", v)
	}
}

type SourceDeltaLake struct {
	// The universally unique identifier for the source.
	ConnectionID string              `json:"connectionId"`
	Type         SourceDeltaLakeType `json:"type"`
...
func (o *SourceDeltaLake) GetConnectionID() string {
	if o == nil {
		return ""
	}
...
func (o *SourceDeltaLake) GetType() SourceDeltaLakeType {
	if o == nil {
		return SourceDeltaLakeType("")
	}
	return o.Type
}

func (o *SourceDeltaLake) GetLatencyThreshold() *int64 {
	if o == nil {
		return nil
	}
...
func (o *SourceDeltaLake) GetTable() *string {
	if o == nil {
		return nil
	}
	return o.Table
...
func (o *SourceDeltaLake) GetTableNameFilter() *string {
	if o == nil {
		return nil
	}
...
func (o *SourceDeltaLake) GetPrimaryKeyColumns() []string {
	if o == nil {
		return []string{}
	}
...
func (o *SourceDeltaLake) GetLastUpdatedColumn() *string {
	if o == nil {
		return nil
	}
...
func (o *SourceDeltaLake) GetSchema() *string {
	if o == nil {
		return nil
	}
	return o.Schema
