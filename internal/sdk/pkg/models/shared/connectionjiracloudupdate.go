...
type ConnectionJiraCloudUpdateType string

const (
	ConnectionJiraCloudUpdateTypeJiraCloud ConnectionJiraCloudUpdateType = "JIRA_CLOUD"
)

func (e ConnectionJiraCloudUpdateType) ToPointer() *ConnectionJiraCloudUpdateType {
	return &e
}

func (e *ConnectionJiraCloudUpdateType) UnmarshalJSON(data []byte) error {
	var v string
	...
	switch v {
	case "JIRA_CLOUD":
		*e = ConnectionJiraCloudUpdateType(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ConnectionJiraCloudUpdateType: %v", v)
	}
}
...
func (o *ConnectionJiraCloudUpdate) GetUpdateScheduleDaily() *UpdateScheduleModeDaily {
	if v := o.GetUpdateSchedule(); v != nil {
...
func (o *ConnectionJiraCloudUpdate) GetCode() *string {
	if o == nil {
		return nil
	}
	return o.Code
