...
type ConnectionFreshchatUpdateType string

const (
	ConnectionFreshchatUpdateTypeFreshchat ConnectionFreshchatUpdateType = "FRESHCHAT"
)

func (e ConnectionFreshchatUpdateType) ToPointer() *ConnectionFreshchatUpdateType {
	return &e
}

func (e *ConnectionFreshchatUpdateType) UnmarshalJSON(data []byte) error {
	var v string
	...
	switch v {
	case "FRESHCHAT":
		*e = ConnectionFreshchatUpdateType(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ConnectionFreshchatUpdateType: %v", v)
	}
}
...
func (o *ConnectionFreshchatUpdate) GetUpdateScheduleDaily() *UpdateScheduleModeDaily {
	if v := o.GetUpdateSchedule(); v != nil {
...
func (o *ConnectionFreshchatUpdate) GetDomain() *string {
	if o == nil {
		return nil
	}
	return o.Domain
...
func (o *ConnectionFreshchatUpdate) GetAPIKey() *string {
	if o == nil {
		return nil
	}
	return o.APIKey
