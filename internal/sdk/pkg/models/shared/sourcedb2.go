...
type SourceDb2Type string

const (
	SourceDb2TypeDb2 SourceDb2Type = "DB2"
)

func (e SourceDb2Type) ToPointer() *SourceDb2Type {
	return &e
}

func (e *SourceDb2Type) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "DB2":
		*e = SourceDb2Type(v)
		return nil
	default:
		return fmt.Errorf("invalid value for SourceDb2Type: %v", v)
	}
}
...
func (o *SourceDb2) GetConnectionID() string {
	if o == nil {
		return ""
	}
...
func (o *SourceDb2) GetType() SourceDb2Type {
	if o == nil {
		return SourceDb2Type("")
	}
	return o.Type
}

func (o *SourceDb2) GetLatencyThreshold() *int64 {
	if o == nil {
		return nil
	}
...
func (o *SourceDb2) GetTable() *string {
	if o == nil {
		return nil
	}
	return o.Table
...
func (o *SourceDb2) GetTableNameFilter() *string {
	if o == nil {
		return nil
	}
...
func (o *SourceDb2) GetPrimaryKeyColumns() []string {
	if o == nil {
		return []string{}
	}
...
func (o *SourceDb2) GetLastUpdatedColumn() *string {
	if o == nil {
		return nil
	}
...
func (o *SourceDb2) GetSchema() *string {
	if o == nil {
		return nil
	}
	return o.Schema
