...
var _ datasource.DataSource = &ConnectionELASTICSEARCHDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionELASTICSEARCHDataSource{}

func NewConnectionELASTICSEARCHDataSource() datasource.DataSource {
	return &ConnectionELASTICSEARCHDataSource{}
}

// ConnectionELASTICSEARCHDataSource is the data source implementation.
type ConnectionELASTICSEARCHDataSource struct {
	client *sdk.SDK
}

// ConnectionELASTICSEARCHDataSourceModel describes the data model.
type ConnectionELASTICSEARCHDataSourceModel struct {
...
func (r *ConnectionELASTICSEARCHDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_elasticsearch"
}

// Schema defines the schema for the data source.
func (r *ConnectionELASTICSEARCHDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionELASTICSEARCH DataSource",
...
func (r *ConnectionELASTICSEARCHDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionELASTICSEARCHDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionELASTICSEARCHDataSourceModel
