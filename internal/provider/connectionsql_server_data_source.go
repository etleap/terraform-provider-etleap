...
var _ datasource.DataSource = &ConnectionSQLSERVERDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionSQLSERVERDataSource{}

func NewConnectionSQLSERVERDataSource() datasource.DataSource {
	return &ConnectionSQLSERVERDataSource{}
}

// ConnectionSQLSERVERDataSource is the data source implementation.
type ConnectionSQLSERVERDataSource struct {
	client *sdk.SDK
}

// ConnectionSQLSERVERDataSourceModel describes the data model.
type ConnectionSQLSERVERDataSourceModel struct {
...
func (r *ConnectionSQLSERVERDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_sql_server"
}

// Schema defines the schema for the data source.
func (r *ConnectionSQLSERVERDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionSQLSERVER DataSource",
...
func (r *ConnectionSQLSERVERDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionSQLSERVERDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionSQLSERVERDataSourceModel
