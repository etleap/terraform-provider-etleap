...
var _ resource.Resource = &ConnectionFTPResource{}
var _ resource.ResourceWithImportState = &ConnectionFTPResource{}

func NewConnectionFTPResource() resource.Resource {
	return &ConnectionFTPResource{}
}

// ConnectionFTPResource defines the resource implementation.
type ConnectionFTPResource struct {
	client *sdk.SDK
}
...
func (r *ConnectionFTPResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_ftp"
}

func (r *ConnectionFTPResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionFTP Resource",
		...
		Attributes: map[string]schema.Attribute{
			...
			"hostname": schema.StringAttribute{
				Required:    true,
				Description: `E.g. 'ftp.etleap.com' or '10.0.0.2'.`,
			},
...
func (r *ConnectionFTPResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *ConnectionFTPResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *ConnectionFTPResourceModel
	...
	request := *data.ToSharedConnectionFtpInput()
	res, err := r.client.Connection.CreateFTPConnection(ctx, request)
	if err != nil {
	...
	if res.ConnectionFtp == nil {
		resp.Diagnostics.AddError("unexpected response from API. No response body", debugResponse(res.RawResponse))
		return
	}
	data.RefreshFromSharedConnectionFtp(res.ConnectionFtp)
	refreshPlan(ctx, plan, &data, resp.Diagnostics)
	id := data.ID.ValueString()
	request1 := operations.GetFTPConnectionRequest{
		ID: id,
	}
	res1, err := r.client.Connection.GetFTPConnection(ctx, request1)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
	...
	if res1.ConnectionFtp == nil {
		resp.Diagnostics.AddError("unexpected response from API. No response body", debugResponse(res1.RawResponse))
		return
	}
	data.RefreshFromSharedConnectionFtp(res1.ConnectionFtp)
	refreshPlan(ctx, plan, &data, resp.Diagnostics)
...
func (r *ConnectionFTPResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *ConnectionFTPResourceModel
	...
	id := data.ID.ValueString()
	request := operations.GetFTPConnectionRequest{
		ID: id,
	}
	res, err := r.client.Connection.GetFTPConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionFTPResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *ConnectionFTPResourceModel
	var plan types.Object
	...
	id := data.ID.ValueString()
	connectionFtpUpdate := data.ToSharedConnectionFtpUpdate()
	request := operations.UpdateFTPConnectionRequest{
		ID:                  id,
		ConnectionFtpUpdate: connectionFtpUpdate,
	}
	res, err := r.client.Connection.UpdateFTPConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionFTPResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *ConnectionFTPResourceModel
	var item types.Object
	...
	request := operations.DeleteFTPConnectionRequest{
		ID:               id,
		ConnectionDelete: connectionDelete,
	}
	res, err := r.client.Connection.DeleteFTPConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionFTPResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
