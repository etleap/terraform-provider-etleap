...
var _ datasource.DataSource = &ConnectionNETSUITEV2DataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionNETSUITEV2DataSource{}

func NewConnectionNETSUITEV2DataSource() datasource.DataSource {
	return &ConnectionNETSUITEV2DataSource{}
}

// ConnectionNETSUITEV2DataSource is the data source implementation.
type ConnectionNETSUITEV2DataSource struct {
	client *sdk.SDK
}
...
func (r *ConnectionNETSUITEV2DataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_netsuite_v2"
}

// Schema defines the schema for the data source.
func (r *ConnectionNETSUITEV2DataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionNETSUITEV2 DataSource",
...
func (r *ConnectionNETSUITEV2DataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionNETSUITEV2DataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionNETSUITEV2DataSourceModel
