...
var _ datasource.DataSource = &ConnectionPINTERESTADSDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionPINTERESTADSDataSource{}

func NewConnectionPINTERESTADSDataSource() datasource.DataSource {
	return &ConnectionPINTERESTADSDataSource{}
}

// ConnectionPINTERESTADSDataSource is the data source implementation.
type ConnectionPINTERESTADSDataSource struct {
	client *sdk.SDK
}

// ConnectionPINTERESTADSDataSourceModel describes the data model.
type ConnectionPINTERESTADSDataSourceModel struct {
...
func (r *ConnectionPINTERESTADSDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_pinterest_ads"
}

// Schema defines the schema for the data source.
func (r *ConnectionPINTERESTADSDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionPINTERESTADS DataSource",
...
func (r *ConnectionPINTERESTADSDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionPINTERESTADSDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionPINTERESTADSDataSourceModel
