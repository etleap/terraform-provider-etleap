...
func (r *ConnectionTHETRADEDESKResourceModel) ToSharedConnectionTheTradeDeskInput() *shared.ConnectionTheTradeDeskInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionTheTradeDeskType(r.Type.ValueString())
	...
	out := shared.ConnectionTheTradeDeskInput{
		Name:           name,
		Type:           typeVar,
...
func (r *ConnectionTHETRADEDESKResourceModel) RefreshFromSharedConnectionTheTradeDesk(resp *shared.ConnectionTheTradeDesk) {
	...
	r.PartnerID = types.StringValue(resp.PartnerID)
	r.Sandbox = types.BoolValue(resp.Sandbox)
...
func (r *ConnectionTHETRADEDESKResourceModel) ToSharedConnectionTheTradeDeskUpdate() *shared.ConnectionTheTradeDeskUpdate {
	name := new(string)
	...
	typeVar := new(shared.ConnectionTheTradeDeskUpdateType)
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionTheTradeDeskUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	active := new(bool)
	...
	out := shared.ConnectionTheTradeDeskUpdate{
		Name:           name,
		Type:           typeVar,
		Active:         active,
		UpdateSchedule: updateSchedule,
...
func (r *ConnectionTHETRADEDESKResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
