...
var _ datasource.DataSource = &ConnectionINCREASEDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionINCREASEDataSource{}

func NewConnectionINCREASEDataSource() datasource.DataSource {
	return &ConnectionINCREASEDataSource{}
}

// ConnectionINCREASEDataSource is the data source implementation.
type ConnectionINCREASEDataSource struct {
	client *sdk.SDK
}

// ConnectionINCREASEDataSourceModel describes the data model.
type ConnectionINCREASEDataSourceModel struct {
...
func (r *ConnectionINCREASEDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_increase"
}

// Schema defines the schema for the data source.
func (r *ConnectionINCREASEDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionINCREASE DataSource",
...
func (r *ConnectionINCREASEDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionINCREASEDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionINCREASEDataSourceModel
