...
func (r *ConnectionIMPACTRADIUSResourceModel) ToSharedConnectionImpactRadiusUpdate() *shared.ConnectionImpactRadiusUpdate {
	...
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionImpactRadiusUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	name := new(string)
...
func (r *ConnectionIMPACTRADIUSResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
