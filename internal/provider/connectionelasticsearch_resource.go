...
var _ resource.Resource = &ConnectionELASTICSEARCHResource{}
var _ resource.ResourceWithImportState = &ConnectionELASTICSEARCHResource{}

func NewConnectionELASTICSEARCHResource() resource.Resource {
	return &ConnectionELASTICSEARCHResource{}
}

// ConnectionELASTICSEARCHResource defines the resource implementation.
type ConnectionELASTICSEARCHResource struct {
	client *sdk.SDK
}

// ConnectionELASTICSEARCHResourceModel describes the resource data model.
type ConnectionELASTICSEARCHResourceModel struct {
...
func (r *ConnectionELASTICSEARCHResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_elasticsearch"
}

func (r *ConnectionELASTICSEARCHResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionELASTICSEARCH Resource",
		...
		Attributes: map[string]schema.Attribute{
			...
			"address": schema.StringAttribute{
				Required:    true,
				Description: `E.g. 'etleap.com' or '10.0.0.2'.`,
			},
			...
			"ssl_enabled": schema.BoolAttribute{
				Required:    true,
				Description: `Enable this if your Elastic endpoint URL starts with 'https'. Usually this should be enabled if you are connecting via port 9243.`,
			},
			...
			"username": schema.StringAttribute{
				Computed: true,
				Optional: true,
				MarkdownDescription: `An account must be setup in your Elastic cluster with at least the following permissions:` + "\n" +
					`` + "\n" +
...
func (r *ConnectionELASTICSEARCHResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *ConnectionELASTICSEARCHResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *ConnectionELASTICSEARCHResourceModel
	...
	res1, err := r.client.Connection.GetELASTICSEARCHConnection(ctx, request1)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
...
func (r *ConnectionELASTICSEARCHResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *ConnectionELASTICSEARCHResourceModel
	...
	id := data.ID.ValueString()
	request := operations.GetELASTICSEARCHConnectionRequest{
		ID: id,
	}
	res, err := r.client.Connection.GetELASTICSEARCHConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionELASTICSEARCHResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *ConnectionELASTICSEARCHResourceModel
	var plan types.Object
...
func (r *ConnectionELASTICSEARCHResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *ConnectionELASTICSEARCHResourceModel
	var item types.Object
	...
	request := operations.DeleteELASTICSEARCHConnectionRequest{
		ID:               id,
		ConnectionDelete: connectionDelete,
	}
	res, err := r.client.Connection.DeleteELASTICSEARCHConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionELASTICSEARCHResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
