...
func (r *ConnectionSFTPResourceModel) RefreshFromSharedConnectionSftpOutput(resp *shared.ConnectionSftpOutput) {
	...
	r.UsePublicKeyAuthentication = types.BoolPointerValue(resp.UsePublicKeyAuthentication)
...
func (r *ConnectionSFTPResourceModel) ToSharedConnectionSftpUpdate() *shared.ConnectionSftpUpdate {
	...
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionSftpUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	name := new(string)
...
func (r *ConnectionSFTPResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
