...
var _ datasource.DataSource = &ConnectionMICROSOFTLISTSDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionMICROSOFTLISTSDataSource{}

func NewConnectionMICROSOFTLISTSDataSource() datasource.DataSource {
	return &ConnectionMICROSOFTLISTSDataSource{}
}

// ConnectionMICROSOFTLISTSDataSource is the data source implementation.
type ConnectionMICROSOFTLISTSDataSource struct {
	client *sdk.SDK
}

// ConnectionMICROSOFTLISTSDataSourceModel describes the data model.
type ConnectionMICROSOFTLISTSDataSourceModel struct {
...
func (r *ConnectionMICROSOFTLISTSDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_microsoft_lists"
}

// Schema defines the schema for the data source.
func (r *ConnectionMICROSOFTLISTSDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionMICROSOFTLISTS DataSource",
...
func (r *ConnectionMICROSOFTLISTSDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionMICROSOFTLISTSDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionMICROSOFTLISTSDataSourceModel
