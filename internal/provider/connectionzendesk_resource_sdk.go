...
func (r *ConnectionZENDESKResourceModel) ToSharedConnectionZendeskInput() *shared.ConnectionZendeskInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionZendeskType(r.Type.ValueString())
	...
	out := shared.ConnectionZendeskInput{
		Name:           name,
		Type:           typeVar,
...
func (r *ConnectionZENDESKResourceModel) RefreshFromSharedConnectionZendesk(resp *shared.ConnectionZendesk) {
...
func (r *ConnectionZENDESKResourceModel) ToSharedConnectionZendeskUpdate() *shared.ConnectionZendeskUpdate {
	active := new(bool)
	...
	typeVar := shared.ConnectionZendeskUpdateType(r.Type.ValueString())
	name := new(string)
	...
	out := shared.ConnectionZendeskUpdate{
		Active:         active,
		Type:           typeVar,
		Name:           name,
		UpdateSchedule: updateSchedule,
...
func (r *ConnectionZENDESKResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
