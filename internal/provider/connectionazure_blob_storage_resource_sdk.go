...
func (r *ConnectionAZUREBLOBSTORAGEResourceModel) ToSharedConnectionAzureBlobStorageInput() *shared.ConnectionAzureBlobStorageInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionAzureBlobStorageType(r.Type.ValueString())
	...
	storageAccount := r.StorageAccount.ValueString()
	container := r.Container.ValueString()
	baseDirectory := r.BaseDirectory.ValueString()
	out := shared.ConnectionAzureBlobStorageInput{
		Name:           name,
		Type:           typeVar,
...
func (r *ConnectionAZUREBLOBSTORAGEResourceModel) RefreshFromSharedConnectionAzureBlobStorage(resp *shared.ConnectionAzureBlobStorage) {
	r.Active = types.BoolValue(resp.Active)
	r.BaseDirectory = types.StringValue(resp.BaseDirectory)
	r.ClientID = types.StringValue(resp.ClientID)
	r.Container = types.StringValue(resp.Container)
	...
	r.StorageAccount = types.StringValue(resp.StorageAccount)
...
func (r *ConnectionAZUREBLOBSTORAGEResourceModel) ToSharedConnectionAzureBlobStorageUpdate() *shared.ConnectionAzureBlobStorageUpdate {
	name := new(string)
	...
	typeVar := new(shared.ConnectionAzureBlobStorageUpdateType)
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionAzureBlobStorageUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	active := new(bool)
	...
	if !r.StorageAccount.IsUnknown() && !r.StorageAccount.IsNull() {
		*storageAccount = r.StorageAccount.ValueString()
	} else {
		storageAccount = nil
	}
	container := new(string)
	if !r.Container.IsUnknown() && !r.Container.IsNull() {
		*container = r.Container.ValueString()
	} else {
		container = nil
	}
	...
	out := shared.ConnectionAzureBlobStorageUpdate{
		Name:           name,
		Type:           typeVar,
		Active:         active,
		UpdateSchedule: updateSchedule,
...
func (r *ConnectionAZUREBLOBSTORAGEResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
