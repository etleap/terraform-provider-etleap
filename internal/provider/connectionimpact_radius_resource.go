...
var _ resource.Resource = &ConnectionIMPACTRADIUSResource{}
var _ resource.ResourceWithImportState = &ConnectionIMPACTRADIUSResource{}

func NewConnectionIMPACTRADIUSResource() resource.Resource {
	return &ConnectionIMPACTRADIUSResource{}
}

// ConnectionIMPACTRADIUSResource defines the resource implementation.
type ConnectionIMPACTRADIUSResource struct {
	client *sdk.SDK
}
...
func (r *ConnectionIMPACTRADIUSResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_impact_radius"
}

func (r *ConnectionIMPACTRADIUSResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionIMPACTRADIUS Resource",

		Attributes: map[string]schema.Attribute{
			"account_sid": schema.StringAttribute{
				Required:    true,
				Description: `To find the Account SID to Impact Radius, click on the Cloud Icon in the bottom left > Click API > Find Rest API information`,
			},
			...
			"auth_token": schema.StringAttribute{
				Required:    true,
				Description: `To find the Auth Token to Impact Radius, click on the Cloud Icon in the bottom left > Click API > Find Rest API information`,
			},
...
func (r *ConnectionIMPACTRADIUSResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *ConnectionIMPACTRADIUSResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *ConnectionIMPACTRADIUSResourceModel
	...
	if res.ConnectionImpactRadius == nil {
	...
	res1, err := r.client.Connection.GetIMPACTRADIUSConnection(ctx, request1)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
	...
	if res1.ConnectionImpactRadius == nil {
...
func (r *ConnectionIMPACTRADIUSResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *ConnectionIMPACTRADIUSResourceModel
	...
	id := data.ID.ValueString()
	request := operations.GetIMPACTRADIUSConnectionRequest{
		ID: id,
	}
	res, err := r.client.Connection.GetIMPACTRADIUSConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionIMPACTRADIUSResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *ConnectionIMPACTRADIUSResourceModel
	var plan types.Object
	...
	id := data.ID.ValueString()
	connectionImpactRadiusUpdate := data.ToSharedConnectionImpactRadiusUpdate()
	request := operations.UpdateIMPACTRADIUSConnectionRequest{
		ID:                           id,
		ConnectionImpactRadiusUpdate: connectionImpactRadiusUpdate,
	}
	res, err := r.client.Connection.UpdateIMPACTRADIUSConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionIMPACTRADIUSResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *ConnectionIMPACTRADIUSResourceModel
	var item types.Object
	...
	request := operations.DeleteIMPACTRADIUSConnectionRequest{
		ID:               id,
		ConnectionDelete: connectionDelete,
	}
	res, err := r.client.Connection.DeleteIMPACTRADIUSConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionIMPACTRADIUSResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
