...
var _ resource.Resource = &ConnectionINTERCOMResource{}
var _ resource.ResourceWithImportState = &ConnectionINTERCOMResource{}

func NewConnectionINTERCOMResource() resource.Resource {
	return &ConnectionINTERCOMResource{}
}

// ConnectionINTERCOMResource defines the resource implementation.
type ConnectionINTERCOMResource struct {
	client *sdk.SDK
}

// ConnectionINTERCOMResourceModel describes the resource data model.
type ConnectionINTERCOMResourceModel struct {
...
func (r *ConnectionINTERCOMResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_intercom"
}

func (r *ConnectionINTERCOMResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionINTERCOM Resource",
...
func (r *ConnectionINTERCOMResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *ConnectionINTERCOMResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *ConnectionINTERCOMResourceModel
	...
	request := *data.ToSharedConnectionIntercomInput()
	res, err := r.client.Connection.CreateINTERCOMConnection(ctx, request)
	if err != nil {
	...
	if res.ConnectionIntercom == nil {
		resp.Diagnostics.AddError("unexpected response from API. No response body", debugResponse(res.RawResponse))
		return
	}
	data.RefreshFromSharedConnectionIntercom(res.ConnectionIntercom)
	refreshPlan(ctx, plan, &data, resp.Diagnostics)
	id := data.ID.ValueString()
	request1 := operations.GetINTERCOMConnectionRequest{
		ID: id,
	}
	res1, err := r.client.Connection.GetINTERCOMConnection(ctx, request1)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
	...
	if res1.ConnectionIntercom == nil {
		resp.Diagnostics.AddError("unexpected response from API. No response body", debugResponse(res1.RawResponse))
		return
	}
	data.RefreshFromSharedConnectionIntercom(res1.ConnectionIntercom)
	refreshPlan(ctx, plan, &data, resp.Diagnostics)
...
func (r *ConnectionINTERCOMResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *ConnectionINTERCOMResourceModel
	...
	id := data.ID.ValueString()
	request := operations.GetINTERCOMConnectionRequest{
		ID: id,
	}
	res, err := r.client.Connection.GetINTERCOMConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionINTERCOMResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *ConnectionINTERCOMResourceModel
	var plan types.Object
	...
	id := data.ID.ValueString()
	connectionIntercomUpdate := data.ToSharedConnectionIntercomUpdate()
	request := operations.UpdateINTERCOMConnectionRequest{
		ID:                       id,
		ConnectionIntercomUpdate: connectionIntercomUpdate,
	}
	res, err := r.client.Connection.UpdateINTERCOMConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionINTERCOMResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *ConnectionINTERCOMResourceModel
	var item types.Object
	...
	request := operations.DeleteINTERCOMConnectionRequest{
		ID:               id,
		ConnectionDelete: connectionDelete,
	}
	res, err := r.client.Connection.DeleteINTERCOMConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionINTERCOMResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
