...
func (r *ConnectionDAYFORCEResourceModel) ToSharedConnectionDayforceInput() *shared.ConnectionDayforceInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionDayforceType(r.Type.ValueString())
	...
	isTestEnvironment := r.IsTestEnvironment.ValueString()
	companyID := r.CompanyID.ValueString()
	domain := r.Domain.ValueString()
	username := r.Username.ValueString()
	password := r.Password.ValueString()
	out := shared.ConnectionDayforceInput{
		Name:              name,
		Type:              typeVar,
...
func (r *ConnectionDAYFORCEResourceModel) RefreshFromSharedConnectionDayforce(resp *shared.ConnectionDayforce) {
	...
	r.IsTestEnvironment = types.StringValue(resp.IsTestEnvironment)
...
func (r *ConnectionDAYFORCEResourceModel) ToSharedConnectionDayforceUpdate() *shared.ConnectionDayforceUpdate {
	name := new(string)
	...
	typeVar := new(shared.ConnectionDayforceUpdateType)
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionDayforceUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	active := new(bool)
	...
	isTestEnvironment := new(string)
	if !r.IsTestEnvironment.IsUnknown() && !r.IsTestEnvironment.IsNull() {
		*isTestEnvironment = r.IsTestEnvironment.ValueString()
	} else {
		isTestEnvironment = nil
	}
	...
	out := shared.ConnectionDayforceUpdate{
		Name:              name,
		Type:              typeVar,
		Active:            active,
		UpdateSchedule:    updateSchedule,
...
func (r *ConnectionDAYFORCEResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
