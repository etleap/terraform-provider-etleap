...
var _ datasource.DataSource = &ConnectionDELTALAKEDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionDELTALAKEDataSource{}

func NewConnectionDELTALAKEDataSource() datasource.DataSource {
	return &ConnectionDELTALAKEDataSource{}
}

// ConnectionDELTALAKEDataSource is the data source implementation.
type ConnectionDELTALAKEDataSource struct {
	client *sdk.SDK
}
...
func (r *ConnectionDELTALAKEDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_delta_lake"
}

// Schema defines the schema for the data source.
func (r *ConnectionDELTALAKEDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionDELTALAKE DataSource",
...
func (r *ConnectionDELTALAKEDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionDELTALAKEDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionDELTALAKEDataSourceModel
