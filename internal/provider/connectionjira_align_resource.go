...
var _ resource.Resource = &ConnectionJIRAALIGNResource{}
var _ resource.ResourceWithImportState = &ConnectionJIRAALIGNResource{}

func NewConnectionJIRAALIGNResource() resource.Resource {
	return &ConnectionJIRAALIGNResource{}
}

// ConnectionJIRAALIGNResource defines the resource implementation.
type ConnectionJIRAALIGNResource struct {
	client *sdk.SDK
}

// ConnectionJIRAALIGNResourceModel describes the resource data model.
type ConnectionJIRAALIGNResourceModel struct {
...
func (r *ConnectionJIRAALIGNResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_jira_align"
}

func (r *ConnectionJIRAALIGNResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionJIRAALIGN Resource",
		...
		Attributes: map[string]schema.Attribute{
			...
			"api_key": schema.StringAttribute{
				Required:    true,
				Description: `The client API key required to authenticate with the JIRA Align API.`,
			},
			...
			"subdomain": schema.StringAttribute{
				Required:    true,
				Description: `Your JIRA Align subdomain (i.e. SUBDOMAIN.jiraalign.com)`,
			},
...
func (r *ConnectionJIRAALIGNResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *ConnectionJIRAALIGNResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *ConnectionJIRAALIGNResourceModel
	...
	request := *data.ToSharedConnectionJiraAlignInput()
	res, err := r.client.Connection.CreateJIRAALIGNConnection(ctx, request)
	if err != nil {
	...
	if res.ConnectionJiraAlign == nil {
		resp.Diagnostics.AddError("unexpected response from API. No response body", debugResponse(res.RawResponse))
		return
	}
	data.RefreshFromSharedConnectionJiraAlign(res.ConnectionJiraAlign)
	refreshPlan(ctx, plan, &data, resp.Diagnostics)
	id := data.ID.ValueString()
	request1 := operations.GetJIRAALIGNConnectionRequest{
		ID: id,
	}
	res1, err := r.client.Connection.GetJIRAALIGNConnection(ctx, request1)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
	...
	if res1.ConnectionJiraAlign == nil {
		resp.Diagnostics.AddError("unexpected response from API. No response body", debugResponse(res1.RawResponse))
		return
	}
	data.RefreshFromSharedConnectionJiraAlign(res1.ConnectionJiraAlign)
	refreshPlan(ctx, plan, &data, resp.Diagnostics)
...
func (r *ConnectionJIRAALIGNResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *ConnectionJIRAALIGNResourceModel
	...
	id := data.ID.ValueString()
	request := operations.GetJIRAALIGNConnectionRequest{
		ID: id,
	}
	res, err := r.client.Connection.GetJIRAALIGNConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionJIRAALIGNResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *ConnectionJIRAALIGNResourceModel
	var plan types.Object
	...
	id := data.ID.ValueString()
	connectionJiraAlignUpdate := data.ToSharedConnectionJiraAlignUpdate()
	request := operations.UpdateJIRAALIGNConnectionRequest{
		ID:                        id,
		ConnectionJiraAlignUpdate: connectionJiraAlignUpdate,
	}
	res, err := r.client.Connection.UpdateJIRAALIGNConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionJIRAALIGNResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *ConnectionJIRAALIGNResourceModel
	var item types.Object
	...
	request := operations.DeleteJIRAALIGNConnectionRequest{
		ID:               id,
		ConnectionDelete: connectionDelete,
	}
	res, err := r.client.Connection.DeleteJIRAALIGNConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionJIRAALIGNResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
