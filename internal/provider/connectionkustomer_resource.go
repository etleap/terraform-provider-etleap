...
var _ resource.Resource = &ConnectionKUSTOMERResource{}
var _ resource.ResourceWithImportState = &ConnectionKUSTOMERResource{}

func NewConnectionKUSTOMERResource() resource.Resource {
	return &ConnectionKUSTOMERResource{}
}

// ConnectionKUSTOMERResource defines the resource implementation.
type ConnectionKUSTOMERResource struct {
	client *sdk.SDK
}

// ConnectionKUSTOMERResourceModel describes the resource data model.
type ConnectionKUSTOMERResourceModel struct {
...
func (r *ConnectionKUSTOMERResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_kustomer"
}

func (r *ConnectionKUSTOMERResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionKUSTOMER Resource",
...
func (r *ConnectionKUSTOMERResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *ConnectionKUSTOMERResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *ConnectionKUSTOMERResourceModel
	...
	request := *data.ToSharedConnectionKustomerInput()
	res, err := r.client.Connection.CreateKUSTOMERConnection(ctx, request)
	if err != nil {
	...
	if res.ConnectionKustomer == nil {
		resp.Diagnostics.AddError("unexpected response from API. No response body", debugResponse(res.RawResponse))
		return
	}
	data.RefreshFromSharedConnectionKustomer(res.ConnectionKustomer)
	refreshPlan(ctx, plan, &data, resp.Diagnostics)
	id := data.ID.ValueString()
	request1 := operations.GetKUSTOMERConnectionRequest{
		ID: id,
	}
	res1, err := r.client.Connection.GetKUSTOMERConnection(ctx, request1)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
	...
	if res1.ConnectionKustomer == nil {
		resp.Diagnostics.AddError("unexpected response from API. No response body", debugResponse(res1.RawResponse))
		return
	}
	data.RefreshFromSharedConnectionKustomer(res1.ConnectionKustomer)
	refreshPlan(ctx, plan, &data, resp.Diagnostics)
...
func (r *ConnectionKUSTOMERResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *ConnectionKUSTOMERResourceModel
	...
	id := data.ID.ValueString()
	request := operations.GetKUSTOMERConnectionRequest{
		ID: id,
	}
	res, err := r.client.Connection.GetKUSTOMERConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionKUSTOMERResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *ConnectionKUSTOMERResourceModel
	var plan types.Object
	...
	id := data.ID.ValueString()
	connectionKustomerUpdate := data.ToSharedConnectionKustomerUpdate()
	request := operations.UpdateKUSTOMERConnectionRequest{
		ID:                       id,
		ConnectionKustomerUpdate: connectionKustomerUpdate,
	}
	res, err := r.client.Connection.UpdateKUSTOMERConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionKUSTOMERResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *ConnectionKUSTOMERResourceModel
	var item types.Object
	...
	request := operations.DeleteKUSTOMERConnectionRequest{
		ID:               id,
		ConnectionDelete: connectionDelete,
	}
	res, err := r.client.Connection.DeleteKUSTOMERConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionKUSTOMERResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
