...
var _ datasource.DataSource = &ConnectionBIGQUERYDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionBIGQUERYDataSource{}

func NewConnectionBIGQUERYDataSource() datasource.DataSource {
	return &ConnectionBIGQUERYDataSource{}
}

// ConnectionBIGQUERYDataSource is the data source implementation.
type ConnectionBIGQUERYDataSource struct {
	client *sdk.SDK
}

// ConnectionBIGQUERYDataSourceModel describes the data model.
type ConnectionBIGQUERYDataSourceModel struct {
...
func (r *ConnectionBIGQUERYDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_bigquery"
}

// Schema defines the schema for the data source.
func (r *ConnectionBIGQUERYDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionBIGQUERY DataSource",
...
func (r *ConnectionBIGQUERYDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionBIGQUERYDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionBIGQUERYDataSourceModel
