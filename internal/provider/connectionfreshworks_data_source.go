...
var _ datasource.DataSource = &ConnectionFRESHWORKSDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionFRESHWORKSDataSource{}

func NewConnectionFRESHWORKSDataSource() datasource.DataSource {
	return &ConnectionFRESHWORKSDataSource{}
}

// ConnectionFRESHWORKSDataSource is the data source implementation.
type ConnectionFRESHWORKSDataSource struct {
	client *sdk.SDK
}

// ConnectionFRESHWORKSDataSourceModel describes the data model.
type ConnectionFRESHWORKSDataSourceModel struct {
...
func (r *ConnectionFRESHWORKSDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_freshworks"
}

// Schema defines the schema for the data source.
func (r *ConnectionFRESHWORKSDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionFRESHWORKS DataSource",
...
func (r *ConnectionFRESHWORKSDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionFRESHWORKSDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionFRESHWORKSDataSourceModel
