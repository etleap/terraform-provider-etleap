...
var _ datasource.DataSource = &ConnectionICEBERGDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionICEBERGDataSource{}

func NewConnectionICEBERGDataSource() datasource.DataSource {
	return &ConnectionICEBERGDataSource{}
}

// ConnectionICEBERGDataSource is the data source implementation.
type ConnectionICEBERGDataSource struct {
	client *sdk.SDK
}
...
func (r *ConnectionICEBERGDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_iceberg"
}

// Schema defines the schema for the data source.
func (r *ConnectionICEBERGDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionICEBERG DataSource",
...
func (r *ConnectionICEBERGDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionICEBERGDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionICEBERGDataSourceModel
