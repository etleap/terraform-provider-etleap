...
func (r *ConnectionGONGResourceModel) ToSharedConnectionGongInput() *shared.ConnectionGongInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionGongType(r.Type.ValueString())
	...
	out := shared.ConnectionGongInput{
		Name:           name,
		Type:           typeVar,
...
func (r *ConnectionGONGResourceModel) RefreshFromSharedConnectionGong(resp *shared.ConnectionGong) {
...
func (r *ConnectionGONGResourceModel) ToSharedConnectionGongUpdate() *shared.ConnectionGongUpdate {
	name := new(string)
	...
	typeVar := shared.ConnectionGongUpdateType(r.Type.ValueString())
	active := new(bool)
	...
	out := shared.ConnectionGongUpdate{
		Name:           name,
		Type:           typeVar,
		Active:         active,
		UpdateSchedule: updateSchedule,
...
func (r *ConnectionGONGResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
