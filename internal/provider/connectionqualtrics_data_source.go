...
var _ datasource.DataSource = &ConnectionQUALTRICSDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionQUALTRICSDataSource{}

func NewConnectionQUALTRICSDataSource() datasource.DataSource {
	return &ConnectionQUALTRICSDataSource{}
}

// ConnectionQUALTRICSDataSource is the data source implementation.
type ConnectionQUALTRICSDataSource struct {
	client *sdk.SDK
}

// ConnectionQUALTRICSDataSourceModel describes the data model.
type ConnectionQUALTRICSDataSourceModel struct {
...
func (r *ConnectionQUALTRICSDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_qualtrics"
}

// Schema defines the schema for the data source.
func (r *ConnectionQUALTRICSDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionQUALTRICS DataSource",
...
func (r *ConnectionQUALTRICSDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionQUALTRICSDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionQUALTRICSDataSourceModel
