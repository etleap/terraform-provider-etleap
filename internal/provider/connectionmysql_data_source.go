...
var _ datasource.DataSource = &ConnectionMYSQLDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionMYSQLDataSource{}

func NewConnectionMYSQLDataSource() datasource.DataSource {
	return &ConnectionMYSQLDataSource{}
}

// ConnectionMYSQLDataSource is the data source implementation.
type ConnectionMYSQLDataSource struct {
	client *sdk.SDK
}
...
func (r *ConnectionMYSQLDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_mysql"
}

// Schema defines the schema for the data source.
func (r *ConnectionMYSQLDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionMYSQL DataSource",
		...
		Attributes: map[string]schema.Attribute{
			...
			"tiny_int1_is_boolean": schema.BoolAttribute{
				Computed:    true,
				Description: `Should Etleap interpret columns with type Tinyint(1) as Boolean (i.e. true/false)?`,
			},
...
func (r *ConnectionMYSQLDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionMYSQLDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionMYSQLDataSourceModel
