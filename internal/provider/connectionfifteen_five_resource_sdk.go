...
func (r *ConnectionFIFTEENFIVEResourceModel) RefreshFromSharedConnectionFifteenFive(resp *shared.ConnectionFifteenFive) {
	...
	r.Subdomain = types.StringPointerValue(resp.Subdomain)
...
func (r *ConnectionFIFTEENFIVEResourceModel) ToSharedConnectionFifteenFiveUpdate() *shared.ConnectionFifteenFiveUpdate {
	...
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionFifteenFiveUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	active := new(bool)
...
func (r *ConnectionFIFTEENFIVEResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
