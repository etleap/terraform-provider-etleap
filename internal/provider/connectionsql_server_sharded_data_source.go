...
var _ datasource.DataSource = &ConnectionSQLSERVERSHARDEDDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionSQLSERVERSHARDEDDataSource{}

func NewConnectionSQLSERVERSHARDEDDataSource() datasource.DataSource {
	return &ConnectionSQLSERVERSHARDEDDataSource{}
}

// ConnectionSQLSERVERSHARDEDDataSource is the data source implementation.
type ConnectionSQLSERVERSHARDEDDataSource struct {
	client *sdk.SDK
}
...
func (r *ConnectionSQLSERVERSHARDEDDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_sql_server_sharded"
}

// Schema defines the schema for the data source.
func (r *ConnectionSQLSERVERSHARDEDDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionSQLSERVERSHARDED DataSource",
...
func (r *ConnectionSQLSERVERSHARDEDDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionSQLSERVERSHARDEDDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionSQLSERVERSHARDEDDataSourceModel
