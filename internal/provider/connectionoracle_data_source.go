...
var _ datasource.DataSource = &ConnectionORACLEDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionORACLEDataSource{}

func NewConnectionORACLEDataSource() datasource.DataSource {
	return &ConnectionORACLEDataSource{}
}

// ConnectionORACLEDataSource is the data source implementation.
type ConnectionORACLEDataSource struct {
	client *sdk.SDK
}

// ConnectionORACLEDataSourceModel describes the data model.
type ConnectionORACLEDataSourceModel struct {
...
func (r *ConnectionORACLEDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_oracle"
}

// Schema defines the schema for the data source.
func (r *ConnectionORACLEDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionORACLE DataSource",
...
func (r *ConnectionORACLEDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionORACLEDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionORACLEDataSourceModel
