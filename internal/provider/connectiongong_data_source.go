...
var _ datasource.DataSource = &ConnectionGONGDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionGONGDataSource{}

func NewConnectionGONGDataSource() datasource.DataSource {
	return &ConnectionGONGDataSource{}
}

// ConnectionGONGDataSource is the data source implementation.
type ConnectionGONGDataSource struct {
	client *sdk.SDK
}

// ConnectionGONGDataSourceModel describes the data model.
type ConnectionGONGDataSourceModel struct {
...
func (r *ConnectionGONGDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_gong"
}

// Schema defines the schema for the data source.
func (r *ConnectionGONGDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionGONG DataSource",
...
func (r *ConnectionGONGDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionGONGDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionGONGDataSourceModel
