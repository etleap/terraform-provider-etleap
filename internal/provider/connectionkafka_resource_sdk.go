...
func (r *ConnectionKAFKAResourceModel) ToSharedConnectionKafkaInput() *shared.ConnectionKafkaInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionKafkaType(r.Type.ValueString())
...
func (r *ConnectionKAFKAResourceModel) RefreshFromSharedConnectionKafka(resp *shared.ConnectionKafka) {
	r.Active = types.BoolValue(resp.Active)
	if resp.AuthMechanism != nil {
		r.AuthMechanism = types.StringValue(string(*resp.AuthMechanism))
	} else {
		r.AuthMechanism = types.StringNull()
	}
	...
	r.SchemaRegistryServer = types.StringPointerValue(resp.SchemaRegistryServer)
	r.SchemaRegistryUser = types.StringPointerValue(resp.SchemaRegistryUser)
	r.ServerList = types.StringValue(resp.ServerList)
	r.Status = types.StringValue(string(resp.Status))
	r.TruststoreCertificate = types.StringValue(resp.TruststoreCertificate)
...
func (r *ConnectionKAFKAResourceModel) ToSharedConnectionKafkaUpdate() *shared.ConnectionKafkaUpdate {
	...
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionKafkaUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	active := new(bool)
	...
	if !r.ServerList.IsUnknown() && !r.ServerList.IsNull() {
		*serverList = r.ServerList.ValueString()
	} else {
		serverList = nil
	}
...
func (r *ConnectionKAFKAResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
