...
func (r *ConnectionSHOPIFYResourceModel) RefreshFromSharedConnectionShopify(resp *shared.ConnectionShopify) {
	...
	r.StoreName = types.StringValue(resp.StoreName)
...
func (r *ConnectionSHOPIFYResourceModel) ToSharedConnectionShopifyUpdate() *shared.ConnectionShopifyUpdate {
	...
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionShopifyUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	active := new(bool)
...
func (r *ConnectionSHOPIFYResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
