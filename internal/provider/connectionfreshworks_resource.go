...
var _ resource.Resource = &ConnectionFRESHWORKSResource{}
var _ resource.ResourceWithImportState = &ConnectionFRESHWORKSResource{}

func NewConnectionFRESHWORKSResource() resource.Resource {
	return &ConnectionFRESHWORKSResource{}
}

// ConnectionFRESHWORKSResource defines the resource implementation.
type ConnectionFRESHWORKSResource struct {
	client *sdk.SDK
}
...
func (r *ConnectionFRESHWORKSResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_freshworks"
}

func (r *ConnectionFRESHWORKSResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionFRESHWORKS Resource",
		...
		Attributes: map[string]schema.Attribute{
			...
			"freshcaller_api_key": schema.StringAttribute{
				Required: true,
			},
			"freshcaller_domain": schema.StringAttribute{
				Required: true,
			},
			"freshdesk_api_key": schema.StringAttribute{
				Required: true,
			},
			"freshdesk_domain": schema.StringAttribute{
				Required: true,
			},
...
func (r *ConnectionFRESHWORKSResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *ConnectionFRESHWORKSResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *ConnectionFRESHWORKSResourceModel
	...
	request := *data.ToSharedConnectionFreshworksInput()
	res, err := r.client.Connection.CreateFRESHWORKSConnection(ctx, request)
	if err != nil {
	...
	if res.ConnectionFreshworks == nil {
		resp.Diagnostics.AddError("unexpected response from API. No response body", debugResponse(res.RawResponse))
		return
	}
	data.RefreshFromSharedConnectionFreshworks(res.ConnectionFreshworks)
	refreshPlan(ctx, plan, &data, resp.Diagnostics)
	id := data.ID.ValueString()
	request1 := operations.GetFRESHWORKSConnectionRequest{
		ID: id,
	}
	res1, err := r.client.Connection.GetFRESHWORKSConnection(ctx, request1)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
	...
	if res1.ConnectionFreshworks == nil {
		resp.Diagnostics.AddError("unexpected response from API. No response body", debugResponse(res1.RawResponse))
		return
	}
	data.RefreshFromSharedConnectionFreshworks(res1.ConnectionFreshworks)
	refreshPlan(ctx, plan, &data, resp.Diagnostics)
...
func (r *ConnectionFRESHWORKSResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *ConnectionFRESHWORKSResourceModel
	...
	id := data.ID.ValueString()
	request := operations.GetFRESHWORKSConnectionRequest{
		ID: id,
	}
	res, err := r.client.Connection.GetFRESHWORKSConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionFRESHWORKSResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *ConnectionFRESHWORKSResourceModel
	var plan types.Object
	...
	id := data.ID.ValueString()
	connectionFreshworksUpdate := data.ToSharedConnectionFreshworksUpdate()
	request := operations.UpdateFRESHWORKSConnectionRequest{
		ID:                         id,
		ConnectionFreshworksUpdate: connectionFreshworksUpdate,
	}
	res, err := r.client.Connection.UpdateFRESHWORKSConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionFRESHWORKSResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *ConnectionFRESHWORKSResourceModel
	var item types.Object
	...
	request := operations.DeleteFRESHWORKSConnectionRequest{
		ID:               id,
		ConnectionDelete: connectionDelete,
	}
	res, err := r.client.Connection.DeleteFRESHWORKSConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionFRESHWORKSResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
