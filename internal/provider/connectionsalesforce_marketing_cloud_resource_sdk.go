...
func (r *ConnectionSALESFORCEMARKETINGCLOUDResourceModel) ToSharedConnectionSalesforceMarketingCloudUpdate() *shared.ConnectionSalesforceMarketingCloudUpdate {
	...
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionSalesforceMarketingCloudUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	name := new(string)
...
func (r *ConnectionSALESFORCEMARKETINGCLOUDResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
