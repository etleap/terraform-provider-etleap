...
var _ datasource.DataSource = &ConnectionTIKTOKADSDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionTIKTOKADSDataSource{}

func NewConnectionTIKTOKADSDataSource() datasource.DataSource {
	return &ConnectionTIKTOKADSDataSource{}
}

// ConnectionTIKTOKADSDataSource is the data source implementation.
type ConnectionTIKTOKADSDataSource struct {
	client *sdk.SDK
}

// ConnectionTIKTOKADSDataSourceModel describes the data model.
type ConnectionTIKTOKADSDataSourceModel struct {
...
func (r *ConnectionTIKTOKADSDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_tik_tok_ads"
}

// Schema defines the schema for the data source.
func (r *ConnectionTIKTOKADSDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionTIKTOKADS DataSource",
...
func (r *ConnectionTIKTOKADSDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionTIKTOKADSDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionTIKTOKADSDataSourceModel
