...
var _ datasource.DataSource = &ConnectionVEEVADataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionVEEVADataSource{}

func NewConnectionVEEVADataSource() datasource.DataSource {
	return &ConnectionVEEVADataSource{}
}

// ConnectionVEEVADataSource is the data source implementation.
type ConnectionVEEVADataSource struct {
	client *sdk.SDK
}

// ConnectionVEEVADataSourceModel describes the data model.
type ConnectionVEEVADataSourceModel struct {
...
func (r *ConnectionVEEVADataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_veeva"
}

// Schema defines the schema for the data source.
func (r *ConnectionVEEVADataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionVEEVA DataSource",
...
func (r *ConnectionVEEVADataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionVEEVADataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionVEEVADataSourceModel
