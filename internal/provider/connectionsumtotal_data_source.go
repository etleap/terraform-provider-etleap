...
var _ datasource.DataSource = &ConnectionSUMTOTALDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionSUMTOTALDataSource{}

func NewConnectionSUMTOTALDataSource() datasource.DataSource {
	return &ConnectionSUMTOTALDataSource{}
}

// ConnectionSUMTOTALDataSource is the data source implementation.
type ConnectionSUMTOTALDataSource struct {
	client *sdk.SDK
}
...
func (r *ConnectionSUMTOTALDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_sumtotal"
}

// Schema defines the schema for the data source.
func (r *ConnectionSUMTOTALDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionSUMTOTAL DataSource",
...
func (r *ConnectionSUMTOTALDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionSUMTOTALDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionSUMTOTALDataSourceModel
