...
func (r *ConnectionPOSTGRESResourceModel) ToSharedConnectionPostgresInput() *shared.ConnectionPostgresInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionPostgresType(r.Type.ValueString())
...
func (r *ConnectionPOSTGRESResourceModel) RefreshFromSharedConnectionPostgres(resp *shared.ConnectionPostgres) {
...
func (r *ConnectionPOSTGRESResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
