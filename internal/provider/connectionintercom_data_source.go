...
var _ datasource.DataSource = &ConnectionINTERCOMDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionINTERCOMDataSource{}

func NewConnectionINTERCOMDataSource() datasource.DataSource {
	return &ConnectionINTERCOMDataSource{}
}

// ConnectionINTERCOMDataSource is the data source implementation.
type ConnectionINTERCOMDataSource struct {
	client *sdk.SDK
}

// ConnectionINTERCOMDataSourceModel describes the data model.
type ConnectionINTERCOMDataSourceModel struct {
...
func (r *ConnectionINTERCOMDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_intercom"
}

// Schema defines the schema for the data source.
func (r *ConnectionINTERCOMDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionINTERCOM DataSource",
...
func (r *ConnectionINTERCOMDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionINTERCOMDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionINTERCOMDataSourceModel
