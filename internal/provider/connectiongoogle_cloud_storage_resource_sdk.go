...
func (r *ConnectionGOOGLECLOUDSTORAGEResourceModel) ToSharedConnectionGoogleCloudStorageInput() *shared.ConnectionGoogleCloudStorageInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionGoogleCloudStorageType(r.Type.ValueString())
	...
	bucket := r.Bucket.ValueString()
	jsonCredentials := r.JSONCredentials.ValueString()
	out := shared.ConnectionGoogleCloudStorageInput{
		Name:            name,
		Type:            typeVar,
...
func (r *ConnectionGOOGLECLOUDSTORAGEResourceModel) RefreshFromSharedConnectionGoogleCloudStorage(resp *shared.ConnectionGoogleCloudStorage) {
	r.Active = types.BoolValue(resp.Active)
	r.Bucket = types.StringValue(resp.Bucket)
...
func (r *ConnectionGOOGLECLOUDSTORAGEResourceModel) ToSharedConnectionGoogleCloudStorageUpdate() *shared.ConnectionGoogleCloudStorageUpdate {
	...
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionGoogleCloudStorageUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	name := new(string)
	...
	bucket := new(string)
	if !r.Bucket.IsUnknown() && !r.Bucket.IsNull() {
		*bucket = r.Bucket.ValueString()
	} else {
		bucket = nil
	}
...
func (r *ConnectionGOOGLECLOUDSTORAGEResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
