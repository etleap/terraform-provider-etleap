...
func (r *ConnectionS3DATALAKEResourceModel) ToSharedConnectionS3DataLakeInput() *shared.ConnectionS3DataLakeInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionS3DataLakeType(r.Type.ValueString())
	...
	kmsKey := new(string)
	if !r.KmsKey.IsUnknown() && !r.KmsKey.IsNull() {
		*kmsKey = r.KmsKey.ValueString()
	} else {
		kmsKey = nil
	}
	writeManifest := new(bool)
	if !r.WriteManifest.IsUnknown() && !r.WriteManifest.IsNull() {
		*writeManifest = r.WriteManifest.ValueBool()
	} else {
		writeManifest = nil
	}
	...
	out := shared.ConnectionS3DataLakeInput{
		Name:           name,
		Type:           typeVar,
...
func (r *ConnectionS3DATALAKEResourceModel) RefreshFromSharedConnectionS3DataLake(resp *shared.ConnectionS3DataLake) {
	...
	r.GlueRegion = types.StringPointerValue(resp.GlueRegion)
	r.IamRole = types.StringValue(resp.IamRole)
	r.ID = types.StringValue(resp.ID)
	r.InputBucket = types.StringValue(resp.InputBucket)
	r.KmsKey = types.StringPointerValue(resp.KmsKey)
	...
	r.WriteManifest = types.BoolPointerValue(resp.WriteManifest)
}

func (r *ConnectionS3DATALAKEResourceModel) ToSharedConnectionS3DataLakeUpdate() *shared.ConnectionS3DataLakeUpdate {
	active := new(bool)
	...
	typeVar := new(shared.ConnectionS3DataLakeUpdateType)
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionS3DataLakeUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	name := new(string)
	...
	inputBucket := new(string)
	if !r.InputBucket.IsUnknown() && !r.InputBucket.IsNull() {
		*inputBucket = r.InputBucket.ValueString()
	} else {
		inputBucket = nil
	}
	...
	out := shared.ConnectionS3DataLakeUpdate{
		Active:         active,
		Type:           typeVar,
		Name:           name,
		UpdateSchedule: updateSchedule,
...
func (r *ConnectionS3DATALAKEResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
