...
func (r *ConnectionERPXResourceModel) RefreshFromSharedConnectionErpx(resp *shared.ConnectionErpx) {
	...
	r.TokenURL = types.StringValue(resp.TokenURL)
...
func (r *ConnectionERPXResourceModel) ToSharedConnectionErpxUpdate() *shared.ConnectionErpxUpdate {
	...
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionErpxUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	active := new(bool)
...
func (r *ConnectionERPXResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
