...
func (r *ConnectionDb2SHARDEDResourceModel) ToSharedConnectionDb2ShardedInput() *shared.ConnectionDb2ShardedInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionDb2ShardedType(r.Type.ValueString())
...
func (r *ConnectionDb2SHARDEDResourceModel) ToSharedConnectionDb2ShardedUpdate() *shared.ConnectionDb2ShardedUpdate {
	name := new(string)
	...
	typeVar := shared.ConnectionDb2ShardedUpdateType(r.Type.ValueString())
	active := new(bool)
...
func (r *ConnectionDb2SHARDEDResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
