...
var _ datasource.DataSource = &ConnectionQUORAADSDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionQUORAADSDataSource{}

func NewConnectionQUORAADSDataSource() datasource.DataSource {
	return &ConnectionQUORAADSDataSource{}
}

// ConnectionQUORAADSDataSource is the data source implementation.
type ConnectionQUORAADSDataSource struct {
	client *sdk.SDK
}

// ConnectionQUORAADSDataSourceModel describes the data model.
type ConnectionQUORAADSDataSourceModel struct {
...
func (r *ConnectionQUORAADSDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_quora_ads"
}

// Schema defines the schema for the data source.
func (r *ConnectionQUORAADSDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionQUORAADS DataSource",
...
func (r *ConnectionQUORAADSDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionQUORAADSDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionQUORAADSDataSourceModel
