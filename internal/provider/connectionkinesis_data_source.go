...
var _ datasource.DataSource = &ConnectionKINESISDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionKINESISDataSource{}

func NewConnectionKINESISDataSource() datasource.DataSource {
	return &ConnectionKINESISDataSource{}
}

// ConnectionKINESISDataSource is the data source implementation.
type ConnectionKINESISDataSource struct {
	client *sdk.SDK
}

// ConnectionKINESISDataSourceModel describes the data model.
type ConnectionKINESISDataSourceModel struct {
...
func (r *ConnectionKINESISDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_kinesis"
}

// Schema defines the schema for the data source.
func (r *ConnectionKINESISDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionKINESIS DataSource",
...
func (r *ConnectionKINESISDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionKINESISDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionKINESISDataSourceModel
