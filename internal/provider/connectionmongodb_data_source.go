...
var _ datasource.DataSource = &ConnectionMONGODBDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionMONGODBDataSource{}

func NewConnectionMONGODBDataSource() datasource.DataSource {
	return &ConnectionMONGODBDataSource{}
}

// ConnectionMONGODBDataSource is the data source implementation.
type ConnectionMONGODBDataSource struct {
	client *sdk.SDK
}
...
func (r *ConnectionMONGODBDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_mongodb"
}

// Schema defines the schema for the data source.
func (r *ConnectionMONGODBDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionMONGODB DataSource",
		...
		Attributes: map[string]schema.Attribute{
			...
			"use_ssl": schema.BoolAttribute{
				Computed:    true,
				Description: `Whether Etleap should connect over SSL.`,
			},
		},
	}
}

func (r *ConnectionMONGODBDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionMONGODBDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionMONGODBDataSourceModel
