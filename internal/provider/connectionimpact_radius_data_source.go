...
var _ datasource.DataSource = &ConnectionIMPACTRADIUSDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionIMPACTRADIUSDataSource{}

func NewConnectionIMPACTRADIUSDataSource() datasource.DataSource {
	return &ConnectionIMPACTRADIUSDataSource{}
}

// ConnectionIMPACTRADIUSDataSource is the data source implementation.
type ConnectionIMPACTRADIUSDataSource struct {
	client *sdk.SDK
}
...
func (r *ConnectionIMPACTRADIUSDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_impact_radius"
}

// Schema defines the schema for the data source.
func (r *ConnectionIMPACTRADIUSDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionIMPACTRADIUS DataSource",
...
func (r *ConnectionIMPACTRADIUSDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionIMPACTRADIUSDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionIMPACTRADIUSDataSourceModel
