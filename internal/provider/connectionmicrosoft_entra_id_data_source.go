...
var _ datasource.DataSource = &ConnectionMICROSOFTENTRAIDDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionMICROSOFTENTRAIDDataSource{}

func NewConnectionMICROSOFTENTRAIDDataSource() datasource.DataSource {
	return &ConnectionMICROSOFTENTRAIDDataSource{}
}

// ConnectionMICROSOFTENTRAIDDataSource is the data source implementation.
type ConnectionMICROSOFTENTRAIDDataSource struct {
	client *sdk.SDK
}

// ConnectionMICROSOFTENTRAIDDataSourceModel describes the data model.
type ConnectionMICROSOFTENTRAIDDataSourceModel struct {
...
func (r *ConnectionMICROSOFTENTRAIDDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_microsoft_entra_id"
}

// Schema defines the schema for the data source.
func (r *ConnectionMICROSOFTENTRAIDDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionMICROSOFTENTRAID DataSource",
...
func (r *ConnectionMICROSOFTENTRAIDDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionMICROSOFTENTRAIDDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionMICROSOFTENTRAIDDataSourceModel
