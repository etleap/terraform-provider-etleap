...
func (r *ConnectionGOOGLEANALYTICSGa4ResourceModel) ToSharedConnectionGoogleAnalyticsGa4Input() *shared.ConnectionGoogleAnalyticsGa4Input {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionGoogleAnalyticsGa4Type(r.Type.ValueString())
	...
	out := shared.ConnectionGoogleAnalyticsGa4Input{
		Name:           name,
		Type:           typeVar,
...
func (r *ConnectionGOOGLEANALYTICSGa4ResourceModel) RefreshFromSharedConnectionGoogleAnalyticsGa4(resp *shared.ConnectionGoogleAnalyticsGa4) {
...
func (r *ConnectionGOOGLEANALYTICSGa4ResourceModel) ToSharedConnectionGoogleAnalyticsGa4Update() *shared.ConnectionGoogleAnalyticsGa4Update {
	active := new(bool)
	...
	typeVar := shared.ConnectionGoogleAnalyticsGa4UpdateType(r.Type.ValueString())
	name := new(string)
	...
	out := shared.ConnectionGoogleAnalyticsGa4Update{
		Active:         active,
		Type:           typeVar,
		Name:           name,
		UpdateSchedule: updateSchedule,
...
func (r *ConnectionGOOGLEANALYTICSGa4ResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
