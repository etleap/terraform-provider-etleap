...
func (r *ConnectionBLACKLINEResourceModel) ToSharedConnectionBlacklineInput() *shared.ConnectionBlacklineInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionBlacklineType(r.Type.ValueString())
	...
	instanceScope := r.InstanceScope.ValueString()
	username := r.Username.ValueString()
	apiKey := r.APIKey.ValueString()
	out := shared.ConnectionBlacklineInput{
		Name:           name,
		Type:           typeVar,
...
func (r *ConnectionBLACKLINEResourceModel) RefreshFromSharedConnectionBlackline(resp *shared.ConnectionBlackline) {
	...
	r.InstanceScope = types.StringValue(resp.InstanceScope)
...
func (r *ConnectionBLACKLINEResourceModel) ToSharedConnectionBlacklineUpdate() *shared.ConnectionBlacklineUpdate {
	name := new(string)
	...
	typeVar := new(shared.ConnectionBlacklineUpdateType)
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionBlacklineUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	active := new(bool)
	...
	instanceScope := new(string)
	if !r.InstanceScope.IsUnknown() && !r.InstanceScope.IsNull() {
		*instanceScope = r.InstanceScope.ValueString()
	} else {
		instanceScope = nil
	}
	...
	out := shared.ConnectionBlacklineUpdate{
		Name:           name,
		Type:           typeVar,
		Active:         active,
		UpdateSchedule: updateSchedule,
...
func (r *ConnectionBLACKLINEResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
