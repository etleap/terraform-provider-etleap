...
var _ datasource.DataSource = &ConnectionMIXPANELDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionMIXPANELDataSource{}

func NewConnectionMIXPANELDataSource() datasource.DataSource {
	return &ConnectionMIXPANELDataSource{}
}

// ConnectionMIXPANELDataSource is the data source implementation.
type ConnectionMIXPANELDataSource struct {
	client *sdk.SDK
}
...
func (r *ConnectionMIXPANELDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_mixpanel"
}

// Schema defines the schema for the data source.
func (r *ConnectionMIXPANELDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionMIXPANEL DataSource",
...
func (r *ConnectionMIXPANELDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionMIXPANELDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionMIXPANELDataSourceModel
