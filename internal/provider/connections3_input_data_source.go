...
var _ datasource.DataSource = &ConnectionS3INPUTDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionS3INPUTDataSource{}

func NewConnectionS3INPUTDataSource() datasource.DataSource {
	return &ConnectionS3INPUTDataSource{}
}

// ConnectionS3INPUTDataSource is the data source implementation.
type ConnectionS3INPUTDataSource struct {
	client *sdk.SDK
}

// ConnectionS3INPUTDataSourceModel describes the data model.
type ConnectionS3INPUTDataSourceModel struct {
...
func (r *ConnectionS3INPUTDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_s3_input"
}

// Schema defines the schema for the data source.
func (r *ConnectionS3INPUTDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionS3INPUT DataSource",
...
func (r *ConnectionS3INPUTDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionS3INPUTDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionS3INPUTDataSourceModel
