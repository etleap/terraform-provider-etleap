...
var _ datasource.DataSource = &ConnectionSAPHANASHARDEDDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionSAPHANASHARDEDDataSource{}

func NewConnectionSAPHANASHARDEDDataSource() datasource.DataSource {
	return &ConnectionSAPHANASHARDEDDataSource{}
}

// ConnectionSAPHANASHARDEDDataSource is the data source implementation.
type ConnectionSAPHANASHARDEDDataSource struct {
	client *sdk.SDK
}
...
func (r *ConnectionSAPHANASHARDEDDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_sap_hana_sharded"
}

// Schema defines the schema for the data source.
func (r *ConnectionSAPHANASHARDEDDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionSAPHANASHARDED DataSource",
...
func (r *ConnectionSAPHANASHARDEDDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionSAPHANASHARDEDDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionSAPHANASHARDEDDataSourceModel
