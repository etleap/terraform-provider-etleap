...
var _ resource.Resource = &ConnectionWORKFRONTResource{}
var _ resource.ResourceWithImportState = &ConnectionWORKFRONTResource{}

func NewConnectionWORKFRONTResource() resource.Resource {
	return &ConnectionWORKFRONTResource{}
}

// ConnectionWORKFRONTResource defines the resource implementation.
type ConnectionWORKFRONTResource struct {
	client *sdk.SDK
}

// ConnectionWORKFRONTResourceModel describes the resource data model.
type ConnectionWORKFRONTResourceModel struct {
...
func (r *ConnectionWORKFRONTResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_workfront"
}

func (r *ConnectionWORKFRONTResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionWORKFRONT Resource",
		...
		Attributes: map[string]schema.Attribute{
			...
			"api_key": schema.StringAttribute{
				Required:    true,
				Description: `The client API key required to authenticate with the Workfront API. API keys can be generated by <a target="_blank" href="https://experience.workfront.com/s/article/Managing-API-Keys-for-the-Workfront-System-1973288244?ui-force-components-controllers-recordGlobalValueProvider.RecordGvp.getRecord=1&r=7"> following the documentation here</a>.`,
			},
			...
			"subdomain": schema.StringAttribute{
				Required:    true,
				Description: `Your Workfront subdomain (i.e. SUBDOMAIN.my.workfront.com)`,
			},
...
func (r *ConnectionWORKFRONTResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *ConnectionWORKFRONTResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *ConnectionWORKFRONTResourceModel
	...
	request := *data.ToSharedConnectionWorkfrontInput()
	res, err := r.client.Connection.CreateWORKFRONTConnection(ctx, request)
	if err != nil {
	...
	if res.ConnectionWorkfront == nil {
		resp.Diagnostics.AddError("unexpected response from API. No response body", debugResponse(res.RawResponse))
		return
	}
	data.RefreshFromSharedConnectionWorkfront(res.ConnectionWorkfront)
	refreshPlan(ctx, plan, &data, resp.Diagnostics)
	id := data.ID.ValueString()
	request1 := operations.GetWORKFRONTConnectionRequest{
		ID: id,
	}
	res1, err := r.client.Connection.GetWORKFRONTConnection(ctx, request1)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
	...
	if res1.ConnectionWorkfront == nil {
		resp.Diagnostics.AddError("unexpected response from API. No response body", debugResponse(res1.RawResponse))
		return
	}
	data.RefreshFromSharedConnectionWorkfront(res1.ConnectionWorkfront)
	refreshPlan(ctx, plan, &data, resp.Diagnostics)
...
func (r *ConnectionWORKFRONTResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *ConnectionWORKFRONTResourceModel
	...
	id := data.ID.ValueString()
	request := operations.GetWORKFRONTConnectionRequest{
		ID: id,
	}
	res, err := r.client.Connection.GetWORKFRONTConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionWORKFRONTResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *ConnectionWORKFRONTResourceModel
	var plan types.Object
	...
	id := data.ID.ValueString()
	connectionWorkfrontUpdate := data.ToSharedConnectionWorkfrontUpdate()
	request := operations.UpdateWORKFRONTConnectionRequest{
		ID:                        id,
		ConnectionWorkfrontUpdate: connectionWorkfrontUpdate,
	}
	res, err := r.client.Connection.UpdateWORKFRONTConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionWORKFRONTResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *ConnectionWORKFRONTResourceModel
	var item types.Object
	...
	request := operations.DeleteWORKFRONTConnectionRequest{
		ID:               id,
		ConnectionDelete: connectionDelete,
	}
	res, err := r.client.Connection.DeleteWORKFRONTConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionWORKFRONTResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
