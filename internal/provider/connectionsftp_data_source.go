...
var _ datasource.DataSource = &ConnectionSFTPDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionSFTPDataSource{}

func NewConnectionSFTPDataSource() datasource.DataSource {
	return &ConnectionSFTPDataSource{}
}

// ConnectionSFTPDataSource is the data source implementation.
type ConnectionSFTPDataSource struct {
	client *sdk.SDK
}
...
func (r *ConnectionSFTPDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_sftp"
}

// Schema defines the schema for the data source.
func (r *ConnectionSFTPDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionSFTP DataSource",
...
func (r *ConnectionSFTPDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionSFTPDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionSFTPDataSourceModel
