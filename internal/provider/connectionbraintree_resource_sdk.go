...
func (r *ConnectionBRAINTREEResourceModel) RefreshFromSharedConnectionBraintree(resp *shared.ConnectionBraintree) {
	...
	r.MerchantID = types.StringValue(resp.MerchantID)
...
func (r *ConnectionBRAINTREEResourceModel) ToSharedConnectionBraintreeUpdate() *shared.ConnectionBraintreeUpdate {
	...
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionBraintreeUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	active := new(bool)
...
func (r *ConnectionBRAINTREEResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
