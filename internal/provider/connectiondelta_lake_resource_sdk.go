...
func (r *ConnectionDELTALAKEResourceModel) ToSharedConnectionDeltaLakeUpdate() *shared.ConnectionDeltaLakeUpdate {
	...
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionDeltaLakeUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	name := new(string)
	...
	httpPath := new(string)
	if !r.HTTPPath.IsUnknown() && !r.HTTPPath.IsNull() {
		*httpPath = r.HTTPPath.ValueString()
	} else {
		httpPath = nil
	}
...
func (r *ConnectionDELTALAKEResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
