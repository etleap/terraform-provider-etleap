...
func (r *ConnectionFRESHWORKSResourceModel) ToSharedConnectionFreshworksInput() *shared.ConnectionFreshworksInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionFreshworksType(r.Type.ValueString())
...
func (r *ConnectionFRESHWORKSResourceModel) RefreshFromSharedConnectionFreshworks(resp *shared.ConnectionFreshworks) {
	...
	r.FreshcallerDomain = types.StringValue(resp.FreshcallerDomain)
	r.FreshdeskDomain = types.StringValue(resp.FreshdeskDomain)
...
func (r *ConnectionFRESHWORKSResourceModel) ToSharedConnectionFreshworksUpdate() *shared.ConnectionFreshworksUpdate {
	...
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionFreshworksUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	name := new(string)
	...
	freshdeskAPIKey := new(string)
	if !r.FreshdeskAPIKey.IsUnknown() && !r.FreshdeskAPIKey.IsNull() {
		*freshdeskAPIKey = r.FreshdeskAPIKey.ValueString()
	} else {
		freshdeskAPIKey = nil
	}
	freshcallerDomain := new(string)
	if !r.FreshcallerDomain.IsUnknown() && !r.FreshcallerDomain.IsNull() {
		*freshcallerDomain = r.FreshcallerDomain.ValueString()
	} else {
...
func (r *ConnectionFRESHWORKSResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
