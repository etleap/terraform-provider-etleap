...
func (r *ConnectionSALESLOFTResourceModel) ToSharedConnectionSalesloftInput() *shared.ConnectionSalesloftInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionSalesloftType(r.Type.ValueString())
	...
	out := shared.ConnectionSalesloftInput{
		Name:           name,
		Type:           typeVar,
...
func (r *ConnectionSALESLOFTResourceModel) RefreshFromSharedConnectionSalesloft(resp *shared.ConnectionSalesloft) {
...
func (r *ConnectionSALESLOFTResourceModel) ToSharedConnectionSalesloftUpdate() *shared.ConnectionSalesloftUpdate {
	name := new(string)
	...
	typeVar := new(shared.ConnectionSalesloftUpdateType)
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionSalesloftUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	active := new(bool)
	...
	out := shared.ConnectionSalesloftUpdate{
		Name:           name,
		Type:           typeVar,
		Active:         active,
		UpdateSchedule: updateSchedule,
...
func (r *ConnectionSALESLOFTResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
