...
func (r *ConnectionSAPCONCURResourceModel) ToSharedConnectionSapConcurUpdate() *shared.ConnectionSapConcurUpdate {
	...
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionSapConcurUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	active := new(bool)
...
func (r *ConnectionSAPCONCURResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
