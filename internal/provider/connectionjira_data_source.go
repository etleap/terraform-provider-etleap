...
var _ datasource.DataSource = &ConnectionJIRADataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionJIRADataSource{}

func NewConnectionJIRADataSource() datasource.DataSource {
	return &ConnectionJIRADataSource{}
}

// ConnectionJIRADataSource is the data source implementation.
type ConnectionJIRADataSource struct {
	client *sdk.SDK
}

// ConnectionJIRADataSourceModel describes the data model.
type ConnectionJIRADataSourceModel struct {
...
func (r *ConnectionJIRADataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_jira"
}

// Schema defines the schema for the data source.
func (r *ConnectionJIRADataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionJIRA DataSource",
...
func (r *ConnectionJIRADataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionJIRADataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionJIRADataSourceModel
