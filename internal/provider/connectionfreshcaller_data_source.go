...
var _ datasource.DataSource = &ConnectionFRESHCALLERDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionFRESHCALLERDataSource{}

func NewConnectionFRESHCALLERDataSource() datasource.DataSource {
	return &ConnectionFRESHCALLERDataSource{}
}

// ConnectionFRESHCALLERDataSource is the data source implementation.
type ConnectionFRESHCALLERDataSource struct {
	client *sdk.SDK
}

// ConnectionFRESHCALLERDataSourceModel describes the data model.
type ConnectionFRESHCALLERDataSourceModel struct {
...
func (r *ConnectionFRESHCALLERDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_freshcaller"
}

// Schema defines the schema for the data source.
func (r *ConnectionFRESHCALLERDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionFRESHCALLER DataSource",
...
func (r *ConnectionFRESHCALLERDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionFRESHCALLERDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionFRESHCALLERDataSourceModel
