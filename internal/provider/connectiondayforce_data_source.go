...
var _ datasource.DataSource = &ConnectionDAYFORCEDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionDAYFORCEDataSource{}

func NewConnectionDAYFORCEDataSource() datasource.DataSource {
	return &ConnectionDAYFORCEDataSource{}
}

// ConnectionDAYFORCEDataSource is the data source implementation.
type ConnectionDAYFORCEDataSource struct {
	client *sdk.SDK
}

// ConnectionDAYFORCEDataSourceModel describes the data model.
type ConnectionDAYFORCEDataSourceModel struct {
...
func (r *ConnectionDAYFORCEDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_dayforce"
}

// Schema defines the schema for the data source.
func (r *ConnectionDAYFORCEDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionDAYFORCE DataSource",
...
func (r *ConnectionDAYFORCEDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionDAYFORCEDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionDAYFORCEDataSourceModel
