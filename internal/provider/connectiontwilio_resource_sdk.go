...
func (r *ConnectionTWILIOResourceModel) ToSharedConnectionTwilioUpdate() *shared.ConnectionTwilioUpdate {
	...
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionTwilioUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	active := new(bool)
	...
	apiKeySid := new(string)
	if !r.APIKeySid.IsUnknown() && !r.APIKeySid.IsNull() {
		*apiKeySid = r.APIKeySid.ValueString()
	} else {
		apiKeySid = nil
	}
	apiKeySecret := new(string)
	if !r.APIKeySecret.IsUnknown() && !r.APIKeySecret.IsNull() {
		*apiKeySecret = r.APIKeySecret.ValueString()
	} else {
		apiKeySecret = nil
	}
...
func (r *ConnectionTWILIOResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
