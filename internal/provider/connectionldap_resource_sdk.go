...
func (r *ConnectionLDAPResourceModel) ToSharedConnectionLdapInput() *shared.ConnectionLdapInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionLdapType(r.Type.ValueString())
...
func (r *ConnectionLDAPResourceModel) RefreshFromSharedConnectionLdap(resp *shared.ConnectionLdap) {
	...
	r.Pen = types.Int64Value(resp.Pen)
...
func (r *ConnectionLDAPResourceModel) ToSharedConnectionLdapUpdate() *shared.ConnectionLdapUpdate {
	...
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionLdapUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	active := new(bool)
...
func (r *ConnectionLDAPResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
