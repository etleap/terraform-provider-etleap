...
var _ datasource.DataSource = &ConnectionSALESLOFTDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionSALESLOFTDataSource{}

func NewConnectionSALESLOFTDataSource() datasource.DataSource {
	return &ConnectionSALESLOFTDataSource{}
}

// ConnectionSALESLOFTDataSource is the data source implementation.
type ConnectionSALESLOFTDataSource struct {
	client *sdk.SDK
}

// ConnectionSALESLOFTDataSourceModel describes the data model.
type ConnectionSALESLOFTDataSourceModel struct {
...
func (r *ConnectionSALESLOFTDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_salesloft"
}

// Schema defines the schema for the data source.
func (r *ConnectionSALESLOFTDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionSALESLOFT DataSource",
...
func (r *ConnectionSALESLOFTDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionSALESLOFTDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionSALESLOFTDataSourceModel
