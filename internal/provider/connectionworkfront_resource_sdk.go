...
func (r *ConnectionWORKFRONTResourceModel) ToSharedConnectionWorkfrontInput() *shared.ConnectionWorkfrontInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionWorkfrontType(r.Type.ValueString())
	...
	out := shared.ConnectionWorkfrontInput{
		Name:           name,
		Type:           typeVar,
...
func (r *ConnectionWORKFRONTResourceModel) RefreshFromSharedConnectionWorkfront(resp *shared.ConnectionWorkfront) {
...
func (r *ConnectionWORKFRONTResourceModel) ToSharedConnectionWorkfrontUpdate() *shared.ConnectionWorkfrontUpdate {
	name := new(string)
	...
	typeVar := new(shared.ConnectionWorkfrontUpdateType)
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionWorkfrontUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	active := new(bool)
	...
	out := shared.ConnectionWorkfrontUpdate{
		Name:           name,
		Type:           typeVar,
		Active:         active,
		UpdateSchedule: updateSchedule,
...
func (r *ConnectionWORKFRONTResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
