...
var _ resource.Resource = &ConnectionRAVEMEDIDATAResource{}
var _ resource.ResourceWithImportState = &ConnectionRAVEMEDIDATAResource{}

func NewConnectionRAVEMEDIDATAResource() resource.Resource {
	return &ConnectionRAVEMEDIDATAResource{}
}

// ConnectionRAVEMEDIDATAResource defines the resource implementation.
type ConnectionRAVEMEDIDATAResource struct {
	client *sdk.SDK
}
...
func (r *ConnectionRAVEMEDIDATAResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_rave_medidata"
}

func (r *ConnectionRAVEMEDIDATAResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionRAVEMEDIDATA Resource",
		...
		Attributes: map[string]schema.Attribute{
			...
			"hostname": schema.StringAttribute{
				Required:    true,
				Description: `E.g., my-org.mdsol.com`,
			},
			...
			"password": schema.StringAttribute{
				Required:    true,
				Description: `Rave Account Password`,
			},
			...
			"username": schema.StringAttribute{
				Required:    true,
				Description: `Rave Account Login`,
			},
		},
	}
}

func (r *ConnectionRAVEMEDIDATAResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *ConnectionRAVEMEDIDATAResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *ConnectionRAVEMEDIDATAResourceModel
	...
	if res.ConnectionRaveMedidata == nil {
	...
	res1, err := r.client.Connection.GetRAVEMEDIDATAConnection(ctx, request1)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
	...
	if res1.ConnectionRaveMedidata == nil {
...
func (r *ConnectionRAVEMEDIDATAResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *ConnectionRAVEMEDIDATAResourceModel
	...
	id := data.ID.ValueString()
	request := operations.GetRAVEMEDIDATAConnectionRequest{
		ID: id,
	}
	res, err := r.client.Connection.GetRAVEMEDIDATAConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionRAVEMEDIDATAResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *ConnectionRAVEMEDIDATAResourceModel
	var plan types.Object
	...
	id := data.ID.ValueString()
	connectionRaveMedidataUpdate := data.ToSharedConnectionRaveMedidataUpdate()
	request := operations.UpdateRAVEMEDIDATAConnectionRequest{
		ID:                           id,
		ConnectionRaveMedidataUpdate: connectionRaveMedidataUpdate,
	}
	res, err := r.client.Connection.UpdateRAVEMEDIDATAConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionRAVEMEDIDATAResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *ConnectionRAVEMEDIDATAResourceModel
	var item types.Object
	...
	request := operations.DeleteRAVEMEDIDATAConnectionRequest{
		ID:               id,
		ConnectionDelete: connectionDelete,
	}
	res, err := r.client.Connection.DeleteRAVEMEDIDATAConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionRAVEMEDIDATAResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
