...
var _ resource.Resource = &ConnectionNETSUITEResource{}
var _ resource.ResourceWithImportState = &ConnectionNETSUITEResource{}

func NewConnectionNETSUITEResource() resource.Resource {
	return &ConnectionNETSUITEResource{}
}

// ConnectionNETSUITEResource defines the resource implementation.
type ConnectionNETSUITEResource struct {
	client *sdk.SDK
}

// ConnectionNETSUITEResourceModel describes the resource data model.
type ConnectionNETSUITEResourceModel struct {
...
func (r *ConnectionNETSUITEResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_netsuite"
}

func (r *ConnectionNETSUITEResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionNETSUITE Resource",

		Attributes: map[string]schema.Attribute{
			"account_id": schema.StringAttribute{
				Required:    true,
				Description: `Under Setup -> Integration -> SOAP Web Services Preferences.`,
			},
...
func (r *ConnectionNETSUITEResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *ConnectionNETSUITEResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *ConnectionNETSUITEResourceModel
	...
	request := *data.ToSharedConnectionNetsuiteInput()
	res, err := r.client.Connection.CreateNETSUITEConnection(ctx, request)
	if err != nil {
	...
	if res.ConnectionNetsuite == nil {
		resp.Diagnostics.AddError("unexpected response from API. No response body", debugResponse(res.RawResponse))
		return
	}
	data.RefreshFromSharedConnectionNetsuite(res.ConnectionNetsuite)
	refreshPlan(ctx, plan, &data, resp.Diagnostics)
	id := data.ID.ValueString()
	request1 := operations.GetNETSUITEConnectionRequest{
		ID: id,
	}
	res1, err := r.client.Connection.GetNETSUITEConnection(ctx, request1)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
	...
	if res1.ConnectionNetsuite == nil {
		resp.Diagnostics.AddError("unexpected response from API. No response body", debugResponse(res1.RawResponse))
		return
	}
	data.RefreshFromSharedConnectionNetsuite(res1.ConnectionNetsuite)
	refreshPlan(ctx, plan, &data, resp.Diagnostics)
...
func (r *ConnectionNETSUITEResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *ConnectionNETSUITEResourceModel
	...
	id := data.ID.ValueString()
	request := operations.GetNETSUITEConnectionRequest{
		ID: id,
	}
	res, err := r.client.Connection.GetNETSUITEConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionNETSUITEResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *ConnectionNETSUITEResourceModel
	var plan types.Object
	...
	id := data.ID.ValueString()
	connectionNetsuiteUpdate := data.ToSharedConnectionNetsuiteUpdate()
	request := operations.UpdateNETSUITEConnectionRequest{
		ID:                       id,
		ConnectionNetsuiteUpdate: connectionNetsuiteUpdate,
	}
	res, err := r.client.Connection.UpdateNETSUITEConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionNETSUITEResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *ConnectionNETSUITEResourceModel
	var item types.Object
	...
	request := operations.DeleteNETSUITEConnectionRequest{
		ID:               id,
		ConnectionDelete: connectionDelete,
	}
	res, err := r.client.Connection.DeleteNETSUITEConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionNETSUITEResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
