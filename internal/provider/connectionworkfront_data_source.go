...
var _ datasource.DataSource = &ConnectionWORKFRONTDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionWORKFRONTDataSource{}

func NewConnectionWORKFRONTDataSource() datasource.DataSource {
	return &ConnectionWORKFRONTDataSource{}
}

// ConnectionWORKFRONTDataSource is the data source implementation.
type ConnectionWORKFRONTDataSource struct {
	client *sdk.SDK
}

// ConnectionWORKFRONTDataSourceModel describes the data model.
type ConnectionWORKFRONTDataSourceModel struct {
...
func (r *ConnectionWORKFRONTDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_workfront"
}

// Schema defines the schema for the data source.
func (r *ConnectionWORKFRONTDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionWORKFRONT DataSource",
...
func (r *ConnectionWORKFRONTDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionWORKFRONTDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionWORKFRONTDataSourceModel
