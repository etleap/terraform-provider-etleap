...
func (r *ConnectionMICROSOFTENTRAIDResourceModel) ToSharedConnectionMicrosoftEntraIDInput() *shared.ConnectionMicrosoftEntraIDInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionMicrosoftEntraIDType(r.Type.ValueString())
	...
	out := shared.ConnectionMicrosoftEntraIDInput{
		Name:           name,
		Type:           typeVar,
...
func (r *ConnectionMICROSOFTENTRAIDResourceModel) RefreshFromSharedConnectionMicrosoftEntraID(resp *shared.ConnectionMicrosoftEntraID) {
...
func (r *ConnectionMICROSOFTENTRAIDResourceModel) ToSharedConnectionMicrosoftEntraIDUpdate() *shared.ConnectionMicrosoftEntraIDUpdate {
	active := new(bool)
	...
	typeVar := shared.ConnectionMicrosoftEntraIDUpdateType(r.Type.ValueString())
	name := new(string)
	...
	out := shared.ConnectionMicrosoftEntraIDUpdate{
		Active:         active,
		Type:           typeVar,
		Name:           name,
		UpdateSchedule: updateSchedule,
...
func (r *ConnectionMICROSOFTENTRAIDResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
