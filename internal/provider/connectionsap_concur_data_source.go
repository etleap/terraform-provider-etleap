...
var _ datasource.DataSource = &ConnectionSAPCONCURDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionSAPCONCURDataSource{}

func NewConnectionSAPCONCURDataSource() datasource.DataSource {
	return &ConnectionSAPCONCURDataSource{}
}

// ConnectionSAPCONCURDataSource is the data source implementation.
type ConnectionSAPCONCURDataSource struct {
	client *sdk.SDK
}
...
func (r *ConnectionSAPCONCURDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_sap_concur"
}

// Schema defines the schema for the data source.
func (r *ConnectionSAPCONCURDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionSAPCONCUR DataSource",
...
func (r *ConnectionSAPCONCURDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionSAPCONCURDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionSAPCONCURDataSourceModel
