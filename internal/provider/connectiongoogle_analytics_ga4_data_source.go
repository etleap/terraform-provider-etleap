...
var _ datasource.DataSource = &ConnectionGOOGLEANALYTICSGa4DataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionGOOGLEANALYTICSGa4DataSource{}

func NewConnectionGOOGLEANALYTICSGa4DataSource() datasource.DataSource {
	return &ConnectionGOOGLEANALYTICSGa4DataSource{}
}

// ConnectionGOOGLEANALYTICSGa4DataSource is the data source implementation.
type ConnectionGOOGLEANALYTICSGa4DataSource struct {
	client *sdk.SDK
}

// ConnectionGOOGLEANALYTICSGa4DataSourceModel describes the data model.
type ConnectionGOOGLEANALYTICSGa4DataSourceModel struct {
...
func (r *ConnectionGOOGLEANALYTICSGa4DataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_google_analytics_ga4"
}

// Schema defines the schema for the data source.
func (r *ConnectionGOOGLEANALYTICSGa4DataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionGOOGLEANALYTICSGa4 DataSource",
...
func (r *ConnectionGOOGLEANALYTICSGa4DataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionGOOGLEANALYTICSGa4DataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionGOOGLEANALYTICSGa4DataSourceModel
