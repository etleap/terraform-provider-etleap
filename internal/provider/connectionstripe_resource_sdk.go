...
func (r *ConnectionSTRIPEResourceModel) ToSharedConnectionStripeUpdate() *shared.ConnectionStripeUpdate {
	...
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionStripeUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	name := new(string)
	...
	apiSecretKey := new(string)
	if !r.APISecretKey.IsUnknown() && !r.APISecretKey.IsNull() {
		*apiSecretKey = r.APISecretKey.ValueString()
	} else {
		apiSecretKey = nil
	}
...
func (r *ConnectionSTRIPEResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
