...
var _ datasource.DataSource = &ConnectionSQSDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionSQSDataSource{}

func NewConnectionSQSDataSource() datasource.DataSource {
	return &ConnectionSQSDataSource{}
}

// ConnectionSQSDataSource is the data source implementation.
type ConnectionSQSDataSource struct {
	client *sdk.SDK
}

// ConnectionSQSDataSourceModel describes the data model.
type ConnectionSQSDataSourceModel struct {
...
func (r *ConnectionSQSDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_sqs"
}

// Schema defines the schema for the data source.
func (r *ConnectionSQSDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionSQS DataSource",
...
func (r *ConnectionSQSDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionSQSDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionSQSDataSourceModel
