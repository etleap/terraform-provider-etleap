...
func (r *ConnectionFTPResourceModel) ToSharedConnectionFtpInput() *shared.ConnectionFtpInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionFtpType(r.Type.ValueString())
...
func (r *ConnectionFTPResourceModel) RefreshFromSharedConnectionFtp(resp *shared.ConnectionFtp) {
	...
	r.PassiveMode = types.BoolValue(resp.PassiveMode)
...
func (r *ConnectionFTPResourceModel) ToSharedConnectionFtpUpdate() *shared.ConnectionFtpUpdate {
	...
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionFtpUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	active := new(bool)
...
func (r *ConnectionFTPResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
