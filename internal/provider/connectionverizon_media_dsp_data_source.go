...
var _ datasource.DataSource = &ConnectionVERIZONMEDIADSPDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionVERIZONMEDIADSPDataSource{}

func NewConnectionVERIZONMEDIADSPDataSource() datasource.DataSource {
	return &ConnectionVERIZONMEDIADSPDataSource{}
}

// ConnectionVERIZONMEDIADSPDataSource is the data source implementation.
type ConnectionVERIZONMEDIADSPDataSource struct {
	client *sdk.SDK
}

// ConnectionVERIZONMEDIADSPDataSourceModel describes the data model.
type ConnectionVERIZONMEDIADSPDataSourceModel struct {
...
func (r *ConnectionVERIZONMEDIADSPDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_verizon_media_dsp"
}

// Schema defines the schema for the data source.
func (r *ConnectionVERIZONMEDIADSPDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionVERIZONMEDIADSP DataSource",
...
func (r *ConnectionVERIZONMEDIADSPDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionVERIZONMEDIADSPDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionVERIZONMEDIADSPDataSourceModel
