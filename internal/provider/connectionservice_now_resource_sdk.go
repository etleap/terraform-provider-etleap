...
func (r *ConnectionSERVICENOWResourceModel) ToSharedConnectionServiceNowInput() *shared.ConnectionServiceNowInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionServiceNowType(r.Type.ValueString())
...
func (r *ConnectionSERVICENOWResourceModel) RefreshFromSharedConnectionServiceNow(resp *shared.ConnectionServiceNow) {
...
func (r *ConnectionSERVICENOWResourceModel) ToSharedConnectionServiceNowUpdate() *shared.ConnectionServiceNowUpdate {
	...
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionServiceNowUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	active := new(bool)
...
func (r *ConnectionSERVICENOWResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
