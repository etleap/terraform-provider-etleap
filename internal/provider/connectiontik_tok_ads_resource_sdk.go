...
func (r *ConnectionTIKTOKADSResourceModel) ToSharedConnectionTikTokAdsInput() *shared.ConnectionTikTokAdsInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionTikTokAdsType(r.Type.ValueString())
	...
	out := shared.ConnectionTikTokAdsInput{
		Name:           name,
		Type:           typeVar,
...
func (r *ConnectionTIKTOKADSResourceModel) RefreshFromSharedConnectionTikTokAds(resp *shared.ConnectionTikTokAds) {
...
func (r *ConnectionTIKTOKADSResourceModel) ToSharedConnectionTikTokAdsUpdate() *shared.ConnectionTikTokAdsUpdate {
	name := new(string)
	...
	typeVar := shared.ConnectionTikTokAdsUpdateType(r.Type.ValueString())
	active := new(bool)
	...
	out := shared.ConnectionTikTokAdsUpdate{
		Name:           name,
		Type:           typeVar,
		Active:         active,
		UpdateSchedule: updateSchedule,
...
func (r *ConnectionTIKTOKADSResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
