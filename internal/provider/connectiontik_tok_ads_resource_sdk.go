...
func (r *ConnectionTIKTOKADSResourceModel) ToSharedConnectionTikTokAds() *shared.ConnectionTikTokAds {
	...
	out := shared.ConnectionTikTokAds{
		Name:           name,
		Type:           typeVar,
...
func (r *ConnectionTIKTOKADSResourceModel) RefreshFromSharedConnectionTikTokAdsOutput(resp *shared.ConnectionTikTokAdsOutput) {
