...
var _ datasource.DataSource = &ConnectionNETSUITEDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionNETSUITEDataSource{}

func NewConnectionNETSUITEDataSource() datasource.DataSource {
	return &ConnectionNETSUITEDataSource{}
}

// ConnectionNETSUITEDataSource is the data source implementation.
type ConnectionNETSUITEDataSource struct {
	client *sdk.SDK
}

// ConnectionNETSUITEDataSourceModel describes the data model.
type ConnectionNETSUITEDataSourceModel struct {
...
func (r *ConnectionNETSUITEDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_netsuite"
}

// Schema defines the schema for the data source.
func (r *ConnectionNETSUITEDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionNETSUITE DataSource",
...
func (r *ConnectionNETSUITEDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionNETSUITEDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionNETSUITEDataSourceModel
