...
var _ datasource.DataSource = &ConnectionSAPODATADataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionSAPODATADataSource{}

func NewConnectionSAPODATADataSource() datasource.DataSource {
	return &ConnectionSAPODATADataSource{}
}

// ConnectionSAPODATADataSource is the data source implementation.
type ConnectionSAPODATADataSource struct {
	client *sdk.SDK
}

// ConnectionSAPODATADataSourceModel describes the data model.
type ConnectionSAPODATADataSourceModel struct {
...
func (r *ConnectionSAPODATADataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_sap_odata"
}

// Schema defines the schema for the data source.
func (r *ConnectionSAPODATADataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionSAPODATA DataSource",
...
func (r *ConnectionSAPODATADataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionSAPODATADataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionSAPODATADataSourceModel
