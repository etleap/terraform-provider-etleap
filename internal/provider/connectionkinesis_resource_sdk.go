...
func (r *ConnectionKINESISResourceModel) ToSharedConnectionKinesisInput() *shared.ConnectionKinesisInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionKinesisType(r.Type.ValueString())
	...
	iamRoleArn := r.IamRoleArn.ValueString()
	region := r.Region.ValueString()
	out := shared.ConnectionKinesisInput{
		Name:           name,
		Type:           typeVar,
...
func (r *ConnectionKINESISResourceModel) RefreshFromSharedConnectionKinesis(resp *shared.ConnectionKinesis) {
	...
	r.IamRoleArn = types.StringValue(resp.IamRoleArn)
...
func (r *ConnectionKINESISResourceModel) ToSharedConnectionKinesisUpdate() *shared.ConnectionKinesisUpdate {
	name := new(string)
	...
	typeVar := new(shared.ConnectionKinesisUpdateType)
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionKinesisUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	active := new(bool)
	...
	iamRoleArn := new(string)
	if !r.IamRoleArn.IsUnknown() && !r.IamRoleArn.IsNull() {
		*iamRoleArn = r.IamRoleArn.ValueString()
	} else {
		iamRoleArn = nil
	}
	...
	out := shared.ConnectionKinesisUpdate{
		Name:           name,
		Type:           typeVar,
		Active:         active,
		UpdateSchedule: updateSchedule,
...
func (r *ConnectionKINESISResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
