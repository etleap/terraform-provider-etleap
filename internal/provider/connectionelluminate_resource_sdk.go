...
func (r *ConnectionELLUMINATEResourceModel) ToSharedConnectionElluminateInput() *shared.ConnectionElluminateInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionElluminateType(r.Type.ValueString())
...
func (r *ConnectionELLUMINATEResourceModel) RefreshFromSharedConnectionElluminate(resp *shared.ConnectionElluminate) {
...
func (r *ConnectionELLUMINATEResourceModel) ToSharedConnectionElluminateUpdate() *shared.ConnectionElluminateUpdate {
	...
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionElluminateUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	name := new(string)
...
func (r *ConnectionELLUMINATEResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
