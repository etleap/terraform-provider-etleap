...
var _ datasource.DataSource = &ConnectionDb2DataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionDb2DataSource{}

func NewConnectionDb2DataSource() datasource.DataSource {
	return &ConnectionDb2DataSource{}
}

// ConnectionDb2DataSource is the data source implementation.
type ConnectionDb2DataSource struct {
	client *sdk.SDK
}
...
func (r *ConnectionDb2DataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_db2"
}

// Schema defines the schema for the data source.
func (r *ConnectionDb2DataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionDb2 DataSource",
...
func (r *ConnectionDb2DataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionDb2DataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionDb2DataSourceModel
