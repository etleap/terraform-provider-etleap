...
var _ datasource.DataSource = &ConnectionFACEBOOKADSDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionFACEBOOKADSDataSource{}

func NewConnectionFACEBOOKADSDataSource() datasource.DataSource {
	return &ConnectionFACEBOOKADSDataSource{}
}

// ConnectionFACEBOOKADSDataSource is the data source implementation.
type ConnectionFACEBOOKADSDataSource struct {
	client *sdk.SDK
}
...
func (r *ConnectionFACEBOOKADSDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_facebook_ads"
}

// Schema defines the schema for the data source.
func (r *ConnectionFACEBOOKADSDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionFACEBOOKADS DataSource",
...
func (r *ConnectionFACEBOOKADSDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionFACEBOOKADSDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionFACEBOOKADSDataSourceModel
