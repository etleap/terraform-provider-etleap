...
var _ datasource.DataSource = &ConnectionSNOWFLAKEDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionSNOWFLAKEDataSource{}

func NewConnectionSNOWFLAKEDataSource() datasource.DataSource {
	return &ConnectionSNOWFLAKEDataSource{}
}

// ConnectionSNOWFLAKEDataSource is the data source implementation.
type ConnectionSNOWFLAKEDataSource struct {
	client *sdk.SDK
}
...
func (r *ConnectionSNOWFLAKEDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_snowflake"
}

// Schema defines the schema for the data source.
func (r *ConnectionSNOWFLAKEDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionSNOWFLAKE DataSource",
...
func (r *ConnectionSNOWFLAKEDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionSNOWFLAKEDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionSNOWFLAKEDataSourceModel
