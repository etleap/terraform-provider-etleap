...
var _ datasource.DataSource = &ConnectionKUSTOMERDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionKUSTOMERDataSource{}

func NewConnectionKUSTOMERDataSource() datasource.DataSource {
	return &ConnectionKUSTOMERDataSource{}
}

// ConnectionKUSTOMERDataSource is the data source implementation.
type ConnectionKUSTOMERDataSource struct {
	client *sdk.SDK
}

// ConnectionKUSTOMERDataSourceModel describes the data model.
type ConnectionKUSTOMERDataSourceModel struct {
...
func (r *ConnectionKUSTOMERDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_kustomer"
}

// Schema defines the schema for the data source.
func (r *ConnectionKUSTOMERDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionKUSTOMER DataSource",
...
func (r *ConnectionKUSTOMERDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionKUSTOMERDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionKUSTOMERDataSourceModel
