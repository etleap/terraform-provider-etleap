...
var _ resource.Resource = &ConnectionOUTLOOKResource{}
var _ resource.ResourceWithImportState = &ConnectionOUTLOOKResource{}

func NewConnectionOUTLOOKResource() resource.Resource {
	return &ConnectionOUTLOOKResource{}
}

// ConnectionOUTLOOKResource defines the resource implementation.
type ConnectionOUTLOOKResource struct {
	client *sdk.SDK
}
...
func (r *ConnectionOUTLOOKResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_outlook"
}

func (r *ConnectionOUTLOOKResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionOUTLOOK Resource",
...
func (r *ConnectionOUTLOOKResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *ConnectionOUTLOOKResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *ConnectionOUTLOOKResourceModel
	...
	res1, err := r.client.Connection.GetOUTLOOKConnection(ctx, request1)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
...
func (r *ConnectionOUTLOOKResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *ConnectionOUTLOOKResourceModel
	...
	id := data.ID.ValueString()
	request := operations.GetOUTLOOKConnectionRequest{
		ID: id,
	}
	res, err := r.client.Connection.GetOUTLOOKConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionOUTLOOKResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *ConnectionOUTLOOKResourceModel
	var plan types.Object
	...
	id := data.ID.ValueString()
	connectionOutlookUpdate := data.ToSharedConnectionOutlookUpdate()
	request := operations.UpdateOUTLOOKConnectionRequest{
		ID:                      id,
		ConnectionOutlookUpdate: connectionOutlookUpdate,
	}
	res, err := r.client.Connection.UpdateOUTLOOKConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionOUTLOOKResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *ConnectionOUTLOOKResourceModel
	var item types.Object
	...
	request := operations.DeleteOUTLOOKConnectionRequest{
		ID:               id,
		ConnectionDelete: connectionDelete,
	}
	res, err := r.client.Connection.DeleteOUTLOOKConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionOUTLOOKResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
