...
func (r *ConnectionGOOGLESHEETSResourceModel) ToSharedConnectionGoogleSheetsInput() *shared.ConnectionGoogleSheetsInput {
	...
	authenticationMethod := new(shared.AuthenticationMethod)
	if !r.AuthenticationMethod.IsUnknown() && !r.AuthenticationMethod.IsNull() {
		*authenticationMethod = shared.AuthenticationMethod(r.AuthenticationMethod.ValueString())
	} else {
	...
	out := shared.ConnectionGoogleSheetsInput{
		Name:                 name,
		Type:                 typeVar,
...
func (r *ConnectionGOOGLESHEETSResourceModel) RefreshFromSharedConnectionGoogleSheets(resp *shared.ConnectionGoogleSheets) {
	r.Active = types.BoolValue(resp.Active)
	if resp.AuthenticationMethod != nil {
		r.AuthenticationMethod = types.StringValue(string(*resp.AuthenticationMethod))
	} else {
		r.AuthenticationMethod = types.StringNull()
	}
