...
func (r *ConnectionFRESHCALLERResourceModel) ToSharedConnectionFreshcallerInput() *shared.ConnectionFreshcallerInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionFreshcallerType(r.Type.ValueString())
	...
	out := shared.ConnectionFreshcallerInput{
		Name:           name,
		Type:           typeVar,
...
func (r *ConnectionFRESHCALLERResourceModel) RefreshFromSharedConnectionFreshcaller(resp *shared.ConnectionFreshcaller) {
...
func (r *ConnectionFRESHCALLERResourceModel) ToSharedConnectionFreshcallerUpdate() *shared.ConnectionFreshcallerUpdate {
	name := new(string)
	...
	typeVar := new(shared.ConnectionFreshcallerUpdateType)
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionFreshcallerUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	active := new(bool)
	...
	out := shared.ConnectionFreshcallerUpdate{
		Name:           name,
		Type:           typeVar,
		Active:         active,
		UpdateSchedule: updateSchedule,
...
func (r *ConnectionFRESHCALLERResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
