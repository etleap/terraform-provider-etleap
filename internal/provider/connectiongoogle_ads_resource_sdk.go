...
func (r *ConnectionGOOGLEADSResourceModel) ToSharedConnectionGoogleAdsInput() *shared.ConnectionGoogleAdsInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionGoogleAdsType(r.Type.ValueString())
	...
	out := shared.ConnectionGoogleAdsInput{
		Name:           name,
		Type:           typeVar,
...
func (r *ConnectionGOOGLEADSResourceModel) RefreshFromSharedConnectionGoogleAds(resp *shared.ConnectionGoogleAds) {
...
func (r *ConnectionGOOGLEADSResourceModel) ToSharedConnectionGoogleAdsUpdate() *shared.ConnectionGoogleAdsUpdate {
	name := new(string)
	...
	out := shared.ConnectionGoogleAdsUpdate{
		Name:           name,
		Type:           typeVar,
		Active:         active,
		UpdateSchedule: updateSchedule,
...
func (r *ConnectionGOOGLEADSResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
