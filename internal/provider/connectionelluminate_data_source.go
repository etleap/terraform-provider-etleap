...
var _ datasource.DataSource = &ConnectionELLUMINATEDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionELLUMINATEDataSource{}

func NewConnectionELLUMINATEDataSource() datasource.DataSource {
	return &ConnectionELLUMINATEDataSource{}
}

// ConnectionELLUMINATEDataSource is the data source implementation.
type ConnectionELLUMINATEDataSource struct {
	client *sdk.SDK
}
...
func (r *ConnectionELLUMINATEDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_elluminate"
}

// Schema defines the schema for the data source.
func (r *ConnectionELLUMINATEDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionELLUMINATE DataSource",
...
func (r *ConnectionELLUMINATEDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionELLUMINATEDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionELLUMINATEDataSourceModel
