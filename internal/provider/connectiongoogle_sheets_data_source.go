...
var _ datasource.DataSource = &ConnectionGOOGLESHEETSDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionGOOGLESHEETSDataSource{}

func NewConnectionGOOGLESHEETSDataSource() datasource.DataSource {
	return &ConnectionGOOGLESHEETSDataSource{}
}

// ConnectionGOOGLESHEETSDataSource is the data source implementation.
type ConnectionGOOGLESHEETSDataSource struct {
	client *sdk.SDK
}

// ConnectionGOOGLESHEETSDataSourceModel describes the data model.
type ConnectionGOOGLESHEETSDataSourceModel struct {
...
func (r *ConnectionGOOGLESHEETSDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_google_sheets"
}

// Schema defines the schema for the data source.
func (r *ConnectionGOOGLESHEETSDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionGOOGLESHEETS DataSource",
...
func (r *ConnectionGOOGLESHEETSDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionGOOGLESHEETSDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionGOOGLESHEETSDataSourceModel
