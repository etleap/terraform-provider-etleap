...
func (r *ConnectionMICROSOFTLISTSResourceModel) ToSharedConnectionMicrosoftListsInput() *shared.ConnectionMicrosoftListsInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionMicrosoftListsType(r.Type.ValueString())
	...
	out := shared.ConnectionMicrosoftListsInput{
		Name:           name,
		Type:           typeVar,
...
func (r *ConnectionMICROSOFTLISTSResourceModel) RefreshFromSharedConnectionMicrosoftLists(resp *shared.ConnectionMicrosoftLists) {
...
func (r *ConnectionMICROSOFTLISTSResourceModel) ToSharedConnectionMicrosoftListsUpdate() *shared.ConnectionMicrosoftListsUpdate {
	name := new(string)
	...
	typeVar := new(shared.ConnectionMicrosoftListsUpdateType)
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionMicrosoftListsUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	active := new(bool)
	...
	out := shared.ConnectionMicrosoftListsUpdate{
		Name:           name,
		Type:           typeVar,
		Active:         active,
		UpdateSchedule: updateSchedule,
...
func (r *ConnectionMICROSOFTLISTSResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
