...
func (r *ConnectionGITLABResourceModel) ToSharedConnectionGitlabInput() *shared.ConnectionGitlabInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionGitlabType(r.Type.ValueString())
	...
	out := shared.ConnectionGitlabInput{
		Name:           name,
		Type:           typeVar,
...
func (r *ConnectionGITLABResourceModel) RefreshFromSharedConnectionGitlab(resp *shared.ConnectionGitlab) {
	r.Active = types.BoolValue(resp.Active)
	r.APIURL = types.StringPointerValue(resp.APIURL)
...
func (r *ConnectionGITLABResourceModel) ToSharedConnectionGitlabUpdate() *shared.ConnectionGitlabUpdate {
	name := new(string)
	...
	typeVar := new(shared.ConnectionGitlabUpdateType)
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionGitlabUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	active := new(bool)
	...
	out := shared.ConnectionGitlabUpdate{
		Name:           name,
		Type:           typeVar,
		Active:         active,
		UpdateSchedule: updateSchedule,
...
func (r *ConnectionGITLABResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
