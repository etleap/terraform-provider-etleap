...
var _ datasource.DataSource = &ConnectionELOQUADataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionELOQUADataSource{}

func NewConnectionELOQUADataSource() datasource.DataSource {
	return &ConnectionELOQUADataSource{}
}

// ConnectionELOQUADataSource is the data source implementation.
type ConnectionELOQUADataSource struct {
	client *sdk.SDK
}
...
func (r *ConnectionELOQUADataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_eloqua"
}

// Schema defines the schema for the data source.
func (r *ConnectionELOQUADataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionELOQUA DataSource",
...
func (r *ConnectionELOQUADataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionELOQUADataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionELOQUADataSourceModel
