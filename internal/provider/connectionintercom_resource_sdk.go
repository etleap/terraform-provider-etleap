...
func (r *ConnectionINTERCOMResourceModel) ToSharedConnectionIntercomInput() *shared.ConnectionIntercomInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionIntercomType(r.Type.ValueString())
	...
	out := shared.ConnectionIntercomInput{
		Name:           name,
		Type:           typeVar,
...
func (r *ConnectionINTERCOMResourceModel) RefreshFromSharedConnectionIntercom(resp *shared.ConnectionIntercom) {
...
func (r *ConnectionINTERCOMResourceModel) ToSharedConnectionIntercomUpdate() *shared.ConnectionIntercomUpdate {
	active := new(bool)
	...
	typeVar := shared.ConnectionIntercomUpdateType(r.Type.ValueString())
	name := new(string)
	...
	out := shared.ConnectionIntercomUpdate{
		Active:         active,
		Type:           typeVar,
		Name:           name,
		UpdateSchedule: updateSchedule,
...
func (r *ConnectionINTERCOMResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
