...
func (r *ConnectionSAPHANAResourceModel) ToSharedConnectionSapHanaInput() *shared.ConnectionSapHanaInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionSapHanaType(r.Type.ValueString())
	...
	out := shared.ConnectionSapHanaInput{
		Name:           name,
		Type:           typeVar,
...
func (r *ConnectionSAPHANAResourceModel) RefreshFromSharedConnectionSapHana(resp *shared.ConnectionSapHana) {
...
func (r *ConnectionSAPHANAResourceModel) ToSharedConnectionSapHanaUpdate() *shared.ConnectionSapHanaUpdate {
	name := new(string)
	...
	typeVar := shared.ConnectionSapHanaUpdateType(r.Type.ValueString())
	active := new(bool)
	...
	var sshConfig *shared.ConnectionSapHanaUpdateSSHConfigurationUpdate
	if r.SSHConfig != nil {
		address1 := new(string)
	...
	out := shared.ConnectionSapHanaUpdate{
		Name:           name,
		Type:           typeVar,
		Active:         active,
		UpdateSchedule: updateSchedule,
...
func (r *ConnectionSAPHANAResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
