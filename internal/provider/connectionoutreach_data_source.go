...
var _ datasource.DataSource = &ConnectionOUTREACHDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionOUTREACHDataSource{}

func NewConnectionOUTREACHDataSource() datasource.DataSource {
	return &ConnectionOUTREACHDataSource{}
}

// ConnectionOUTREACHDataSource is the data source implementation.
type ConnectionOUTREACHDataSource struct {
	client *sdk.SDK
}

// ConnectionOUTREACHDataSourceModel describes the data model.
type ConnectionOUTREACHDataSourceModel struct {
...
func (r *ConnectionOUTREACHDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_outreach"
}

// Schema defines the schema for the data source.
func (r *ConnectionOUTREACHDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionOUTREACH DataSource",
...
func (r *ConnectionOUTREACHDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionOUTREACHDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionOUTREACHDataSourceModel
