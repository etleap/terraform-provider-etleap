...
var _ datasource.DataSource = &ConnectionOUTLOOKDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionOUTLOOKDataSource{}

func NewConnectionOUTLOOKDataSource() datasource.DataSource {
	return &ConnectionOUTLOOKDataSource{}
}

// ConnectionOUTLOOKDataSource is the data source implementation.
type ConnectionOUTLOOKDataSource struct {
	client *sdk.SDK
}

// ConnectionOUTLOOKDataSourceModel describes the data model.
type ConnectionOUTLOOKDataSourceModel struct {
...
func (r *ConnectionOUTLOOKDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_outlook"
}

// Schema defines the schema for the data source.
func (r *ConnectionOUTLOOKDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionOUTLOOK DataSource",
...
func (r *ConnectionOUTLOOKDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionOUTLOOKDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionOUTLOOKDataSourceModel
