...
func (r *ConnectionS3INPUTResourceModel) ToSharedConnectionS3InputInput() *shared.ConnectionS3InputInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionS3InputType(r.Type.ValueString())
...
func (r *ConnectionS3INPUTResourceModel) RefreshFromSharedConnectionS3Input(resp *shared.ConnectionS3Input) {
...
func (r *ConnectionS3INPUTResourceModel) ToSharedConnectionS3InputUpdate() *shared.ConnectionS3InputUpdate {
	active := new(bool)
	...
	typeVar := new(shared.ConnectionS3InputUpdateType)
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionS3InputUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	name := new(string)
...
func (r *ConnectionS3INPUTResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
