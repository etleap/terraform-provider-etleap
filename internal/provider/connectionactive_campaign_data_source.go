...
var _ datasource.DataSource = &ConnectionACTIVECAMPAIGNDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionACTIVECAMPAIGNDataSource{}

func NewConnectionACTIVECAMPAIGNDataSource() datasource.DataSource {
	return &ConnectionACTIVECAMPAIGNDataSource{}
}

// ConnectionACTIVECAMPAIGNDataSource is the data source implementation.
type ConnectionACTIVECAMPAIGNDataSource struct {
	client *sdk.SDK
}

// ConnectionACTIVECAMPAIGNDataSourceModel describes the data model.
type ConnectionACTIVECAMPAIGNDataSourceModel struct {
...
func (r *ConnectionACTIVECAMPAIGNDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_active_campaign"
}

// Schema defines the schema for the data source.
func (r *ConnectionACTIVECAMPAIGNDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionACTIVECAMPAIGN DataSource",
...
func (r *ConnectionACTIVECAMPAIGNDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionACTIVECAMPAIGNDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionACTIVECAMPAIGNDataSourceModel
