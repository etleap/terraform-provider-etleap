...
var _ resource.Resource = &ConnectionSEISMICResource{}
var _ resource.ResourceWithImportState = &ConnectionSEISMICResource{}

func NewConnectionSEISMICResource() resource.Resource {
	return &ConnectionSEISMICResource{}
}

// ConnectionSEISMICResource defines the resource implementation.
type ConnectionSEISMICResource struct {
	client *sdk.SDK
}
...
func (r *ConnectionSEISMICResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_seismic"
}

func (r *ConnectionSEISMICResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionSEISMIC Resource",
		...
		Attributes: map[string]schema.Attribute{
			...
			"client_secret": schema.StringAttribute{
				Required:    true,
				Description: `If you don't have a Client ID or Secret, see <a target="_blank" href="https://support.etleap.com/hc/en-us/articles/360045382574-Getting-Seismic-Credentials">the instructions here</a> for getting it.`,
			},
			...
			"tenant_name": schema.StringAttribute{
				Required:    true,
				Description: `The name of the tenant. This is in the URL when you use seismic: [tenant].seismic.com`,
			},
...
func (r *ConnectionSEISMICResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *ConnectionSEISMICResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *ConnectionSEISMICResourceModel
	...
	res1, err := r.client.Connection.GetSEISMICConnection(ctx, request1)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
...
func (r *ConnectionSEISMICResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *ConnectionSEISMICResourceModel
	...
	id := data.ID.ValueString()
	request := operations.GetSEISMICConnectionRequest{
		ID: id,
	}
	res, err := r.client.Connection.GetSEISMICConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionSEISMICResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *ConnectionSEISMICResourceModel
	var plan types.Object
	...
	id := data.ID.ValueString()
	connectionSeismicUpdate := data.ToSharedConnectionSeismicUpdate()
	request := operations.UpdateSEISMICConnectionRequest{
		ID:                      id,
		ConnectionSeismicUpdate: connectionSeismicUpdate,
	}
	res, err := r.client.Connection.UpdateSEISMICConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionSEISMICResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *ConnectionSEISMICResourceModel
	var item types.Object
	...
	request := operations.DeleteSEISMICConnectionRequest{
		ID:               id,
		ConnectionDelete: connectionDelete,
	}
	res, err := r.client.Connection.DeleteSEISMICConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionSEISMICResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
