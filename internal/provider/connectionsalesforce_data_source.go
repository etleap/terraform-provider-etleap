...
var _ datasource.DataSource = &ConnectionSALESFORCEDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionSALESFORCEDataSource{}

func NewConnectionSALESFORCEDataSource() datasource.DataSource {
	return &ConnectionSALESFORCEDataSource{}
}

// ConnectionSALESFORCEDataSource is the data source implementation.
type ConnectionSALESFORCEDataSource struct {
	client *sdk.SDK
}

// ConnectionSALESFORCEDataSourceModel describes the data model.
type ConnectionSALESFORCEDataSourceModel struct {
...
func (r *ConnectionSALESFORCEDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_salesforce"
}

// Schema defines the schema for the data source.
func (r *ConnectionSALESFORCEDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionSALESFORCE DataSource",
...
func (r *ConnectionSALESFORCEDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionSALESFORCEDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionSALESFORCEDataSourceModel
