...
var _ datasource.DataSource = &ConnectionSEISMICDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionSEISMICDataSource{}

func NewConnectionSEISMICDataSource() datasource.DataSource {
	return &ConnectionSEISMICDataSource{}
}

// ConnectionSEISMICDataSource is the data source implementation.
type ConnectionSEISMICDataSource struct {
	client *sdk.SDK
}
...
func (r *ConnectionSEISMICDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_seismic"
}

// Schema defines the schema for the data source.
func (r *ConnectionSEISMICDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionSEISMIC DataSource",
...
func (r *ConnectionSEISMICDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionSEISMICDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionSEISMICDataSourceModel
