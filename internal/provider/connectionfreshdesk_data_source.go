...
var _ datasource.DataSource = &ConnectionFRESHDESKDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionFRESHDESKDataSource{}

func NewConnectionFRESHDESKDataSource() datasource.DataSource {
	return &ConnectionFRESHDESKDataSource{}
}

// ConnectionFRESHDESKDataSource is the data source implementation.
type ConnectionFRESHDESKDataSource struct {
	client *sdk.SDK
}

// ConnectionFRESHDESKDataSourceModel describes the data model.
type ConnectionFRESHDESKDataSourceModel struct {
...
func (r *ConnectionFRESHDESKDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_freshdesk"
}

// Schema defines the schema for the data source.
func (r *ConnectionFRESHDESKDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionFRESHDESK DataSource",
...
func (r *ConnectionFRESHDESKDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionFRESHDESKDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionFRESHDESKDataSourceModel
