...
var _ datasource.DataSource = &ConnectionTWILIODataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionTWILIODataSource{}

func NewConnectionTWILIODataSource() datasource.DataSource {
	return &ConnectionTWILIODataSource{}
}

// ConnectionTWILIODataSource is the data source implementation.
type ConnectionTWILIODataSource struct {
	client *sdk.SDK
}
...
func (r *ConnectionTWILIODataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_twilio"
}

// Schema defines the schema for the data source.
func (r *ConnectionTWILIODataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionTWILIO DataSource",
...
func (r *ConnectionTWILIODataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionTWILIODataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionTWILIODataSourceModel
