...
var _ datasource.DataSource = &ConnectionSNAPCHATADSDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionSNAPCHATADSDataSource{}

func NewConnectionSNAPCHATADSDataSource() datasource.DataSource {
	return &ConnectionSNAPCHATADSDataSource{}
}

// ConnectionSNAPCHATADSDataSource is the data source implementation.
type ConnectionSNAPCHATADSDataSource struct {
	client *sdk.SDK
}

// ConnectionSNAPCHATADSDataSourceModel describes the data model.
type ConnectionSNAPCHATADSDataSourceModel struct {
...
func (r *ConnectionSNAPCHATADSDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_snapchat_ads"
}

// Schema defines the schema for the data source.
func (r *ConnectionSNAPCHATADSDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionSNAPCHATADS DataSource",
...
func (r *ConnectionSNAPCHATADSDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionSNAPCHATADSDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionSNAPCHATADSDataSourceModel
