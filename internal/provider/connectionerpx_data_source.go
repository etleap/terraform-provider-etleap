...
var _ datasource.DataSource = &ConnectionERPXDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionERPXDataSource{}

func NewConnectionERPXDataSource() datasource.DataSource {
	return &ConnectionERPXDataSource{}
}

// ConnectionERPXDataSource is the data source implementation.
type ConnectionERPXDataSource struct {
	client *sdk.SDK
}
...
func (r *ConnectionERPXDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_erpx"
}

// Schema defines the schema for the data source.
func (r *ConnectionERPXDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionERPX DataSource",
		...
		Attributes: map[string]schema.Attribute{
			...
			"api_url": schema.StringAttribute{
				Computed:    true,
				Description: `Your ERPx tenant API URL.`,
			},
...
func (r *ConnectionERPXDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionERPXDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionERPXDataSourceModel
