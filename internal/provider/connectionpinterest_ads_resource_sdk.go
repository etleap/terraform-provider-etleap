...
func (r *ConnectionPINTERESTADSResourceModel) ToSharedConnectionPinterestAdsInput() *shared.ConnectionPinterestAdsInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionPinterestAdsType(r.Type.ValueString())
	...
	out := shared.ConnectionPinterestAdsInput{
		Name:           name,
		Type:           typeVar,
...
func (r *ConnectionPINTERESTADSResourceModel) RefreshFromSharedConnectionPinterestAds(resp *shared.ConnectionPinterestAds) {
...
func (r *ConnectionPINTERESTADSResourceModel) ToSharedConnectionPinterestAdsUpdate() *shared.ConnectionPinterestAdsUpdate {
	name := new(string)
	...
	typeVar := shared.ConnectionPinterestAdsUpdateType(r.Type.ValueString())
	active := new(bool)
	...
	out := shared.ConnectionPinterestAdsUpdate{
		Name:           name,
		Type:           typeVar,
		Active:         active,
		UpdateSchedule: updateSchedule,
...
func (r *ConnectionPINTERESTADSResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
