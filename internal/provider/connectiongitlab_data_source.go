...
var _ datasource.DataSource = &ConnectionGITLABDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionGITLABDataSource{}

func NewConnectionGITLABDataSource() datasource.DataSource {
	return &ConnectionGITLABDataSource{}
}

// ConnectionGITLABDataSource is the data source implementation.
type ConnectionGITLABDataSource struct {
	client *sdk.SDK
}

// ConnectionGITLABDataSourceModel describes the data model.
type ConnectionGITLABDataSourceModel struct {
...
func (r *ConnectionGITLABDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_gitlab"
}

// Schema defines the schema for the data source.
func (r *ConnectionGITLABDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionGITLAB DataSource",
		...
		Attributes: map[string]schema.Attribute{
			...
			"api_url": schema.StringAttribute{
				Computed:    true,
				Description: `Your Gitlab instance URL if you're on a self hosted setup. Leave empty for gitlab.com. Example: https://gitlab.example.com`,
			},
...
func (r *ConnectionGITLABDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionGITLABDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionGITLABDataSourceModel
