...
var _ datasource.DataSource = &ConnectionJIRACLOUDDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionJIRACLOUDDataSource{}

func NewConnectionJIRACLOUDDataSource() datasource.DataSource {
	return &ConnectionJIRACLOUDDataSource{}
}

// ConnectionJIRACLOUDDataSource is the data source implementation.
type ConnectionJIRACLOUDDataSource struct {
	client *sdk.SDK
}

// ConnectionJIRACLOUDDataSourceModel describes the data model.
type ConnectionJIRACLOUDDataSourceModel struct {
...
func (r *ConnectionJIRACLOUDDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_jira_cloud"
}

// Schema defines the schema for the data source.
func (r *ConnectionJIRACLOUDDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionJIRACLOUD DataSource",
...
func (r *ConnectionJIRACLOUDDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionJIRACLOUDDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionJIRACLOUDDataSourceModel
