...
var _ datasource.DataSource = &ConnectionMYSQLSHARDEDDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionMYSQLSHARDEDDataSource{}

func NewConnectionMYSQLSHARDEDDataSource() datasource.DataSource {
	return &ConnectionMYSQLSHARDEDDataSource{}
}

// ConnectionMYSQLSHARDEDDataSource is the data source implementation.
type ConnectionMYSQLSHARDEDDataSource struct {
	client *sdk.SDK
}
...
func (r *ConnectionMYSQLSHARDEDDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_mysql_sharded"
}

// Schema defines the schema for the data source.
func (r *ConnectionMYSQLSHARDEDDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionMYSQLSHARDED DataSource",
...
func (r *ConnectionMYSQLSHARDEDDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionMYSQLSHARDEDDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionMYSQLSHARDEDDataSourceModel
