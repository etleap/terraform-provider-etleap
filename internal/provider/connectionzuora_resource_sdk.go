...
func (r *ConnectionZUORAResourceModel) RefreshFromSharedConnectionZuora(resp *shared.ConnectionZuora) {
	...
	r.Endpoint = types.StringValue(resp.Endpoint)
	r.EndpointHostname = types.StringPointerValue(resp.EndpointHostname)
...
func (r *ConnectionZUORAResourceModel) ToSharedConnectionZuoraUpdate() *shared.ConnectionZuoraUpdate {
	...
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionZuoraUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	active := new(bool)
...
func (r *ConnectionZUORAResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
