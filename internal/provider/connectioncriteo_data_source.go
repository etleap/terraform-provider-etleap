...
var _ datasource.DataSource = &ConnectionCRITEODataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionCRITEODataSource{}

func NewConnectionCRITEODataSource() datasource.DataSource {
	return &ConnectionCRITEODataSource{}
}

// ConnectionCRITEODataSource is the data source implementation.
type ConnectionCRITEODataSource struct {
	client *sdk.SDK
}
...
func (r *ConnectionCRITEODataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_criteo"
}

// Schema defines the schema for the data source.
func (r *ConnectionCRITEODataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionCRITEO DataSource",
...
func (r *ConnectionCRITEODataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionCRITEODataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionCRITEODataSourceModel
