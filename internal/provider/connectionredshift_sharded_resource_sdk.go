...
func (r *ConnectionREDSHIFTSHARDEDResourceModel) ToSharedConnectionRedshiftShardedInput() *shared.ConnectionRedshiftShardedInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionRedshiftShardedType(r.Type.ValueString())
...
func (r *ConnectionREDSHIFTSHARDEDResourceModel) RefreshFromSharedConnectionRedshiftSharded(resp *shared.ConnectionRedshiftSharded) {
...
func (r *ConnectionREDSHIFTSHARDEDResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
