...
func (r *ConnectionFRESHDESKResourceModel) ToSharedConnectionFreshdeskInput() *shared.ConnectionFreshdeskInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionFreshdeskType(r.Type.ValueString())
	...
	out := shared.ConnectionFreshdeskInput{
		Name:           name,
		Type:           typeVar,
...
func (r *ConnectionFRESHDESKResourceModel) RefreshFromSharedConnectionFreshdesk(resp *shared.ConnectionFreshdesk) {
...
func (r *ConnectionFRESHDESKResourceModel) ToSharedConnectionFreshdeskUpdate() *shared.ConnectionFreshdeskUpdate {
	name := new(string)
	...
	typeVar := new(shared.ConnectionFreshdeskUpdateType)
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionFreshdeskUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	active := new(bool)
	...
	out := shared.ConnectionFreshdeskUpdate{
		Name:           name,
		Type:           typeVar,
		Active:         active,
		UpdateSchedule: updateSchedule,
...
func (r *ConnectionFRESHDESKResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
