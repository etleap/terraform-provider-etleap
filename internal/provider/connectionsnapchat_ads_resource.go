...
var _ resource.Resource = &ConnectionSNAPCHATADSResource{}
var _ resource.ResourceWithImportState = &ConnectionSNAPCHATADSResource{}

func NewConnectionSNAPCHATADSResource() resource.Resource {
	return &ConnectionSNAPCHATADSResource{}
}

// ConnectionSNAPCHATADSResource defines the resource implementation.
type ConnectionSNAPCHATADSResource struct {
	client *sdk.SDK
}

// ConnectionSNAPCHATADSResourceModel describes the resource data model.
type ConnectionSNAPCHATADSResourceModel struct {
...
func (r *ConnectionSNAPCHATADSResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_snapchat_ads"
}

func (r *ConnectionSNAPCHATADSResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionSNAPCHATADS Resource",
...
func (r *ConnectionSNAPCHATADSResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *ConnectionSNAPCHATADSResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *ConnectionSNAPCHATADSResourceModel
	...
	request := *data.ToSharedConnectionSnapchatAdsInput()
	res, err := r.client.Connection.CreateSNAPCHATADSConnection(ctx, request)
	if err != nil {
	...
	if res.ConnectionSnapchatAds == nil {
		resp.Diagnostics.AddError("unexpected response from API. No response body", debugResponse(res.RawResponse))
		return
	}
	data.RefreshFromSharedConnectionSnapchatAds(res.ConnectionSnapchatAds)
	refreshPlan(ctx, plan, &data, resp.Diagnostics)
	id := data.ID.ValueString()
	request1 := operations.GetSNAPCHATADSConnectionRequest{
		ID: id,
	}
	res1, err := r.client.Connection.GetSNAPCHATADSConnection(ctx, request1)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
	...
	if res1.ConnectionSnapchatAds == nil {
		resp.Diagnostics.AddError("unexpected response from API. No response body", debugResponse(res1.RawResponse))
		return
	}
	data.RefreshFromSharedConnectionSnapchatAds(res1.ConnectionSnapchatAds)
	refreshPlan(ctx, plan, &data, resp.Diagnostics)
...
func (r *ConnectionSNAPCHATADSResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *ConnectionSNAPCHATADSResourceModel
	...
	id := data.ID.ValueString()
	request := operations.GetSNAPCHATADSConnectionRequest{
		ID: id,
	}
	res, err := r.client.Connection.GetSNAPCHATADSConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionSNAPCHATADSResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *ConnectionSNAPCHATADSResourceModel
	var plan types.Object
	...
	id := data.ID.ValueString()
	connectionSnapchatAdsUpdate := data.ToSharedConnectionSnapchatAdsUpdate()
	request := operations.UpdateSNAPCHATADSConnectionRequest{
		ID:                          id,
		ConnectionSnapchatAdsUpdate: connectionSnapchatAdsUpdate,
	}
	res, err := r.client.Connection.UpdateSNAPCHATADSConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionSNAPCHATADSResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *ConnectionSNAPCHATADSResourceModel
	var item types.Object
	...
	request := operations.DeleteSNAPCHATADSConnectionRequest{
		ID:               id,
		ConnectionDelete: connectionDelete,
	}
	res, err := r.client.Connection.DeleteSNAPCHATADSConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionSNAPCHATADSResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
