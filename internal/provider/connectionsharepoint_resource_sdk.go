...
func (r *ConnectionSHAREPOINTResourceModel) ToSharedConnectionSharepointInput() *shared.ConnectionSharepointInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionSharepointType(r.Type.ValueString())
	...
	out := shared.ConnectionSharepointInput{
		Name:           name,
		Type:           typeVar,
...
func (r *ConnectionSHAREPOINTResourceModel) RefreshFromSharedConnectionSharepoint(resp *shared.ConnectionSharepoint) {
...
func (r *ConnectionSHAREPOINTResourceModel) ToSharedConnectionSharepointUpdate() *shared.ConnectionSharepointUpdate {
	name := new(string)
	...
	typeVar := new(shared.ConnectionSharepointUpdateType)
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionSharepointUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	active := new(bool)
	...
	out := shared.ConnectionSharepointUpdate{
		Name:           name,
		Type:           typeVar,
		Active:         active,
		UpdateSchedule: updateSchedule,
...
func (r *ConnectionSHAREPOINTResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
