...
var _ datasource.DataSource = &ConnectionHUBSPOTDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionHUBSPOTDataSource{}

func NewConnectionHUBSPOTDataSource() datasource.DataSource {
	return &ConnectionHUBSPOTDataSource{}
}

// ConnectionHUBSPOTDataSource is the data source implementation.
type ConnectionHUBSPOTDataSource struct {
	client *sdk.SDK
}
...
func (r *ConnectionHUBSPOTDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_hubspot"
}

// Schema defines the schema for the data source.
func (r *ConnectionHUBSPOTDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionHUBSPOT DataSource",
...
func (r *ConnectionHUBSPOTDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionHUBSPOTDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionHUBSPOTDataSourceModel
