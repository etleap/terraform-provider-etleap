				...
				Attributes: map[string]schema.Attribute{
					...
					"dayforce": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"entity": schema.StringAttribute{
								Computed:    true,
								Description: `The Dayforce resource. Example: Departments`,
							},
							"latency_threshold": schema.Int64Attribute{
								Computed:    true,
								Description: `Notify if we can't extract for ` + "`" + `x` + "`" + ` hours. Setting it to ` + "`" + `null` + "`" + ` disables the notification. Defaults to ` + "`" + `null` + "`" + `.`,
					...
					"increase": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"entity": schema.StringAttribute{
								Computed:    true,
								Description: `The Increase resource. Example: Transactions`,
							},
							"latency_threshold": schema.Int64Attribute{
								Computed:    true,
								Description: `Notify if we can't extract for ` + "`" + `x` + "`" + ` hours. Setting it to ` + "`" + `null` + "`" + ` disables the notification. Defaults to ` + "`" + `null` + "`" + `.`,
					...
					"reddit_ads": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"entity": schema.StringAttribute{
								Computed:    true,
								Description: `The Reddit Ads resource. Example: campaigns`,
							},
							"latency_threshold": schema.Int64Attribute{
								Computed:    true,
								Description: `Notify if we can't extract for ` + "`" + `x` + "`" + ` hours. Setting it to ` + "`" + `null` + "`" + ` disables the notification. Defaults to ` + "`" + `null` + "`" + `.`,
					...
					"salesloft": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"entity": schema.StringAttribute{
								Computed:    true,
								Description: `The Salesloft resource. Example: people`,
							},
							"latency_threshold": schema.Int64Attribute{
								Computed:    true,
								Description: `Notify if we can't extract for ` + "`" + `x` + "`" + ` hours. Setting it to ` + "`" + `null` + "`" + ` disables the notification. Defaults to ` + "`" + `null` + "`" + `.`,
					...
					"sqs": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"entity": schema.StringAttribute{
								Computed:    true,
								Description: `The SQS queue URL. Example value: https://sqs.us-east-1.amazonaws.com/1234567890/my-sqs-queue.fifo`,
							},
							"latency_threshold": schema.Int64Attribute{
								Computed:    true,
								Description: `Notify if we can't extract for ` + "`" + `x` + "`" + ` hours. Setting it to ` + "`" + `null` + "`" + ` disables the notification. Defaults to ` + "`" + `null` + "`" + `.`,
