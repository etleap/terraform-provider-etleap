...
func (r *ConnectionMIXPANELResourceModel) ToSharedConnectionMixpanelInput() *shared.ConnectionMixpanelInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionMixpanelType(r.Type.ValueString())
	...
	out := shared.ConnectionMixpanelInput{
		Name:           name,
		Type:           typeVar,
...
func (r *ConnectionMIXPANELResourceModel) RefreshFromSharedConnectionMixpanel(resp *shared.ConnectionMixpanel) {
...
func (r *ConnectionMIXPANELResourceModel) ToSharedConnectionMixpanelUpdate() *shared.ConnectionMixpanelUpdate {
	active := new(bool)
	...
	typeVar := new(shared.ConnectionMixpanelUpdateType)
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionMixpanelUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	name := new(string)
	...
	out := shared.ConnectionMixpanelUpdate{
		Active:         active,
		Type:           typeVar,
		Name:           name,
		UpdateSchedule: updateSchedule,
...
func (r *ConnectionMIXPANELResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
