...
var _ resource.Resource = &ConnectionPINTERESTADSResource{}
var _ resource.ResourceWithImportState = &ConnectionPINTERESTADSResource{}

func NewConnectionPINTERESTADSResource() resource.Resource {
	return &ConnectionPINTERESTADSResource{}
}

// ConnectionPINTERESTADSResource defines the resource implementation.
type ConnectionPINTERESTADSResource struct {
	client *sdk.SDK
}

// ConnectionPINTERESTADSResourceModel describes the resource data model.
type ConnectionPINTERESTADSResourceModel struct {
...
func (r *ConnectionPINTERESTADSResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_pinterest_ads"
}

func (r *ConnectionPINTERESTADSResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionPINTERESTADS Resource",
...
func (r *ConnectionPINTERESTADSResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *ConnectionPINTERESTADSResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *ConnectionPINTERESTADSResourceModel
	...
	request := *data.ToSharedConnectionPinterestAdsInput()
	res, err := r.client.Connection.CreatePINTERESTADSConnection(ctx, request)
	if err != nil {
	...
	if res.ConnectionPinterestAds == nil {
		resp.Diagnostics.AddError("unexpected response from API. No response body", debugResponse(res.RawResponse))
		return
	}
	data.RefreshFromSharedConnectionPinterestAds(res.ConnectionPinterestAds)
	refreshPlan(ctx, plan, &data, resp.Diagnostics)
	id := data.ID.ValueString()
	request1 := operations.GetPINTERESTADSConnectionRequest{
		ID: id,
	}
	res1, err := r.client.Connection.GetPINTERESTADSConnection(ctx, request1)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
	...
	if res1.ConnectionPinterestAds == nil {
		resp.Diagnostics.AddError("unexpected response from API. No response body", debugResponse(res1.RawResponse))
		return
	}
	data.RefreshFromSharedConnectionPinterestAds(res1.ConnectionPinterestAds)
	refreshPlan(ctx, plan, &data, resp.Diagnostics)
...
func (r *ConnectionPINTERESTADSResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *ConnectionPINTERESTADSResourceModel
	...
	id := data.ID.ValueString()
	request := operations.GetPINTERESTADSConnectionRequest{
		ID: id,
	}
	res, err := r.client.Connection.GetPINTERESTADSConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionPINTERESTADSResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *ConnectionPINTERESTADSResourceModel
	var plan types.Object
	...
	id := data.ID.ValueString()
	connectionPinterestAdsUpdate := data.ToSharedConnectionPinterestAdsUpdate()
	request := operations.UpdatePINTERESTADSConnectionRequest{
		ID:                           id,
		ConnectionPinterestAdsUpdate: connectionPinterestAdsUpdate,
	}
	res, err := r.client.Connection.UpdatePINTERESTADSConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionPINTERESTADSResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *ConnectionPINTERESTADSResourceModel
	var item types.Object
	...
	request := operations.DeletePINTERESTADSConnectionRequest{
		ID:               id,
		ConnectionDelete: connectionDelete,
	}
	res, err := r.client.Connection.DeletePINTERESTADSConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionPINTERESTADSResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
