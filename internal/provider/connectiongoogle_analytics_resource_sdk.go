...
func (r *ConnectionGOOGLEANALYTICSResourceModel) ToSharedConnectionGaInput() *shared.ConnectionGaInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionGaType(r.Type.ValueString())
...
func (r *ConnectionGOOGLEANALYTICSResourceModel) RefreshFromSharedConnectionGa(resp *shared.ConnectionGa) {
	...
	r.GoogleID = types.StringValue(resp.GoogleID)
...
func (r *ConnectionGOOGLEANALYTICSResourceModel) ToSharedConnectionGaUpdate() *shared.ConnectionGaUpdate {
	name := new(string)
	...
	typeVar := shared.ConnectionGaUpdateType(r.Type.ValueString())
	active := new(bool)
...
func (r *ConnectionGOOGLEANALYTICSResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
