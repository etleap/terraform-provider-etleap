...
var _ datasource.DataSource = &ConnectionMARKETODataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionMARKETODataSource{}

func NewConnectionMARKETODataSource() datasource.DataSource {
	return &ConnectionMARKETODataSource{}
}

// ConnectionMARKETODataSource is the data source implementation.
type ConnectionMARKETODataSource struct {
	client *sdk.SDK
}
...
func (r *ConnectionMARKETODataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_marketo"
}

// Schema defines the schema for the data source.
func (r *ConnectionMARKETODataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionMARKETO DataSource",
...
func (r *ConnectionMARKETODataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionMARKETODataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionMARKETODataSourceModel
