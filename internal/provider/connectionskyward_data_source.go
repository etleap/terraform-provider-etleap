...
var _ datasource.DataSource = &ConnectionSKYWARDDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionSKYWARDDataSource{}

func NewConnectionSKYWARDDataSource() datasource.DataSource {
	return &ConnectionSKYWARDDataSource{}
}

// ConnectionSKYWARDDataSource is the data source implementation.
type ConnectionSKYWARDDataSource struct {
	client *sdk.SDK
}

// ConnectionSKYWARDDataSourceModel describes the data model.
type ConnectionSKYWARDDataSourceModel struct {
...
func (r *ConnectionSKYWARDDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_skyward"
}

// Schema defines the schema for the data source.
func (r *ConnectionSKYWARDDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionSKYWARD DataSource",
...
func (r *ConnectionSKYWARDDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionSKYWARDDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionSKYWARDDataSourceModel
