...
var _ resource.Resource = &ConnectionTWITTERADSResource{}
var _ resource.ResourceWithImportState = &ConnectionTWITTERADSResource{}

func NewConnectionTWITTERADSResource() resource.Resource {
	return &ConnectionTWITTERADSResource{}
}

// ConnectionTWITTERADSResource defines the resource implementation.
type ConnectionTWITTERADSResource struct {
	client *sdk.SDK
}
...
func (r *ConnectionTWITTERADSResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_twitter_ads"
}

func (r *ConnectionTWITTERADSResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionTWITTERADS Resource",
...
func (r *ConnectionTWITTERADSResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *ConnectionTWITTERADSResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *ConnectionTWITTERADSResourceModel
	...
	res1, err := r.client.Connection.GetTWITTERADSConnection(ctx, request1)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
...
func (r *ConnectionTWITTERADSResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *ConnectionTWITTERADSResourceModel
	...
	id := data.ID.ValueString()
	request := operations.GetTWITTERADSConnectionRequest{
		ID: id,
	}
	res, err := r.client.Connection.GetTWITTERADSConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionTWITTERADSResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *ConnectionTWITTERADSResourceModel
	var plan types.Object
...
func (r *ConnectionTWITTERADSResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *ConnectionTWITTERADSResourceModel
	var item types.Object
	...
	request := operations.DeleteTWITTERADSConnectionRequest{
		ID:               id,
		ConnectionDelete: connectionDelete,
	}
	res, err := r.client.Connection.DeleteTWITTERADSConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionTWITTERADSResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
