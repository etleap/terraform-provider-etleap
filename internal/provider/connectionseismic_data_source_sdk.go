...
func (r *ConnectionSEISMICDataSourceModel) RefreshFromSharedConnectionSeismicOutput(resp *shared.ConnectionSeismicOutput) {
	...
	r.TenantName = types.StringValue(resp.TenantName)
