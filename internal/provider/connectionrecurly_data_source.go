...
var _ datasource.DataSource = &ConnectionRECURLYDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionRECURLYDataSource{}

func NewConnectionRECURLYDataSource() datasource.DataSource {
	return &ConnectionRECURLYDataSource{}
}

// ConnectionRECURLYDataSource is the data source implementation.
type ConnectionRECURLYDataSource struct {
	client *sdk.SDK
}

// ConnectionRECURLYDataSourceModel describes the data model.
type ConnectionRECURLYDataSourceModel struct {
...
func (r *ConnectionRECURLYDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_recurly"
}

// Schema defines the schema for the data source.
func (r *ConnectionRECURLYDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionRECURLY DataSource",
...
func (r *ConnectionRECURLYDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionRECURLYDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionRECURLYDataSourceModel
