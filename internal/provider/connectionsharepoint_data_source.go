...
var _ datasource.DataSource = &ConnectionSHAREPOINTDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionSHAREPOINTDataSource{}

func NewConnectionSHAREPOINTDataSource() datasource.DataSource {
	return &ConnectionSHAREPOINTDataSource{}
}

// ConnectionSHAREPOINTDataSource is the data source implementation.
type ConnectionSHAREPOINTDataSource struct {
	client *sdk.SDK
}

// ConnectionSHAREPOINTDataSourceModel describes the data model.
type ConnectionSHAREPOINTDataSourceModel struct {
...
func (r *ConnectionSHAREPOINTDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_sharepoint"
}

// Schema defines the schema for the data source.
func (r *ConnectionSHAREPOINTDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionSHAREPOINT DataSource",
...
func (r *ConnectionSHAREPOINTDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionSHAREPOINTDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionSHAREPOINTDataSourceModel
