...
var _ datasource.DataSource = &ConnectionLDAPVIRTUALLISTVIEWDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionLDAPVIRTUALLISTVIEWDataSource{}

func NewConnectionLDAPVIRTUALLISTVIEWDataSource() datasource.DataSource {
	return &ConnectionLDAPVIRTUALLISTVIEWDataSource{}
}

// ConnectionLDAPVIRTUALLISTVIEWDataSource is the data source implementation.
type ConnectionLDAPVIRTUALLISTVIEWDataSource struct {
	client *sdk.SDK
}
...
func (r *ConnectionLDAPVIRTUALLISTVIEWDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_ldap_virtual_list_view"
}

// Schema defines the schema for the data source.
func (r *ConnectionLDAPVIRTUALLISTVIEWDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionLDAPVIRTUALLISTVIEW DataSource",
...
func (r *ConnectionLDAPVIRTUALLISTVIEWDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionLDAPVIRTUALLISTVIEWDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionLDAPVIRTUALLISTVIEWDataSourceModel
