...
var _ datasource.DataSource = &ConnectionFRESHSALESDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionFRESHSALESDataSource{}

func NewConnectionFRESHSALESDataSource() datasource.DataSource {
	return &ConnectionFRESHSALESDataSource{}
}

// ConnectionFRESHSALESDataSource is the data source implementation.
type ConnectionFRESHSALESDataSource struct {
	client *sdk.SDK
}
...
func (r *ConnectionFRESHSALESDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_freshsales"
}

// Schema defines the schema for the data source.
func (r *ConnectionFRESHSALESDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionFRESHSALES DataSource",
...
func (r *ConnectionFRESHSALESDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionFRESHSALESDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionFRESHSALESDataSourceModel
