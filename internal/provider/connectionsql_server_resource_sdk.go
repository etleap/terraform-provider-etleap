...
func (r *ConnectionSQLSERVERResourceModel) ToSharedConnectionSQLServerInput() *shared.ConnectionSQLServerInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionSQLServerType(r.Type.ValueString())
	...
	out := shared.ConnectionSQLServerInput{
		Name:           name,
		Type:           typeVar,
...
func (r *ConnectionSQLSERVERResourceModel) ToSharedConnectionSQLServerUpdate() *shared.ConnectionSQLServerUpdate {
	name := new(string)
	...
	typeVar := shared.ConnectionSQLServerUpdateType(r.Type.ValueString())
	active := new(bool)
	...
	var sshConfig *shared.ConnectionSQLServerUpdateSSHConfigurationUpdate
	if r.SSHConfig != nil {
		address1 := new(string)
		...
		sshConfig = &shared.ConnectionSQLServerUpdateSSHConfigurationUpdate{
			Address:  address1,
			Username: username1,
		}
	}
	out := shared.ConnectionSQLServerUpdate{
		Name:           name,
		Type:           typeVar,
		Active:         active,
		UpdateSchedule: updateSchedule,
...
func (r *ConnectionSQLSERVERResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
