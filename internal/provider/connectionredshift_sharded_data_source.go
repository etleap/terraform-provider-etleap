...
var _ datasource.DataSource = &ConnectionREDSHIFTSHARDEDDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionREDSHIFTSHARDEDDataSource{}

func NewConnectionREDSHIFTSHARDEDDataSource() datasource.DataSource {
	return &ConnectionREDSHIFTSHARDEDDataSource{}
}

// ConnectionREDSHIFTSHARDEDDataSource is the data source implementation.
type ConnectionREDSHIFTSHARDEDDataSource struct {
	client *sdk.SDK
}
...
func (r *ConnectionREDSHIFTSHARDEDDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_redshift_sharded"
}

// Schema defines the schema for the data source.
func (r *ConnectionREDSHIFTSHARDEDDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionREDSHIFTSHARDED DataSource",
...
func (r *ConnectionREDSHIFTSHARDEDDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionREDSHIFTSHARDEDDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionREDSHIFTSHARDEDDataSourceModel
