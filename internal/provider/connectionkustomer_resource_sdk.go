...
func (r *ConnectionKUSTOMERResourceModel) ToSharedConnectionKustomerInput() *shared.ConnectionKustomerInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionKustomerType(r.Type.ValueString())
	...
	out := shared.ConnectionKustomerInput{
		Name:           name,
		Type:           typeVar,
...
func (r *ConnectionKUSTOMERResourceModel) RefreshFromSharedConnectionKustomer(resp *shared.ConnectionKustomer) {
...
func (r *ConnectionKUSTOMERResourceModel) ToSharedConnectionKustomerUpdate() *shared.ConnectionKustomerUpdate {
	...
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionKustomerUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	name := new(string)
...
func (r *ConnectionKUSTOMERResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
