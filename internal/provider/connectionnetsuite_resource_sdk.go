...
func (r *ConnectionNETSUITEResourceModel) ToSharedConnectionNetsuiteInput() *shared.ConnectionNetsuiteInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionNetsuiteType(r.Type.ValueString())
...
func (r *ConnectionNETSUITEResourceModel) RefreshFromSharedConnectionNetsuite(resp *shared.ConnectionNetsuite) {
...
func (r *ConnectionNETSUITEResourceModel) ToSharedConnectionNetsuiteUpdate() *shared.ConnectionNetsuiteUpdate {
	...
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionNetsuiteUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	active := new(bool)
...
func (r *ConnectionNETSUITEResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
