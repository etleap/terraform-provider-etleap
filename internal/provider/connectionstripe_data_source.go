...
var _ datasource.DataSource = &ConnectionSTRIPEDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionSTRIPEDataSource{}

func NewConnectionSTRIPEDataSource() datasource.DataSource {
	return &ConnectionSTRIPEDataSource{}
}

// ConnectionSTRIPEDataSource is the data source implementation.
type ConnectionSTRIPEDataSource struct {
	client *sdk.SDK
}

// ConnectionSTRIPEDataSourceModel describes the data model.
type ConnectionSTRIPEDataSourceModel struct {
...
func (r *ConnectionSTRIPEDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_stripe"
}

// Schema defines the schema for the data source.
func (r *ConnectionSTRIPEDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionSTRIPE DataSource",
...
func (r *ConnectionSTRIPEDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionSTRIPEDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionSTRIPEDataSourceModel
