...
func (r *ConnectionVEEVAResourceModel) ToSharedConnectionVeevaInput() *shared.ConnectionVeevaInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionVeevaType(r.Type.ValueString())
...
func (r *ConnectionVEEVAResourceModel) RefreshFromSharedConnectionVeeva(resp *shared.ConnectionVeeva) {
...
func (r *ConnectionVEEVAResourceModel) ToSharedConnectionVeevaUpdate() *shared.ConnectionVeevaUpdate {
	...
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionVeevaUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	active := new(bool)
...
func (r *ConnectionVEEVAResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
