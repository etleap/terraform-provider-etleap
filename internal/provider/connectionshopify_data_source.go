...
var _ datasource.DataSource = &ConnectionSHOPIFYDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionSHOPIFYDataSource{}

func NewConnectionSHOPIFYDataSource() datasource.DataSource {
	return &ConnectionSHOPIFYDataSource{}
}

// ConnectionSHOPIFYDataSource is the data source implementation.
type ConnectionSHOPIFYDataSource struct {
	client *sdk.SDK
}

// ConnectionSHOPIFYDataSourceModel describes the data model.
type ConnectionSHOPIFYDataSourceModel struct {
...
func (r *ConnectionSHOPIFYDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_shopify"
}

// Schema defines the schema for the data source.
func (r *ConnectionSHOPIFYDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionSHOPIFY DataSource",
...
func (r *ConnectionSHOPIFYDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionSHOPIFYDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionSHOPIFYDataSourceModel
