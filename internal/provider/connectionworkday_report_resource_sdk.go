...
func (r *ConnectionWORKDAYREPORTResourceModel) ToSharedConnectionWorkdayReportInput() *shared.ConnectionWorkdayReportInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionWorkdayReportType(r.Type.ValueString())
	...
	reportURL := r.ReportURL.ValueString()
	username := r.Username.ValueString()
	password := r.Password.ValueString()
	out := shared.ConnectionWorkdayReportInput{
		Name:           name,
		Type:           typeVar,
...
func (r *ConnectionWORKDAYREPORTResourceModel) RefreshFromSharedConnectionWorkdayReport(resp *shared.ConnectionWorkdayReport) {
	...
	r.ReportURL = types.StringValue(resp.ReportURL)
...
func (r *ConnectionWORKDAYREPORTResourceModel) ToSharedConnectionWorkdayReportUpdate() *shared.ConnectionWorkdayReportUpdate {
	name := new(string)
	...
	typeVar := new(shared.ConnectionWorkdayReportUpdateType)
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionWorkdayReportUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	active := new(bool)
	...
	reportURL := new(string)
	if !r.ReportURL.IsUnknown() && !r.ReportURL.IsNull() {
		*reportURL = r.ReportURL.ValueString()
	} else {
		reportURL = nil
	}
	...
	out := shared.ConnectionWorkdayReportUpdate{
		Name:           name,
		Type:           typeVar,
		Active:         active,
		UpdateSchedule: updateSchedule,
...
func (r *ConnectionWORKDAYREPORTResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
