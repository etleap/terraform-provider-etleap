...
func (r *ConnectionEGNYTEResourceModel) ToSharedConnectionEgnyteInput() *shared.ConnectionEgnyteInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionEgnyteType(r.Type.ValueString())
...
func (r *ConnectionEGNYTEResourceModel) RefreshFromSharedConnectionEgnyte(resp *shared.ConnectionEgnyte) {
...
func (r *ConnectionEGNYTEResourceModel) ToSharedConnectionEgnyteUpdate() *shared.ConnectionEgnyteUpdate {
	...
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionEgnyteUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	name := new(string)
...
func (r *ConnectionEGNYTEResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
