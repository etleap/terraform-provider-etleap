...
func (r *ConnectionOUTREACHResourceModel) ToSharedConnectionOutreachInput() *shared.ConnectionOutreachInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionOutreachType(r.Type.ValueString())
	...
	out := shared.ConnectionOutreachInput{
		Name:           name,
		Type:           typeVar,
...
func (r *ConnectionOUTREACHResourceModel) RefreshFromSharedConnectionOutreach(resp *shared.ConnectionOutreach) {
...
func (r *ConnectionOUTREACHResourceModel) ToSharedConnectionOutreachUpdate() *shared.ConnectionOutreachUpdate {
	name := new(string)
	...
	typeVar := shared.ConnectionOutreachUpdateType(r.Type.ValueString())
	active := new(bool)
	...
	out := shared.ConnectionOutreachUpdate{
		Name:           name,
		Type:           typeVar,
		Active:         active,
		UpdateSchedule: updateSchedule,
...
func (r *ConnectionOUTREACHResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
