...
func (r *ConnectionFRESHSALESResourceModel) ToSharedConnectionFreshsalesUpdate() *shared.ConnectionFreshsalesUpdate {
	...
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionFreshsalesUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	active := new(bool)
...
func (r *ConnectionFRESHSALESResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
