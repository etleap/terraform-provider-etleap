...
var _ datasource.DataSource = &ConnectionCOUPADataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionCOUPADataSource{}

func NewConnectionCOUPADataSource() datasource.DataSource {
	return &ConnectionCOUPADataSource{}
}

// ConnectionCOUPADataSource is the data source implementation.
type ConnectionCOUPADataSource struct {
	client *sdk.SDK
}

// ConnectionCOUPADataSourceModel describes the data model.
type ConnectionCOUPADataSourceModel struct {
...
func (r *ConnectionCOUPADataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_coupa"
}

// Schema defines the schema for the data source.
func (r *ConnectionCOUPADataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionCOUPA DataSource",
...
func (r *ConnectionCOUPADataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionCOUPADataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionCOUPADataSourceModel
