...
var _ datasource.DataSource = &ConnectionZOOMPHONEDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionZOOMPHONEDataSource{}

func NewConnectionZOOMPHONEDataSource() datasource.DataSource {
	return &ConnectionZOOMPHONEDataSource{}
}

// ConnectionZOOMPHONEDataSource is the data source implementation.
type ConnectionZOOMPHONEDataSource struct {
	client *sdk.SDK
}

// ConnectionZOOMPHONEDataSourceModel describes the data model.
type ConnectionZOOMPHONEDataSourceModel struct {
...
func (r *ConnectionZOOMPHONEDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_zoom_phone"
}

// Schema defines the schema for the data source.
func (r *ConnectionZOOMPHONEDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionZOOMPHONE DataSource",
...
func (r *ConnectionZOOMPHONEDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionZOOMPHONEDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionZOOMPHONEDataSourceModel
