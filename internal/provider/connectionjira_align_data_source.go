...
var _ datasource.DataSource = &ConnectionJIRAALIGNDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionJIRAALIGNDataSource{}

func NewConnectionJIRAALIGNDataSource() datasource.DataSource {
	return &ConnectionJIRAALIGNDataSource{}
}

// ConnectionJIRAALIGNDataSource is the data source implementation.
type ConnectionJIRAALIGNDataSource struct {
	client *sdk.SDK
}

// ConnectionJIRAALIGNDataSourceModel describes the data model.
type ConnectionJIRAALIGNDataSourceModel struct {
...
func (r *ConnectionJIRAALIGNDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_jira_align"
}

// Schema defines the schema for the data source.
func (r *ConnectionJIRAALIGNDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionJIRAALIGN DataSource",
...
func (r *ConnectionJIRAALIGNDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionJIRAALIGNDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionJIRAALIGNDataSourceModel
