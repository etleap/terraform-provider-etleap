...
func (r *ConnectionCRITEOResourceModel) ToSharedConnectionCriteoInput() *shared.ConnectionCriteoInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionCriteoType(r.Type.ValueString())
	...
	out := shared.ConnectionCriteoInput{
		Name:           name,
		Type:           typeVar,
...
func (r *ConnectionCRITEOResourceModel) ToSharedConnectionCriteoUpdate() *shared.ConnectionCriteoUpdate {
	active := new(bool)
	...
	typeVar := new(shared.ConnectionCriteoUpdateType)
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionCriteoUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	name := new(string)
	...
	out := shared.ConnectionCriteoUpdate{
		Active:         active,
		Type:           typeVar,
		Name:           name,
		UpdateSchedule: updateSchedule,
...
func (r *ConnectionCRITEOResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
