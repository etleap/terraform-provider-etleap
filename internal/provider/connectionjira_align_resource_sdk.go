...
func (r *ConnectionJIRAALIGNResourceModel) ToSharedConnectionJiraAlignInput() *shared.ConnectionJiraAlignInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionJiraAlignType(r.Type.ValueString())
	...
	out := shared.ConnectionJiraAlignInput{
		Name:           name,
		Type:           typeVar,
...
func (r *ConnectionJIRAALIGNResourceModel) RefreshFromSharedConnectionJiraAlign(resp *shared.ConnectionJiraAlign) {
...
func (r *ConnectionJIRAALIGNResourceModel) ToSharedConnectionJiraAlignUpdate() *shared.ConnectionJiraAlignUpdate {
	name := new(string)
	...
	typeVar := new(shared.ConnectionJiraAlignUpdateType)
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionJiraAlignUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	active := new(bool)
	...
	out := shared.ConnectionJiraAlignUpdate{
		Name:           name,
		Type:           typeVar,
		Active:         active,
		UpdateSchedule: updateSchedule,
...
func (r *ConnectionJIRAALIGNResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
