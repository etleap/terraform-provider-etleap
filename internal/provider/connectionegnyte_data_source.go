...
var _ datasource.DataSource = &ConnectionEGNYTEDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionEGNYTEDataSource{}

func NewConnectionEGNYTEDataSource() datasource.DataSource {
	return &ConnectionEGNYTEDataSource{}
}

// ConnectionEGNYTEDataSource is the data source implementation.
type ConnectionEGNYTEDataSource struct {
	client *sdk.SDK
}

// ConnectionEGNYTEDataSourceModel describes the data model.
type ConnectionEGNYTEDataSourceModel struct {
...
func (r *ConnectionEGNYTEDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_egnyte"
}

// Schema defines the schema for the data source.
func (r *ConnectionEGNYTEDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionEGNYTE DataSource",
...
func (r *ConnectionEGNYTEDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionEGNYTEDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionEGNYTEDataSourceModel
