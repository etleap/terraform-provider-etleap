...
var _ datasource.DataSource = &ConnectionPOSTGRESSHARDEDDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionPOSTGRESSHARDEDDataSource{}

func NewConnectionPOSTGRESSHARDEDDataSource() datasource.DataSource {
	return &ConnectionPOSTGRESSHARDEDDataSource{}
}

// ConnectionPOSTGRESSHARDEDDataSource is the data source implementation.
type ConnectionPOSTGRESSHARDEDDataSource struct {
	client *sdk.SDK
}
...
func (r *ConnectionPOSTGRESSHARDEDDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_postgres_sharded"
}

// Schema defines the schema for the data source.
func (r *ConnectionPOSTGRESSHARDEDDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionPOSTGRESSHARDED DataSource",
...
func (r *ConnectionPOSTGRESSHARDEDDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionPOSTGRESSHARDEDDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionPOSTGRESSHARDEDDataSourceModel
