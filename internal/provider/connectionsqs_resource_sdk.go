...
func (r *ConnectionSQSResourceModel) ToSharedConnectionSqsInput() *shared.ConnectionSqsInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionSqsType(r.Type.ValueString())
...
func (r *ConnectionSQSResourceModel) RefreshFromSharedConnectionSqs(resp *shared.ConnectionSqs) {
...
func (r *ConnectionSQSResourceModel) ToSharedConnectionSqsUpdate() *shared.ConnectionSqsUpdate {
	name := new(string)
	...
	typeVar := new(shared.ConnectionSqsUpdateType)
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionSqsUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	active := new(bool)
	...
	out := shared.ConnectionSqsUpdate{
		Name:           name,
		Type:           typeVar,
		Active:         active,
		UpdateSchedule: updateSchedule,
...
func (r *ConnectionSQSResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
