...
func (r *ConnectionJIRAResourceModel) ToSharedConnectionJiraInput() *shared.ConnectionJiraInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionJiraType(r.Type.ValueString())
	...
	out := shared.ConnectionJiraInput{
		Name:           name,
		Type:           typeVar,
...
func (r *ConnectionJIRAResourceModel) RefreshFromSharedConnectionJira(resp *shared.ConnectionJira) {
...
func (r *ConnectionJIRAResourceModel) ToSharedConnectionJiraUpdate() *shared.ConnectionJiraUpdate {
	name := new(string)
	...
	typeVar := new(shared.ConnectionJiraUpdateType)
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionJiraUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	active := new(bool)
	...
	out := shared.ConnectionJiraUpdate{
		Name:           name,
		Type:           typeVar,
		Active:         active,
		UpdateSchedule: updateSchedule,
...
func (r *ConnectionJIRAResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
