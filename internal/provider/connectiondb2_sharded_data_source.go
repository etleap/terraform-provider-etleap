...
var _ datasource.DataSource = &ConnectionDb2SHARDEDDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionDb2SHARDEDDataSource{}

func NewConnectionDb2SHARDEDDataSource() datasource.DataSource {
	return &ConnectionDb2SHARDEDDataSource{}
}

// ConnectionDb2SHARDEDDataSource is the data source implementation.
type ConnectionDb2SHARDEDDataSource struct {
	client *sdk.SDK
}
...
func (r *ConnectionDb2SHARDEDDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_db2_sharded"
}

// Schema defines the schema for the data source.
func (r *ConnectionDb2SHARDEDDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionDb2SHARDED DataSource",
...
func (r *ConnectionDb2SHARDEDDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionDb2SHARDEDDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionDb2SHARDEDDataSourceModel
