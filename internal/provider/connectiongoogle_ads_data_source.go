...
var _ datasource.DataSource = &ConnectionGOOGLEADSDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionGOOGLEADSDataSource{}

func NewConnectionGOOGLEADSDataSource() datasource.DataSource {
	return &ConnectionGOOGLEADSDataSource{}
}

// ConnectionGOOGLEADSDataSource is the data source implementation.
type ConnectionGOOGLEADSDataSource struct {
	client *sdk.SDK
}

// ConnectionGOOGLEADSDataSourceModel describes the data model.
type ConnectionGOOGLEADSDataSourceModel struct {
...
func (r *ConnectionGOOGLEADSDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_google_ads"
}

// Schema defines the schema for the data source.
func (r *ConnectionGOOGLEADSDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionGOOGLEADS DataSource",
...
func (r *ConnectionGOOGLEADSDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionGOOGLEADSDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionGOOGLEADSDataSourceModel
