...
var _ datasource.DataSource = &ConnectionZENDESKDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionZENDESKDataSource{}

func NewConnectionZENDESKDataSource() datasource.DataSource {
	return &ConnectionZENDESKDataSource{}
}

// ConnectionZENDESKDataSource is the data source implementation.
type ConnectionZENDESKDataSource struct {
	client *sdk.SDK
}

// ConnectionZENDESKDataSourceModel describes the data model.
type ConnectionZENDESKDataSourceModel struct {
...
func (r *ConnectionZENDESKDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_zendesk"
}

// Schema defines the schema for the data source.
func (r *ConnectionZENDESKDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionZENDESK DataSource",
...
func (r *ConnectionZENDESKDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionZENDESKDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionZENDESKDataSourceModel
