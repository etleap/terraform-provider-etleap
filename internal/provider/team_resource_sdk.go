...
func (r *TeamResourceModel) ToSharedTeamInput() *shared.TeamInput {
	name := r.Name.ValueString()
	description := r.Description.ValueString()
	out := shared.TeamInput{
		Name:        name,
...
func (r *TeamResourceModel) RefreshFromSharedTeamOutput(resp *shared.TeamOutput) {
