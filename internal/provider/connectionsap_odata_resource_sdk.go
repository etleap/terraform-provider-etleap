...
func (r *ConnectionSAPODATAResourceModel) ToSharedConnectionSapOdataInput() *shared.ConnectionSapOdataInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionSapOdataType(r.Type.ValueString())
	...
	out := shared.ConnectionSapOdataInput{
		Name:           name,
		Type:           typeVar,
...
func (r *ConnectionSAPODATAResourceModel) RefreshFromSharedConnectionSapOdata(resp *shared.ConnectionSapOdata) {
...
func (r *ConnectionSAPODATAResourceModel) ToSharedConnectionSapOdataUpdate() *shared.ConnectionSapOdataUpdate {
	name := new(string)
	...
	typeVar := new(shared.ConnectionSapOdataUpdateType)
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionSapOdataUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	active := new(bool)
	...
	out := shared.ConnectionSapOdataUpdate{
		Name:           name,
		Type:           typeVar,
		Active:         active,
		UpdateSchedule: updateSchedule,
...
func (r *ConnectionSAPODATAResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
