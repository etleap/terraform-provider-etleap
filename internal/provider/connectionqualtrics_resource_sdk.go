...
func (r *ConnectionQUALTRICSResourceModel) ToSharedConnectionQualtricsInput() *shared.ConnectionQualtricsInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionQualtricsType(r.Type.ValueString())
	...
	dataCenterID := r.DataCenterID.ValueString()
	out := shared.ConnectionQualtricsInput{
		Name:           name,
		Type:           typeVar,
...
func (r *ConnectionQUALTRICSResourceModel) RefreshFromSharedConnectionQualtrics(resp *shared.ConnectionQualtrics) {
	r.Active = types.BoolValue(resp.Active)
	r.CreateDate = types.StringValue(resp.CreateDate.Format(time.RFC3339Nano))
	r.DataCenterID = types.StringValue(resp.DataCenterID)
...
func (r *ConnectionQUALTRICSResourceModel) ToSharedConnectionQualtricsUpdate() *shared.ConnectionQualtricsUpdate {
	name := new(string)
	...
	typeVar := new(shared.ConnectionQualtricsUpdateType)
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionQualtricsUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	active := new(bool)
	...
	if !r.DataCenterID.IsUnknown() && !r.DataCenterID.IsNull() {
		*dataCenterID = r.DataCenterID.ValueString()
	} else {
		dataCenterID = nil
	}
	out := shared.ConnectionQualtricsUpdate{
		Name:           name,
		Type:           typeVar,
		Active:         active,
		UpdateSchedule: updateSchedule,
...
func (r *ConnectionQUALTRICSResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
