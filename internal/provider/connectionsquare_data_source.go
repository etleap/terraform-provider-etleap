...
var _ datasource.DataSource = &ConnectionSQUAREDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionSQUAREDataSource{}

func NewConnectionSQUAREDataSource() datasource.DataSource {
	return &ConnectionSQUAREDataSource{}
}

// ConnectionSQUAREDataSource is the data source implementation.
type ConnectionSQUAREDataSource struct {
	client *sdk.SDK
}
...
func (r *ConnectionSQUAREDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_square"
}

// Schema defines the schema for the data source.
func (r *ConnectionSQUAREDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionSQUARE DataSource",
...
func (r *ConnectionSQUAREDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionSQUAREDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionSQUAREDataSourceModel
