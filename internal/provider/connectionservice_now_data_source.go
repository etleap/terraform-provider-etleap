...
var _ datasource.DataSource = &ConnectionSERVICENOWDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionSERVICENOWDataSource{}

func NewConnectionSERVICENOWDataSource() datasource.DataSource {
	return &ConnectionSERVICENOWDataSource{}
}

// ConnectionSERVICENOWDataSource is the data source implementation.
type ConnectionSERVICENOWDataSource struct {
	client *sdk.SDK
}

// ConnectionSERVICENOWDataSourceModel describes the data model.
type ConnectionSERVICENOWDataSourceModel struct {
...
func (r *ConnectionSERVICENOWDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_service_now"
}

// Schema defines the schema for the data source.
func (r *ConnectionSERVICENOWDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionSERVICENOW DataSource",
...
func (r *ConnectionSERVICENOWDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionSERVICENOWDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionSERVICENOWDataSourceModel
