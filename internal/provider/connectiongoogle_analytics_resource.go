...
var _ resource.Resource = &ConnectionGOOGLEANALYTICSResource{}
var _ resource.ResourceWithImportState = &ConnectionGOOGLEANALYTICSResource{}

func NewConnectionGOOGLEANALYTICSResource() resource.Resource {
	return &ConnectionGOOGLEANALYTICSResource{}
}

// ConnectionGOOGLEANALYTICSResource defines the resource implementation.
type ConnectionGOOGLEANALYTICSResource struct {
	client *sdk.SDK
}

// ConnectionGOOGLEANALYTICSResourceModel describes the resource data model.
type ConnectionGOOGLEANALYTICSResourceModel struct {
	Active                   types.Bool              `tfsdk:"active"`
	Code                     types.String            `tfsdk:"code"`
	CreateDate               types.String            `tfsdk:"create_date"`
	DefaultUpdateSchedule    []DefaultUpdateSchedule `tfsdk:"default_update_schedule"`
	DeletionOfExportProducts types.Bool              `tfsdk:"deletion_of_export_products"`
	GoogleID                 types.String            `tfsdk:"google_id"`
...
func (r *ConnectionGOOGLEANALYTICSResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_google_analytics"
}

func (r *ConnectionGOOGLEANALYTICSResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionGOOGLEANALYTICS Resource",
		...
		Attributes: map[string]schema.Attribute{
			...
			"google_id": schema.StringAttribute{
				Computed: true,
			},
...
func (r *ConnectionGOOGLEANALYTICSResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *ConnectionGOOGLEANALYTICSResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *ConnectionGOOGLEANALYTICSResourceModel
	...
	request := *data.ToSharedConnectionGaInput()
	res, err := r.client.Connection.CreateGOOGLEANALYTICSConnection(ctx, request)
	if err != nil {
	...
	if res.ConnectionGa == nil {
		resp.Diagnostics.AddError("unexpected response from API. No response body", debugResponse(res.RawResponse))
		return
	}
	data.RefreshFromSharedConnectionGa(res.ConnectionGa)
	refreshPlan(ctx, plan, &data, resp.Diagnostics)
	id := data.ID.ValueString()
	request1 := operations.GetGOOGLEANALYTICSConnectionRequest{
		ID: id,
	}
	res1, err := r.client.Connection.GetGOOGLEANALYTICSConnection(ctx, request1)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
	...
	if res1.ConnectionGa == nil {
		resp.Diagnostics.AddError("unexpected response from API. No response body", debugResponse(res1.RawResponse))
		return
	}
	data.RefreshFromSharedConnectionGa(res1.ConnectionGa)
	refreshPlan(ctx, plan, &data, resp.Diagnostics)
...
func (r *ConnectionGOOGLEANALYTICSResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *ConnectionGOOGLEANALYTICSResourceModel
	...
	id := data.ID.ValueString()
	request := operations.GetGOOGLEANALYTICSConnectionRequest{
		ID: id,
	}
	res, err := r.client.Connection.GetGOOGLEANALYTICSConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionGOOGLEANALYTICSResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *ConnectionGOOGLEANALYTICSResourceModel
	var plan types.Object
	...
	id := data.ID.ValueString()
	connectionGaUpdate := data.ToSharedConnectionGaUpdate()
	request := operations.UpdateGOOGLEANALYTICSConnectionRequest{
		ID:                 id,
		ConnectionGaUpdate: connectionGaUpdate,
	}
	res, err := r.client.Connection.UpdateGOOGLEANALYTICSConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionGOOGLEANALYTICSResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *ConnectionGOOGLEANALYTICSResourceModel
	var item types.Object
	...
	request := operations.DeleteGOOGLEANALYTICSConnectionRequest{
		ID:               id,
		ConnectionDelete: connectionDelete,
	}
	res, err := r.client.Connection.DeleteGOOGLEANALYTICSConnection(ctx, request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *ConnectionGOOGLEANALYTICSResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
