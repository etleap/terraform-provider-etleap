...
var _ datasource.DataSource = &ConnectionCONFLUENTCLOUDDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionCONFLUENTCLOUDDataSource{}

func NewConnectionCONFLUENTCLOUDDataSource() datasource.DataSource {
	return &ConnectionCONFLUENTCLOUDDataSource{}
}

// ConnectionCONFLUENTCLOUDDataSource is the data source implementation.
type ConnectionCONFLUENTCLOUDDataSource struct {
	client *sdk.SDK
}
...
func (r *ConnectionCONFLUENTCLOUDDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_confluent_cloud"
}

// Schema defines the schema for the data source.
func (r *ConnectionCONFLUENTCLOUDDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionCONFLUENTCLOUD DataSource",
...
func (r *ConnectionCONFLUENTCLOUDDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionCONFLUENTCLOUDDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionCONFLUENTCLOUDDataSourceModel
