...
func (r *ConnectionSNAPCHATADSResourceModel) ToSharedConnectionSnapchatAdsInput() *shared.ConnectionSnapchatAdsInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionSnapchatAdsType(r.Type.ValueString())
	...
	out := shared.ConnectionSnapchatAdsInput{
		Name:           name,
		Type:           typeVar,
...
func (r *ConnectionSNAPCHATADSResourceModel) RefreshFromSharedConnectionSnapchatAds(resp *shared.ConnectionSnapchatAds) {
...
func (r *ConnectionSNAPCHATADSResourceModel) ToSharedConnectionSnapchatAdsUpdate() *shared.ConnectionSnapchatAdsUpdate {
	name := new(string)
	...
	typeVar := shared.ConnectionSnapchatAdsUpdateType(r.Type.ValueString())
	active := new(bool)
	...
	out := shared.ConnectionSnapchatAdsUpdate{
		Name:           name,
		Type:           typeVar,
		Active:         active,
		UpdateSchedule: updateSchedule,
...
func (r *ConnectionSNAPCHATADSResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
