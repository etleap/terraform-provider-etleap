...
var _ datasource.DataSource = &ConnectionBINGADSDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionBINGADSDataSource{}

func NewConnectionBINGADSDataSource() datasource.DataSource {
	return &ConnectionBINGADSDataSource{}
}

// ConnectionBINGADSDataSource is the data source implementation.
type ConnectionBINGADSDataSource struct {
	client *sdk.SDK
}

// ConnectionBINGADSDataSourceModel describes the data model.
type ConnectionBINGADSDataSourceModel struct {
...
func (r *ConnectionBINGADSDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_bing_ads"
}

// Schema defines the schema for the data source.
func (r *ConnectionBINGADSDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionBINGADS DataSource",
...
func (r *ConnectionBINGADSDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionBINGADSDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionBINGADSDataSourceModel
