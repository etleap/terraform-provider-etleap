...
func (r *ConnectionINCREASEResourceModel) ToSharedConnectionIncreaseInput() *shared.ConnectionIncreaseInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionIncreaseType(r.Type.ValueString())
	...
	isSandbox := r.IsSandbox.ValueString()
	out := shared.ConnectionIncreaseInput{
		Name:           name,
		Type:           typeVar,
...
func (r *ConnectionINCREASEResourceModel) RefreshFromSharedConnectionIncrease(resp *shared.ConnectionIncrease) {
	...
	r.IsSandbox = types.StringValue(resp.IsSandbox)
...
func (r *ConnectionINCREASEResourceModel) ToSharedConnectionIncreaseUpdate() *shared.ConnectionIncreaseUpdate {
	name := new(string)
	...
	typeVar := new(shared.ConnectionIncreaseUpdateType)
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionIncreaseUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	active := new(bool)
	...
	isSandbox := new(string)
	if !r.IsSandbox.IsUnknown() && !r.IsSandbox.IsNull() {
		*isSandbox = r.IsSandbox.ValueString()
	} else {
		isSandbox = nil
	}
	out := shared.ConnectionIncreaseUpdate{
		Name:           name,
		Type:           typeVar,
		Active:         active,
		UpdateSchedule: updateSchedule,
...
func (r *ConnectionINCREASEResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
