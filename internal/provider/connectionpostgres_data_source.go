...
var _ datasource.DataSource = &ConnectionPOSTGRESDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionPOSTGRESDataSource{}

func NewConnectionPOSTGRESDataSource() datasource.DataSource {
	return &ConnectionPOSTGRESDataSource{}
}

// ConnectionPOSTGRESDataSource is the data source implementation.
type ConnectionPOSTGRESDataSource struct {
	client *sdk.SDK
}

// ConnectionPOSTGRESDataSourceModel describes the data model.
type ConnectionPOSTGRESDataSourceModel struct {
...
func (r *ConnectionPOSTGRESDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_postgres"
}

// Schema defines the schema for the data source.
func (r *ConnectionPOSTGRESDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionPOSTGRES DataSource",
...
func (r *ConnectionPOSTGRESDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionPOSTGRESDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionPOSTGRESDataSourceModel
