...
func (r *ConnectionLDAPVIRTUALLISTVIEWResourceModel) ToSharedConnectionLdapVirtualListViewInput() *shared.ConnectionLdapVirtualListViewInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionLdapVirtualListViewType(r.Type.ValueString())
...
func (r *ConnectionLDAPVIRTUALLISTVIEWResourceModel) RefreshFromSharedConnectionLdapVirtualListView(resp *shared.ConnectionLdapVirtualListView) {
...
func (r *ConnectionLDAPVIRTUALLISTVIEWResourceModel) ToSharedConnectionLdapVirtualListViewUpdate() *shared.ConnectionLdapVirtualListViewUpdate {
	...
	if !r.Type.IsUnknown() && !r.Type.IsNull() {
		*typeVar = shared.ConnectionLdapVirtualListViewUpdateType(r.Type.ValueString())
	} else {
		typeVar = nil
	}
	active := new(bool)
...
func (r *ConnectionLDAPVIRTUALLISTVIEWResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
