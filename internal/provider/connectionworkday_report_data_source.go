...
var _ datasource.DataSource = &ConnectionWORKDAYREPORTDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionWORKDAYREPORTDataSource{}

func NewConnectionWORKDAYREPORTDataSource() datasource.DataSource {
	return &ConnectionWORKDAYREPORTDataSource{}
}

// ConnectionWORKDAYREPORTDataSource is the data source implementation.
type ConnectionWORKDAYREPORTDataSource struct {
	client *sdk.SDK
}

// ConnectionWORKDAYREPORTDataSourceModel describes the data model.
type ConnectionWORKDAYREPORTDataSourceModel struct {
...
func (r *ConnectionWORKDAYREPORTDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_workday_report"
}

// Schema defines the schema for the data source.
func (r *ConnectionWORKDAYREPORTDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionWORKDAYREPORT DataSource",
...
func (r *ConnectionWORKDAYREPORTDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionWORKDAYREPORTDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionWORKDAYREPORTDataSourceModel
