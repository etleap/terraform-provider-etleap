...
var _ datasource.DataSource = &ConnectionRAVEMEDIDATADataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionRAVEMEDIDATADataSource{}

func NewConnectionRAVEMEDIDATADataSource() datasource.DataSource {
	return &ConnectionRAVEMEDIDATADataSource{}
}

// ConnectionRAVEMEDIDATADataSource is the data source implementation.
type ConnectionRAVEMEDIDATADataSource struct {
	client *sdk.SDK
}

// ConnectionRAVEMEDIDATADataSourceModel describes the data model.
type ConnectionRAVEMEDIDATADataSourceModel struct {
...
func (r *ConnectionRAVEMEDIDATADataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_rave_medidata"
}

// Schema defines the schema for the data source.
func (r *ConnectionRAVEMEDIDATADataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionRAVEMEDIDATA DataSource",
...
func (r *ConnectionRAVEMEDIDATADataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionRAVEMEDIDATADataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionRAVEMEDIDATADataSourceModel
