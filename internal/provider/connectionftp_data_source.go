...
var _ datasource.DataSource = &ConnectionFTPDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionFTPDataSource{}

func NewConnectionFTPDataSource() datasource.DataSource {
	return &ConnectionFTPDataSource{}
}

// ConnectionFTPDataSource is the data source implementation.
type ConnectionFTPDataSource struct {
	client *sdk.SDK
}
...
func (r *ConnectionFTPDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_ftp"
}

// Schema defines the schema for the data source.
func (r *ConnectionFTPDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionFTP DataSource",
...
func (r *ConnectionFTPDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionFTPDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionFTPDataSourceModel
