...
var _ datasource.DataSource = &ConnectionTWITTERADSDataSource{}
var _ datasource.DataSourceWithConfigure = &ConnectionTWITTERADSDataSource{}

func NewConnectionTWITTERADSDataSource() datasource.DataSource {
	return &ConnectionTWITTERADSDataSource{}
}

// ConnectionTWITTERADSDataSource is the data source implementation.
type ConnectionTWITTERADSDataSource struct {
	client *sdk.SDK
}
...
func (r *ConnectionTWITTERADSDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connection_twitter_ads"
}

// Schema defines the schema for the data source.
func (r *ConnectionTWITTERADSDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ConnectionTWITTERADS DataSource",
...
func (r *ConnectionTWITTERADSDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ConnectionTWITTERADSDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ConnectionTWITTERADSDataSourceModel
