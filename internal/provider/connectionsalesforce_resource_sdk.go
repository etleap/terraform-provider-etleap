...
func (r *ConnectionSALESFORCEResourceModel) ToSharedConnectionSalesforceInput() *shared.ConnectionSalesforceInput {
	name := r.Name.ValueString()
	typeVar := shared.ConnectionSalesforceType(r.Type.ValueString())
	...
	out := shared.ConnectionSalesforceInput{
		Name:           name,
		Type:           typeVar,
...
func (r *ConnectionSALESFORCEResourceModel) RefreshFromSharedConnectionSalesforce(resp *shared.ConnectionSalesforce) {
	...
	r.InstanceURL = types.StringValue(resp.InstanceURL)
...
func (r *ConnectionSALESFORCEResourceModel) ToSharedConnectionSalesforceUpdate() *shared.ConnectionSalesforceUpdate {
	name := new(string)
	...
	typeVar := shared.ConnectionSalesforceUpdateType(r.Type.ValueString())
	active := new(bool)
	...
	out := shared.ConnectionSalesforceUpdate{
		Name:           name,
		Type:           typeVar,
		Active:         active,
		UpdateSchedule: updateSchedule,
...
func (r *ConnectionSALESFORCEResourceModel) ToSharedConnectionDelete() *shared.ConnectionDelete {
